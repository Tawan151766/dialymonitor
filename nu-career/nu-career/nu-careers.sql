...
--
-- Table structure for table `d_addr_workplace`
--

CREATE TABLE `d_addr_workplace` (
  `add_wp_ID` int(11) NOT NULL,
  `std_id` varchar(8) DEFAULT NULL,
  `add_name` varchar(255) DEFAULT NULL,
  `workplace_tel` varchar(20) DEFAULT NULL,
  `workplace_fax` varchar(50) DEFAULT NULL,
  `workplace_email` varchar(50) DEFAULT NULL,
  `workplace_number` varchar(50) DEFAULT NULL,
  `village_number` varchar(50) DEFAULT NULL,
  `building_name` varchar(50) DEFAULT NULL,
  `floor` varchar(50) DEFAULT NULL,
  `alley_or_ane` varchar(50) DEFAULT NULL,
...
--
-- Dumping data for table `d_addr_workplace`
--
...
--
-- Table structure for table `d_apply_edu`
--

CREATE TABLE `d_apply_edu` (
  `apply_edu_id` int(11) NOT NULL,
  `apply_edu_values` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_apply_edu`
--

INSERT INTO `d_apply_edu` (`apply_edu_id`, `apply_edu_values`) VALUES
(1, 'น้อยที่สุด'),
(2, 'น้อย'),
(3, 'ปานกลาง'),
(4, 'มาก'),
...
--
-- Table structure for table `d_cause_edu`
--

CREATE TABLE `d_cause_edu` (
  `cause_edu_id` int(11) DEFAULT NULL,
  `cause_edu_desc` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_cause_edu`
--

INSERT INTO `d_cause_edu` (`cause_edu_id`, `cause_edu_desc`) VALUES
(1, 'เป็นความต้องการของบิดา/มารดา หรือผู้ปกครอง'),
(2, 'งานที่ต้องการต้องใช้วุฒิสูงกว่า ปริญญาตรี'),
(3, 'ได้รับทุนศึกษาต่อ'),
(4, 'เป็นความต้องการของตนเอง'),
(5, 'อื่นๆให้ระบุ');

-- --------------------------------------------------------

--
-- Table structure for table `d_cause_nowork`
--

CREATE TABLE `d_cause_nowork` (
  `cause_nowork_id` int(11) DEFAULT NULL,
  `cause_nowork_desc` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_cause_nowork`
--

INSERT INTO `d_cause_nowork` (`cause_nowork_id`, `cause_nowork_desc`) VALUES
(1, 'ยังไม่ประสงค์ทำงาน'),
(2, 'รอฟังคำตอบจากหน่วยงาน'),
(3, 'หางานทำไม่ได้'),
(4, 'ต้องการประกอบอาชีพอิสระ'),
(5, 'อื่นๆให้ระบุ');

-- --------------------------------------------------------

--
-- Table structure for table `d_department`
--
...
CREATE TABLE `d_department` (
  ...
  `dep_status` varchar(1) NOT NULL DEFAULT '1',
  `status` varchar(1) NOT NULL DEFAULT 'Y'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_department`
--

INSERT INTO `d_department` (`id`, `fac_id`, `dep_id`, `dep_name`, `dep_status`, `status`) VALUES
(1, 1, 2, 'กองกลาง', '1', 'Y'),
(2, 1, 10, 'กองกิจการนิสิต', '1', 'Y'),
(3, 1, 18, 'กองบริการการศึกษา', '1', 'Y'),
(4, 1, 25, 'กองแผนงาน', '1', 'Y'),
(5, 1, 31, 'กองคลัง', '1', 'Y'),
(6, 110, 45, 'ศูนย์วิจัยสิ่งแวดล้อม', '1', 'Y'),
(7, 1, 48, 'กองบริการเทคโนโลยีสารสนเทศและการสื่อสาร', '1', 'Y'),
(8, 55, 56, 'สำนักงานเลขานุการ', '1', 'Y'),
(9, 57, 58, 'สำนักงานเลขานุการ', '1', 'Y'),
(10, 57, 59, 'ภาควิชาวิทยาศาสตร์การเกษตร', '1', 'Y'),
(11, 57, 60, 'ภาควิชาอุตสาหกรรมเกษตร', '1', 'Y'),
(12, 57, 61, 'ภาควิชาทรัพยากรธรรมชาติและสิ่งแวดล้อม', '1', 'Y'),
(13, 62, 63, 'สำนักงานเลขานุการ', '1', 'Y'),
(14, 62, 64, 'ภาควิชาทันตกรรมป้องกัน', '1', 'Y'),
(15, 62, 65, 'ภาควิชาทันตกรรมวินิจฉัย', '1', 'Y'),
(16, 62, 66, 'โรงพยาบาลทันตกรรม', '1', 'Y'),
(17, 62, 67, 'ภาควิชาชีววิทยาช่องปาก', '1', 'Y'),
(18, 62, 68, 'ภาควิชาทันตกรรมบูรณะ', '1', 'Y'),
(19, 69, 70, 'สำนักงานเลขานุการ', '1', 'Y'),
(20, 71, 72, 'สำนักงานเลขานุการ', '1', 'Y'),
(21, 71, 73, 'ภาควิชาพยาบาลศาสตร์', '1', 'Y'),
(22, 74, 75, 'สำนักงานเลขานุการ', '1', 'Y'),
(23, 74, 76, 'ภาควิชากุมารเวชศาสตร์', '1', 'Y'),
(24, 74, 77, 'ภาควิชาจักษุวิทยา', '1', 'Y'),
(25, 74, 78, 'ภาควิชาจิตเวชศาสตร์', '1', 'Y'),
(26, 74, 79, 'ภาควิชาพยาธิวิทยา', '1', 'Y'),
(27, 74, 80, 'ภาควิชารังสีวิทยา', '1', 'Y'),
(28, 74, 81, 'ภาควิชาวิสัญญีวิทยา', '1', 'Y'),
(29, 74, 82, 'ภาควิชาเวชศาสตร์ชุมชน', '1', 'Y'),
(30, 74, 83, 'ภาควิชาศัลยศาสตร์', '1', 'Y'),
(31, 74, 84, 'ภาควิชาสูติศาสตร์-นรีเวชวิทยา', '1', 'Y'),
(32, 74, 85, 'ภาควิชาออร์โธปิดิกส์', '1', 'Y'),
(33, 74, 86, 'ภาควิชาอายุรศาสตร์', '1', 'Y'),
(34, 74, 87, 'โรงพยาบาลมหาวิทยาลัยนเรศวร', '1', 'Y'),
(35, 88, 89, 'สำนักงานเลขานุการ', '1', 'Y'),
(36, 88, 90, 'ภาควิชาเภสัชกรรมปฏิบัติ', '1', 'Y'),
(37, 88, 91, 'ภาควิชาเภสัชเคมีและเภสัชเวท', '1', 'Y'),
(38, 88, 92, 'ภาควิชาเทคโนโลยีเภสัชกรรม', '1', 'Y'),
(39, 93, 94, 'สำนักงานเลขานุการ', '1', 'Y'),
(40, 95, 96, 'สำนักงานเลขานุการ', '1', 'Y'),
(41, 97, 98, 'สำนักงานเลขานุการ', '1', 'Y'),
(42, 97, 99, 'ภาควิชาคณิตศาสตร์', '1', 'Y'),
(43, 97, 100, 'ภาควิชาเคมี', '1', 'Y'),
(44, 97, 101, 'ภาควิชาชีววิทยา', '1', 'Y'),
(45, 97, 102, 'ภาควิชาฟิสิกส์', '1', 'Y'),
(46, 97, 103, 'ภาควิชาวิทยาการคอมพิวเตอร์และเทคโนโลยีสารสนเทศ', '1', 'Y'),
(47, 104, 105, 'สำนักงานเลขานุการ', '1', 'Y'),
(48, 104, 106, 'ภาควิชากายวิภาคศาสตร์', '1', 'Y'),
(49, 104, 107, 'ภาควิชาสรีรวิทยา', '1', 'Y'),
(50, 104, 108, 'ภาควิชาชีวเคมี', '1', 'Y'),
(51, 104, 109, 'ภาควิชาจุลชีววิทยาและปรสิตวิทยา', '1', 'Y'),
(52, 110, 111, 'สำนักงานเลขานุการ', '1', 'Y'),
(53, 110, 112, 'ภาควิชาวิศวกรรมเครื่องกล', '1', 'Y'),
(54, 110, 113, 'ภาควิชาวิศวกรรมโยธา', '1', 'Y'),
(55, 110, 114, 'ภาควิชาวิศวกรรมอุตสาหการ', '1', 'Y'),
(56, 110, 115, 'ภาควิชาวิศวกรรมไฟฟ้าและคอมพิวเตอร์', '1', 'Y'),
(57, 116, 117, 'สำนักงานเลขานุการ', '1', 'Y'),
(58, 116, 118, 'ภาควิชาการศึกษา', '1', 'Y'),
(59, 116, 119, 'ภาควิชาเทคโนโลยีและสื่อสารการศึกษา', '1', 'Y'),
(60, 116, 120, 'ภาควิชาบริหารและพัฒนาการศึกษา', '1', 'Y'),
(61, 121, 122, 'สำนักงานเลขานุการ', '1', 'Y'),
(62, 123, 124, 'สำนักงานเลขานุการ', '1', 'Y'),
(63, 123, 125, 'ภาควิชาเทคนิคการแพทย์', '1', 'Y'),
(64, 123, 126, 'ภาควิชาเทคโนโลยีหัวใจและทรวงอก', '1', 'Y'),
(65, 123, 127, 'ภาควิชารังสีเทคนิค', '1', 'Y'),
(66, 123, 128, 'ภาควิชากายภาพบำบัด', '1', 'Y'),
(67, 129, 130, 'สำนักงานเลขานุการ', '1', 'Y'),
(68, 131, 132, 'สำนักงานเลขานุการ', '1', 'Y'),
(69, 133, 134, 'สำนักงานเลขานุการ', '1', 'Y'),
(70, 135, 136, 'สำนักงานเลขานุการ', '1', 'Y'),
(71, 141, 142, 'สำนักงานเลขานุการ', '1', 'Y'),
(72, 141, 143, 'ฝ่ายบริการสารสนเทศ', '1', 'Y'),
(73, 141, 144, 'ฝ่ายพัฒนาและวิเคราะห์ทรัพยากรสารสนเทศ', '1', 'Y'),
(74, 121, 220, 'ภาควิชาสถาปัตยกรรม', '1', 'Y'),
(75, 95, 221, 'ภาควิชาบริหารธุรกิจ', '1', 'Y'),
(76, 95, 222, 'ภาควิชาเศรษฐศาสตร์', '1', 'Y'),
(77, 95, 223, 'ภาควิชานิเทศศาสตร์', '1', 'Y'),
(78, 121, 240, 'ภาควิชาศิลปะและการออกแบบ', '1', 'Y'),
(79, 93, 260, 'ภาควิชาภาษาตะวันตก', '1', 'Y'),
(80, 93, 262, 'ภาควิชาภาษาตะวันออก', '1', 'Y'),
(81, 1, 300, 'กองการบริหารงานบุคคล', '1', 'Y'),
(82, 1, 340, 'กองอาคารสถานที่', '1', 'Y'),
(83, 62, 360, 'ภาควิชาศัลยศาสตร์ช่องปาก', '1', 'Y'),
(84, 1, 426, 'กองกฎหมาย', '1', 'Y'),
(85, 1, 584, 'กองพัฒนาคุณภาพการศึกษา', '1', 'Y'),
(86, 1, 600, 'กองการวิจัยและนวัตกรรม', '1', 'Y'),
(87, 129, 666, 'ภาควิชาจิตวิทยา', '1', 'Y'),
(88, 129, 667, 'ภาควิชาประวัติศาสตร์', '1', 'Y'),
(89, 129, 668, 'ภาควิชาสังคมวิทยาและมานุษยวิทยา', '1', 'Y'),
(90, 129, 669, 'ภาควิชารัฐศาสตร์และรัฐประศาสนศาสตร์', '1', 'Y'),
(91, 116, 670, 'โรงเรียนมัธยมสาธิต มหาวิทยาลัยนเรศวร', '1', 'Y'),
(92, 69, 69, 'สาขาวิชานิติศาสตร์', '1', 'Y'),
(93, 1, 684, 'กองส่งเสริมศิลปวัฒนธรรม', '1', 'Y'),
(94, 74, 760, 'ภาควิชาโสต ศอ นาสิกวิทยา', '1', 'Y'),
(95, 74, 761, 'ภาควิชาเวชศาสตร์ฟื้นฟู', '1', 'Y'),
(96, 800, 801, 'สำนักงานเลขานุการ', '1', 'Y'),
(97, 800, 802, 'ฝ่ายวิชาการ', '1', 'Y'),
(98, 800, 803, 'ฝ่ายวิจัยและบริการวิชาการ', '1', 'Y'),
(99, 1, 840, 'สถานสัตว์ทดลองเพื่อการวิจัย', '1', 'Y'),
(100, 74, 861, 'ภาควิชานิติเวชศาสตร์', '1', 'Y'),
(101, 104, 940, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านเทคโนโลยีชีวภาพทางการแพทย์', '1', 'Y'),
(102, 88, 941, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านนวัตกรรมทางเคมี', '1', 'Y'),
(103, 88, 942, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านอนามัยสิ่งแวดล้อมและพิษวิทยา', '1', 'Y'),
(104, 97, 943, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านคณิตศาสตร์', '1', 'Y'),
(105, 97, 944, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านความหลากหลายทางชีวภาพ', '1', 'Y'),
(106, 97, 945, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านปิโตรเลียม ปิโตรเคมี และวัสดุขั้นสูง', '1', 'Y'),
(107, 110, 947, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านวิจัยและนวัตกรรมเพื่อสิ่งแวดล้อม', '1', 'Y'),
(108, 110, 948, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านเทคโนโลยีพลังงานและสิ่งแวดล้อม', '1', 'Y'),
(109, 57, 949, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านเทคโนโลยีหลังการเก็บเกี่ยว', '1', 'Y'),
(110, 57, 950, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านเทคโนโลยีชีวภาพเกษตร', '1', 'Y'),
(111, 131, 960, 'สถานปฏิบัติการแพทย์แผนไทยประยุกต์', '1', 'Y'),
(112, 123, 1000, 'ภาควิชาทัศนมาตรศาสตร์', '1', 'Y'),
(113, 123, 1001, 'สถานปฏิบัติการส่งเสริมสุขภาพ', '1', 'Y'),
(114, 104, 1084, 'สถานบริการวิชาการด้านวิทยาศาสตร์การแพทย์', '1', 'Y'),
(115, 95, 1085, 'ภาควิชาการบัญชี', '1', 'Y'),
(116, 95, 1086, 'ภาควิชาการท่องเที่ยว', '1', 'Y'),
(117, 93, 1088, 'ภาควิชาภาษาศาสตร์ คติชนวิทยา ปรัชญาและศาสนา', '1', 'Y'),
(118, 93, 1090, 'ภาควิชาดนตรี', '1', 'Y'),
(119, 93, 1091, 'ภาควิชาภาษาอังกฤษ', '1', 'Y'),
(120, 93, 1092, 'ภาควิชาภาษาไทย', '1', 'Y'),
(121, 93, 1093, 'ภาควิชาศิลปะการแสดง', '1', 'Y'),
(122, 820, 1180, 'สำนักงานเลขานุการ', '1', 'Y'),
(123, 820, 1181, 'ฝ่ายวิชาการ', '1', 'Y'),
(124, 74, 1280, 'ภาควิชาเวชศาสตร์ครอบครัว', '1', 'Y'),
(125, 110, 1320, 'สถานวิจัยเพื่อความเป็นเลิศด้านนวัตกรรมถนนและระบบราง', '1', 'Y'),
(126, 95, 1360, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านการจัดการการท่องเที่ยว', '1', 'Y'),
(127, 121, 1406, 'สถานการออกแบบทางศิลปะและสถาปัตยกรรม', '1', 'Y'),
(128, 110, 1460, 'สถานวิจัยเพื่อความเป้นเลิศทางวิชาการด้านทรัพยากรน้ำ', '1', 'Y'),
(129, 110, 1462, 'สถานวิจัยเพื่อความเป้นเลิศทางวิชาการด้านนวัตกรรมและเทคโนโลยีเพื่อการบำบัดน้ำ', '1', 'Y'),
(130, 97, 1463, 'สถานวิจัยเพื่อความเป้นเลิศทางวิชาการด้านฟิสิกส์ประยุกต์', '1', 'Y'),
(131, 104, 1464, 'สถานวิจัยเพื่อความเป้นเลิศทางวิชาการด้านเห็ดและรา', '1', 'Y'),
(132, 95, 1466, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านการจัดการวิสาหกิจขนาดกลางและขนาดย่อม', '1', 'Y'),
(133, 95, 1480, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านตลาดทุน', '1', 'Y'),
(134, 1500, 1501, 'สำนักงานเลขานุการ', '1', 'Y'),
(135, 57, 1508, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาการด้านไขมันและน้ำมัน', '1', 'Y'),
(136, 74, 1620, 'สถานรักษาแก้ไขภาวะปากแหว่งเพดานโหว่และความผิดปกติของศรีษะและใบหน้า', '1', 'Y'),
(137, 116, 1660, 'ภาควิชาพลศึกษาและวิทยาศาสตร์การออกกำลังกาย', '1', 'Y'),
(138, 97, 1740, 'สถานวิจัยเพื่อความเป็นเลิศทางวิชาด้านวัสดุชีวภาพ', '1', 'Y'),
(139, 1, 1763, '-', '1', 'Y'),
(140, 1780, 1781, 'สำนักงานเลขานุการ', '1', 'Y'),
(141, 1, 1825, 'กองพัฒนาภาษาและกิจการต่างประเทศ', '1', 'Y'),
(142, 1, 1829, 'กองส่งเสริมการบริการวิชาการ', '1', 'Y'),
(143, 1, 1834, 'กองการถ่ายทอดเทคโนโลยี', '1', 'Y'),
(144, 88, 1860, 'สถานวิจัยเครื่องสำอางและผลิตภัณฑ์ธรรมชาติ', '1', 'Y'),
(145, 1, 1960, 'โรงเรียนสาธิตมหาวิทยาลัยนเรศวร(ปฐมวัยและประถมศึกษา)', '1', 'Y'),
(146, 88, 2000, 'สถานปฏิบัติการเภสัชกรรมชุมชน', '1', 'Y'),
(147, 129, 2020, 'สถานประชาคมอาเซียนศึกษา', '1', 'Y'),
(148, 129, 2021, 'ศูนย์ความเป็นเลิศทางวิชาการด้านประชาคมอาเซียนศึกษา', '1', 'Y'),
(149, 2267, 2268, 'สำนักงานเลขานุการ', '1', 'Y'),
(150, 2267, 2269, 'ฝ่ายกิจการสภามหาวิทยาลัย', '1', 'Y'),
(151, 2267, 2270, 'ฝ่ายตรวจสอบและเสริมสร้างธรรมาภิบาล', '1', 'Y');

-- --------------------------------------------------------

--
-- Table structure for table `d_desire_study_further`
--

CREATE TABLE `d_desire_study_further` (
  `desire_study_id` int(11) NOT NULL,
  `desire_desc` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_desire_study_further`
--

INSERT INTO `d_desire_study_further` (`desire_study_id`, `desire_desc`) VALUES
(1, 'สนใจ'),
(2, 'ไม่สนใจ');
...
--
-- Table structure for table `d_disclosure_agreement`
--

CREATE TABLE `d_disclosure_agreement` (
  `disclosure_agree_id` int(11) DEFAULT NULL,
  `disclosure_agree_desc` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_disclosure_agreement`
--

INSERT INTO `d_disclosure_agreement` (`disclosure_agree_id`, `disclosure_agree_desc`) VALUES
(0, 'ไม่ยินยอมเปิดเผยข้อมูล'),
(1, 'ยินยอมเปิดเผยข้อมูลต่อนายจ้างทุกประเภท'),
(2, 'ยินยอมเปิดเผยข้อมูลยกเว้นนายจ้างประเภทจ้างเหมาแรงงาน'),
(3, 'ยินยอมเปิดเผยข้อมูลยกเว้นนายจ้างประเภทขายประกัน/ขายตรง'),
(4, 'ยินยอมเปิดเผยข้อมูลยกเว้นนายจ้างประเภทจ้างเหมาแรงงาน และประเภทขายประกัน/ขายตรง');

-- --------------------------------------------------------

--
-- Table structure for table `d_faculty`
--
...
--
-- Table structure for table `d_lev_degree`
--

CREATE TABLE `d_lev_degree` (
...
--
-- Table structure for table `d_lev_edu`
--

CREATE TABLE `d_lev_edu` (
  `lev_edu_id` int(11) DEFAULT NULL,
  `lev_edu_name` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_lev_edu`
--

INSERT INTO `d_lev_edu` (`lev_edu_id`, `lev_edu_name`) VALUES
(10, 'ประกาศนียบัตรวิชาชีพชั้นสูง'),
(20, 'อนุปริญญา'),
(30, 'ปริญญาตรี'),
(40, 'ประกาศนียบัตรบัณฑิต'),
(50, 'ปริญญาโท'),
(60, 'ประกาศนียบัตรบัณฑิตชั้นสูง'),
(70, 'ปริญญาเอก'),
(80, 'ประกาศนียบัตรหรือหลักสูตรเฉพาะ(ที่บรรจุในอัตราเงินเดือนสูงกว่าปริญญาเอก)');

-- --------------------------------------------------------

--
-- Table structure for table `d_major`
--
...
--
-- Dumping data for table `d_major`
--

INSERT INTO `d_major` (`major_ID`, `major_name`) VALUES
(0, 'สาขาวิชาเดิม'),
(1, 'สาขาวิชาวิศวกรรมคอมพิวเตอร์'),
(2, 'สาขาวิชาบริบาลเภสัชกรรม');

-- --------------------------------------------------------

--
-- Table structure for table `d_match_edu`
--

CREATE TABLE `d_match_edu` (
  `match_edu_id` varchar(255) DEFAULT NULL,
  `match_edu_desc` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_match_edu`
--

INSERT INTO `d_match_edu` (`match_edu_id`, `match_edu_desc`) VALUES
('1', 'ตรง'),
('2', 'ไม่ตรง');
...
--
-- Table structure for table `d_military_status`
--

CREATE TABLE `d_military_status` (
  `military_status_id` int(11) DEFAULT NULL,
  `military_status_desc` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_military_status`
--

INSERT INTO `d_military_status` (`military_status_id`, `military_status_desc`) VALUES
(10, 'เพศหญิง'),
(11, 'อยู่ในช่วงผ่อนผันเกณฑ์ทหารหรือได้รับการยกเว้นหรือผ่านการเกณฑ์ทหารแล้ว'),
(12, 'อยู่ในระหว่างการเป็นทหารเกณฑ์');
...
CREATE TABLE `d_nationality` (
  ...
  `national_fullname` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `d_nationality` (`national_code`, `national_fullname`) VALUES
('AD', 'ANDORRA'),
...
('YT', 'MAYOTTE'),
('ZA', 'SOUTH AFRICA'),
('ZM', 'Zaire see CONGO, THE DEMOCRATIC REPUBLIC OF THE ZAMBIA'),
('ZW', 'ZIMBABWE');

-- --------------------------------------------------------

--
-- Table structure for table `d_occup_type`
--

CREATE TABLE `d_occup_type` (
  `occup_type_id` int(11) DEFAULT NULL,
  `occup_type_desc` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_occup_type`
--

INSERT INTO `d_occup_type` (`occup_type_id`, `occup_type_desc`) VALUES
(1, 'ข้าราชการ /เจ้าหน้าที่หน่วยงานของรัฐ'),
(2, 'รัฐวิสาหกิจ'),
(3, 'พนักงานบริษัท/องค์กรธุรกิจเอกชน'),
(4, 'ดำเนินธุรกิจอิสระ/เจ้าของกิจการ'),
(5, 'พนักงานองค์การต่างประเทศ/ระหว่างประเทศ'),
(6, 'เป็นข้อความที่ผู้ใช้ระบุเพิ่มเติม');

-- --------------------------------------------------------

--
-- Table structure for table `d_ordinate_status`
--

CREATE TABLE `d_ordinate_status` (
  `ordinate_status_id` varchar(255) DEFAULT NULL,
  `ordinate_status_desc` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_ordinate_status`
--

INSERT INTO `d_ordinate_status` (`ordinate_status_id`, `ordinate_status_desc`) VALUES
('1', 'ไม่ได้เป็นนักบวช'),
('2', 'อยู่ในระหว่างการเป็นนักบวช ระยะเวลาถึงกำหนดลาสิกขา น้อยกว่า 3 เดือน'),
('3', 'อยู่ในระหว่างการเป็นนักบวช ระยะเวลาถึงกำหนดลาสิกขา 4 เดือน - 1 ปี'),
('4', 'อยู่ในระหว่างการเป็นนักบวช ระยะเวลาถึงกำหนดลาสิกขา มากกว่า 1 ปี'),
('5', 'อยู่ในระหว่างการเป็นนักบวช ระยะเวลาถึงกำหนดลาสิกขา ไม่มีกำหนด');

-- --------------------------------------------------------

--
-- Table structure for table `d_position_career`
--

CREATE TABLE `d_position_career` (
  `possition_id` int(11) DEFAULT NULL,
  `position_name` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_position_career`
--

INSERT INTO `d_position_career` (`possition_id`, `position_name`) VALUES
(11010, 'ทหาร'),
...
(214890, 'นักทำแผนที่และนักสำรวจอื่น ๆ'),
(214910, 'วิศวกรอุตสาหการ'),
(214920, 'วิศวกรควบคุมประสิทธิภาพ'),
(214925, 'วิศวกรคุณภาพ ;วิศวกรควบคุมคุณภาพ'),
(214930, 'วิศวกรอุตสาหกรรมการผลิต; วิศวกรอุตสาหกรรมโรงงาน'),
(214934, 'วิศวกรสิ่งทอ ; วิศวกรอุตสหกรรมสิ่งทอ'),
(214936, 'วิศวกรเสื้อผ้าและเครื่องนุ่งห่ม'),
(214940, 'วิศวกรความปลอดภัย'),
(214945, 'วิศวกรความปลอดภัย (ผลิตภัณฑ์)'),
(214950, 'วิศวกรสิ่งแวดล้อม,วิศวกรประปา,วิศวกรบำบัดนำเสีย'),
(214990, 'สถาปนิกวิศวกรและผู้ประกอบวิชาชีพที่เกี่ยวข้องอื่น ๆ'),
(221110, 'นักชีววิทยาทั่วไป'),
(221120, 'นักพฤษศาสตร์'),
(221130, 'นักสัตววิทยา'),
(221140, 'นักจุลชีววิทยาและไวรัส'),
(221150, 'นักนิเวศวิทยา'),
(221160, 'นักเทคโนโลยีชีวภาพ'),
(221170, 'นักวิทยาศาสตร์ทางทะเล'),
(221190, 'นักชีววิทยาและนักวิทยาศาสตร์ที่เกี่ยวข้องกันอื่นๆ'),
(221210, 'นักเภสัชวิทยา'),
(221220, 'นักเภสัชววิทยา'),
(221225, 'นักสรีรวิทยา'),
(221230, 'นักชีวเคมี'),
(221235, 'นักฟิสิกส์ชีวภาพ'),
(221240, 'นักพยาธิวิทยา'),
(221245, 'นักโรคพืช'),
(221250, 'นักเทคนิคการแพทย์'),
(221255, 'นักรังสีเทคนิค'),
(221290, 'นักเภสัชวิทยา นักพยาธิวิทยาและผู้ประกอยวิชาชีพที่เกี่ยวข้องอื่นๆ'),
(221320, 'นักพืชไร่ , พืชกร'),
(221330, 'นักพืชสวน'),
(221340, 'นักวิทยาศาสตร์ป่าไม้ , นักวนวัฒนวิทยา'),
(221345, 'นักวิชาการป่าไม้'),
(221350, 'นักปฐพีวิทยา,  นักวิทยาศาสตร์การเกษตรทางดิน'),
(221360, 'นักสัตวบาล'),
(221365, 'นักกีฏวิทยา'),
(221390, 'นักเกษตรกรรมและผู้ประกอบวิชาชีพที่เกี่ยวข้องอื่น ๆ'),
(222110, 'แพทย์ทั่วไป'),
(222115, 'แพทย์เฉพาะทาง (จักษุแพทย์  ,  สูตินารีแพทย์ , กุมารแพทย์)'),
(222120, 'แพทย์อายุรกรรม , อายุรแพทย์'),
(222122, 'โสต-ศอ-นาสิกและลาริงซ์วิทยา'),
(222124, 'จักษุแพทย์'),
(222130, 'ศัลยแพทย์'),
(222135, 'ศัลยแพทย์เฉพาะทางกระดูกและข้อ'),
(222137, 'วิสัญญีแพทย์'),
(222140, 'แพทย์สูติ-นรีแพทย์'),
(222145, 'กุมารแพทย์'),
(222150, 'จิตแพทย์'),
(222160, 'รังสีแพทย์'),
(222165, 'แพทย์กายภาพบำบัด'),
(222170, 'แพทย์เวชศาสตร์ฟื้นฟู'),
(222180, 'แพทย์ตจวิทยา (แพทย์โรคผิวหนัง)'),
(222190, 'แพทย์อื่น ๆ'),
(222210, 'ทันตแพทย์ทั่วไป'),
(222215, 'ทันตแพทย์เฉพาะทาง (ทันตแพทย์สำหรับเด็ก)'),
(222220, 'ทันตแพทย์เฉพาะทาง (ศัลยศาสตร์ช่องปากและแม็กซิลโลเฟเชียล)'),
(222225, 'ทันตแพทย์เฉพาะทาง (วิทยาการวิจัยโรคช่องปาก)'),
(222230, 'ทันตแพทย์   (จัดฟัน)'),
(222235, 'ทันตแพทย์เฉพาะทาง (ทันกรรมประดิษฐ์)'),
(222240, 'ทันตแพทย์เฉพาะทาง (ทันตสาธารณสุข)'),
(222245, 'ทันตแพทย์เฉพาะทาง (ทันตกรรรมหัตถการ)'),
(222250, 'ทันตแพทย์เฉพาะทาง (ปริทันตวิทยา)'),
(222255, 'ทันตแพทย์เฉพาะทาง (วิทยาเอ็นโดดอนต์)'),
(222290, 'ทันตแพทย์อื่น ๆ'),
(222310, 'สัตวแพทย์ทั่วไป'),
(222320, 'สัตวแพทย์สัตว์เลี้ยง'),
(222330, 'สัตวแพทย์สัตว์ป่า'),
(222340, 'สัตวแพทย์สัตว์น้ำ'),
(222350, 'สัตวแพทย์ปศุสัตว์'),
...
(241290, 'ผู้ประกอบวิชาชีพด้านงานบุคลากร และงานอาชีพอื่น ๆ'),
(241920, 'นักโฆษณา ; ผู้สร้างสรรค์งานโฆษณา'),
(241930, 'เจ้าหน้าที่ประชาสัมพันธ์/นักประชาสัมพันธ์'),
(241935, 'เจ้าหน้าที่สร้างสรรค์งานประชาสัมพันธ์'),
(241940, 'นักวิเคราะห์ตลาด'),
(241950, 'นักวิจัยตลาด'),
(241960, 'นักการตลาด ; เจ้าหน้าที่การตลาด ; เจ้าหน้าที่ส่งเสริมการขาย'),
(241970, 'เจ้าหน้าที่บริหารงานลูกค้า'),
(241980, 'นักวางแผนงานประชุม'),
(241990, 'ผู้ประกอบวิชาชีพทางธุรกิจ ที่มิได้จัดประเภทไว้ในที่อื่น'),
(242110, 'นักกฎหมายกฤษฎีการ'),
(242115, 'นิติกร'),
(242120, 'ทนายความ'),
(242130, 'พนักงานอัยการ'),
(242190, 'นักกฎหมายอื่น ๆ'),
(242220, 'ผู้พิพากษา , ตุลาการ'),
(242230, 'ตุลาการศาลรัฐธรรมนูญ'),
(242240, 'ตุลาการศาลปกครอง'),
(242250, 'อนุญาโตตุลาการ'),
(242290, 'ผู้ประกอบวิชาชีพด้านกฎหมายที่มิได้จัดประเภทไว้ที่อื่น'),
(242920, 'ที่ปรึกษาทางกฎหมาย , เจ้าหน้าที่ฝ่ายกฎหมาย'),
(242930, 'เจ้าหน้าที่ชันสูตรศพ'),
(243110, 'ภัณฑารักษ์'),
(243120, 'นักจดหมายเหตุ'),
(243190, 'ภัณฑารักษ์อื่น ๆ'),
(243210, 'บรรณารักษ์'),
(243220, 'นักเอกสารสนเทศ'),
(243290, 'บรรณารักษ์และผู้ประกอบวิชาชีพด้านงานสนเทศอื่น ๆ'),
(244110, 'นักเศรษฐศาสตร์ทั่วไป'),
(244120, 'นักเศรษฐศาสตร์เฉพาะสาขา  (การเงิน , การคลัง, การค้าระหว่างประเทศ )'),
(244220, 'นักสังคมวิทยา'),
(244230, 'นักมนุษยวิทยา'),
(244240, 'นักโบราณคดี'),
(244250, 'นักภูมิศาสตร์'),
(244320, 'นักปรัชญา'),
(244330, 'นักประวัติศาสตร์ (สังคม, การเมือง, เศรษฐกิจ)'),
(244340, 'นักรัฐศาสตร์'),
(244420, 'ล่าม'),
(244430, 'นักภาษาศาสตร์, นักนิรุกติศาสตร์'),
(244440, 'นักแปล'),
(244450, 'นักแปลบท (โทรทัศน์, ภาพยนตร์)'),
(244455, 'ผู้แปลข่าว'),
(244510, 'นักจิตวิทยาทั่วไป'),
(244520, 'นักจิตวิทยาเฉพาะสาขา   (การพยาบาล , การศึกษา , สังคม , อุตสาหกรรม)'),
(244590, 'นักจิตรวิทยาอื่นๆ'),
(244610, 'นักสังคมสงเคราะห์ทั่วไป'),
...
(311110, 'ช่างเทคนิคเคมี , ช่างเทคนิค  (อินทรีย์เคมี , ยาง , พลาสติก  ,     พอลิเมอร์, สี, กระดาษ, น้ำมัน, เส้นใย, อาหารและเครื่องดื่ม)'),
(311120, 'ช่างเทคนิคทางฟิสิกส์'),
(311125, 'เจ้าหน้าที่เทคนิคนิวเคลียร์'),
(311130, 'เจ้าหน้าที่เทคนิคอุตุนิยมวิทยา , ช่างเทคนิคอุตุนิยมวิทยา'),
(311140, 'เจ้าหน้าที่เทคนิคทางธรณีวิทยา'),
(311190, 'เจ้าหน้าที่เทคนิควิทยาศาสตร์กายภาพและเคมีอื่น ๆ'),
(311210, 'ช่างเทคนิควิศวกรรมโยธา'),
(311220, 'ช่างเทคนิควิศวกรรมโยธา  (ก่อสร้าง)'),
(311290, 'ช่างเทคนิควิศวกรรมโยธาอื่น ๆ'),
(311310, 'ช่างเทคนิควิศวกรรมไฟฟ้า'),
(311320, 'ช่างเทคนิควิศวกรรมไฟฟ้า  (สายส่งไฟฟ้ากำลัง)'),
(311330, 'ช่างเทคนิควิศวกรรมไฟฟ้าเครื่องวัดและควบคุม'),
(311390, 'ช่างเทคนิควิศวกรรมไฟฟ้าอื่น ๆ'),
(311410, 'ช่างเทคนิควิศวกรรมอิเล็กทรอนิกส์'),
(311420, 'ช่างเทคนิควิศวกรรมโทรคมนาคม'),
(311430, 'ช่างเทคนิควิศวกรรมคอมพิวเตอร์'),
(311490, 'ช่างเทคนิควิศวกรรมอิเล็กทรอนิกส์และโทรคมนาคมอื่น ๆ'),
(311510, 'ช่างเทคนิควิศวกรรมเครื่องกล,ผู้ควบคุมช่างหรือพนักงานอื่นๆที่เกี่ยวกับการผลิต'),
(311520, 'ช่างเทคนิควิศวกรรม  เครื่องยนต์  เครื่องจักรและอุปกรณ์'),
(311530, 'ช่างเทคนิควิศวกรรมการต่อเรือ'),
(311540, 'ช่างเทคนิควิศวกรรมพลังงานนิวเคลียร์'),
(311550, 'ช่างเทคนิควิศวกรรมอากาศยาน'),
(311560, 'ช่างเทคนิคแมคคาทรอนิกส์'),
(311570, 'ช่างเทคนิคการหล่อ'),
(311580, 'ช่างเทคนิควิศวกรรมระบบปรับอากาศ'),
(311585, 'ช่างเทคนิควิศวกรรมระบบทำความเย็น'),
(311590, 'ช่างเทคนิควิศวกรรมเครื่องกลอื่น ๆ'),
(311610, 'ช่างเทคนิควิศวกรรมเคมี'),
(311615, 'ช่างเทคนิควิศวกรรมเคมี  (ปิโตรเลียมและก๊าซ)'),
(311690, 'ช่างเทคนิควิศวกรรมเคมีอื่น ๆ'),
(311710, 'เจ้าหน้าที่เทคนิคเหมืองแร่ทั่วไป, ช่างเทคนิค'),
(311720, 'เจ้าหน้าที่เทคนิควิศวกรรมเหมืองแร่ปิโตรเลียมและก๊าซธรรมชาติ    :ช่างเทคนิค'),
(311730, 'เจ้าหน้าที่เทคนิควิศวกรรมโลหะ , ช่างเทคนิค'),
(311740, 'เจ้าหน้าที่เทคนิคโลหกรรม (ถลุง แยกและหลอมโลหะ) ,  ช่างเทคนิคโลหะกรรม'),
(311790, 'ช่างเทคนิคเหมืองแร่และโลหะวิทยาอื่น ๆ'),
(311810, 'ช่างเขียนแบบทั่วไป'),
(311815, 'ช่างเขียนแบบสถาปัตยกรรม'),
(311820, 'ช่างเขียนแบบโครงสร้าง  ,  งานวิศวกรรมโยธา'),
(311830, 'ช่างเขียนแบบงานเครื่องกล'),
(311835, 'ช่างเขียนแผนที่'),
(311840, 'ช่างเขียนแบบงานไฟฟ้า'),
(311850, 'ช่างเขียนแบบเรือ'),
(311890, 'ช่างเขียนแบบอื่น ๆ'),
(311920, 'ช่างเทคนิคควบคุมประสิทธิภาพ  (อุตสาหกรรมการผลิต, สิ่งทอ, แก้ว, กระดาษ , เซรามิค, ซีเมนต์, ไม้, หนังสัตว์)'),
(311930, 'ช่างเทคนิควิศวกรรมระบบ (ยกเว้นคอมพิวเตอร์)'),
(311940, 'ช่างเทคนิควิศวกรรมการผลิต  (การวางแผน)'),
(311950, 'ช่างเทคนิควิศวกรรม (ระบบ) ความปลอดภัย'),
(311960, 'ช่างเทคนิคการสำรวจ  (ปริมาณ)'),
(311970, 'ผู้ประมาณการ (งานวิศวกรรม)'),
(311990, 'ช่างเทคนิควิทยาศาสตร์กายภาพและวิศวกรรมศาสตร์ที่มีมิได้จัดประเภทไว้ในที่อื่น ๆ'),
(312120, 'ผู้ช่วยงานด้านคอมพิวเตอร์'),
(312130, 'พนักงานขายด้านไอที (ตัวแทนบริการไอที)'),
(312210, 'ช่างเทคนิคระบบคอมพิวเตอร์'),
(312220, 'ผู้ปฏิบัติงานด้านระบบคอมพิวเตอร์   (เจ้าหน้าที่ควบคุมคอมพิวเตอร์ , เจ้าหน้าที่บริการประมวลผลข้อมูล)'),
(312320, 'ผู้ควบคุมหุ่นยนต์'),
(313110, 'ช่างถ่ายภาพบุคคล'),
(313112, 'ช่างภาพโฆษณา'),
(313114, 'ช่างภาพหนังสือพิมพ์'),
(313116, 'ช่างภาพสารคดี'),
(313118, 'ช่างภาพเพื่อการประชาสัมพันธ์'),
(313120, 'ช่างภาพประจำกล้องโทรทัศน์'),
(313125, 'ช่างถ่ายภาพยนตร์, ช่างกล้อง'),
(313130, 'ช่างเทคนิคงานกำกับภาพรายการโทรทัศน์'),
(313135, 'เจ้าหน้าที่ตัดต่อรายการโทรทัศน์'),
(313137, 'เจ้าหน้าที่กราฟฟิกรายการโทรทัศน์'),
(313140, 'ช่างเทคนิคบันทึกภาพ'),
(313145, 'ผู้ตัดต่อลำดับภาพยนตร์'),
(313150, 'ช่างเทคนิค , ผู้ช่วยกล้อง'),
(313160, 'ช่างเทคนิคงานเสียง , ผู้บันทึกเสียง , เจ้าหน้าที่บันทึกเสียงและ   ทำสำเนาเทปละครโทรทัศน์'),
(313170, 'เจ้าหน้าที่เทคนิคและซ่อมบำรุงประจำกองถ่ายรายการละคร    โทรทัศน์'),
(313190, 'ช่างภาพและเจ้าหน้าที่อุปกรณ์บันทึกภาพและเสียงอื่น ๆ'),
(313220, 'พนักงานประจำสถานีวิทยุกระจายเสียง ;  ผู้ควบคุมการออกอากาศรายการวิทยุกระจายเสียง'),
(313225, 'เจ้าหน้าที่เทคนิคประจำสถานีวิทยุกระจายเสียง'),
(313230, 'ผู้เชี่ยวชาญติดตั้งเครื่องฉายภาพยนตร์และปรับแต่งระบบเสียง'),
(313235, 'ผู้ฉายภาพยนตร์'),
(313240, 'พนักงานประจำสถานีโทรทัศน์ ; เจ้าหน้าที่เทคนิคงานแพร่ภาพสถานีโทรทัศน์'),
(313250, 'ช่างเทคนิคงานไมโครเวฟ'),
(313255, 'ช่างเทคนิคด้านดาวเทียมและเครื่องส่ง'),
(313260, 'ผู้ควบคุมสัญญาณ'),
(313270, 'พนักงานวิทยุประจำเรือ ; พนักงานสื่อสารประจำเรือ'),
(313290, 'เจ้าหน้าที่อุปกรณ์แพร่ภาพกระจายเสียงและโทรคมนาคมอื่น ๆ'),
(313320, 'เจ้าหน้าที่ควบคุมอุปกรณ์การวัดคลื่นไฟฟ้าหัวใจ'),
(313330, 'เจ้าหน้าที่ควบคุมอุปกรณ์เอ็กซเรย์ (ทางการแพทย์)'),
(313340, 'เจ้าหน้าที่ควบคุมอุปกรณ์สแกนนิ่ง'),
(313350, 'นักรังสีเทคนิค, เจ้าหน้าที่รังสีการแพทย์'),
(313390, 'เจ้าหน้าควบคุมอุปกรณ์การแพทย์อื่น ๆ'),
(313920, 'เจ้าหน้าที่อุปกรณ์ด้านทัศนศาสตร์  (ออฟจิตัล)  และอิเล็กทรอนิกส์ที่มิได้จัดประเภทไว้ในที่อื่น'),
(314120, 'นายช่างใหญ่ทางวิศวกรรม (เรือ)/ผู้ควบคุมงานฝ่ายช่าง'),
(314130, 'ต้นกล'),
(314132, 'รองต้นกล'),
(314134, 'นายช่างกล'),
(314136, 'นายช่างประจำเรือฝ่ายช่างกล'),
(314190, 'ช่างเทคนิคหรือช่างเครื่องประจำเรือ'),
(314220, 'ผู้บังคับการเรือ/นายเรือเดินทะเล'),
(314230, 'นายเรือ/ผู้ควบคุมเรือ'),
(314240, 'ต้นเรือ'),
(314245, 'นายประจำเรือฝ่ายเดินเรือ'),
(314250, 'ผู้นำร่อง/เจ้าพนักงานนำร่อง'),
(314260, 'ไต้ก๋ง (เรือประมง)'),
(314270, 'ช่างไฟประจำเรือ'),
(314275, 'พนักงานห้องเครื่องเรือ'),
(314290, 'นายเรือและผู้นำร่องอื่นๆ'),
(314310, 'นักบิน'),
(314320, 'นักบินเฉพาะงาน'),
(314330, 'ต้นหนประจำอากาศยาน'),
(314340, 'นายช่างประจำอากาศยาน'),
(314420, 'ผู้ควบคุมการจราจรทางอากาศ'),
(314520, 'ช่างเทคนิคความปลอดภัยด้านการจราจรทางอากาศ'),
(315120, 'ผู้ตรวจสอบอาคารสิ่งก่อสร้าง'),
(315130, 'ผู้ตรวจสอบอัคคีภัย'),
(315210, 'ผู้ตรวจสอบด้านความปลอดภัยและสุขอนามัย  (ด้านมลภาวะ , สิ่งแวดล้อม , การกำจัดของเสียในโรงงาน'),
(315220, 'ผู้ตรวจสอบความปลอดภัยในการทำงาน  , เจ้าหน้าที่ความปลอดภัย'),
(315225, 'เจ้าหน้าที่ตรวจสภาพอากาศยาน'),
(315227, 'นายตรวจอากาศยาน ; สารวัตรช่าง'),
(315230, 'ผู้ตรวจสอบคุณภาพผลิตภัณฑ์สินค้า (ไฟฟ้า , อิเล็กทรอนิกส์,เครื่องกล)'),
(315240, 'ผู้ตรวจสอบคุณภาพผลิตภัณฑ์สินค้า  (เส้นใย , เสื้อผ้าและผลิตภัณฑ์อื่น ๆ)'),
(315245, 'พนักงานตรวจสอบเส้นใย  สิ่งทอสิ่งถัก'),
(315247, 'พนักงานตรวจผืนผ้า'),
(315250, 'ผู้ตรวจสอบคุณภาพผลิตภัณฑ์ไม้'),
(315260, 'ผู้ควบคุมคุณภาพวัตถุดิบและผลิตภัณฑ์อาหาร'),
(315270, 'ผู้ตรวจสอบคุณภาพ (ด้านบริการ)'),
(315290, 'ผู้ตรวจสอบด้านความปลอดภัย สุขภาพ และคุณภาพผลิตภัณฑ์อื่น ๆ'),
(321120, 'เจ้าหน้าที่เทคนิคด้านชีววิทยา'),
(321190, 'เจ้าหน้าที่เทคนิคด้านวิทยาศาสตร์ชีวภาพอื่นๆ'),
(321220, 'เจ้าหน้าที่เทคนิคด้านเกษตรกรรม'),
(321230, 'เจ้าหน้าที่เทคนิคด้านการป่าไม้'),
(321240, 'เจ้าหน้าที่เทคนิคด้านปฐพีวิทยา'),
(321320, 'ที่ปรึกษาและผู้ชำนาญการด้านเกษตรกรรม'),
(321330, 'ที่ปรึกษาและผู้ชำนาญการด้านป่าไม้'),
(321340, 'เจ้าหน้าที่สาธิตด้านการเกษตร'),
(322120, 'ผู้ช่วยแพทย์'),
(322220, 'นักอาชีวอนามัย'),
(322230, 'ผู้เชี่ยวชาญด้านสุขอนามัย'),
(322240, 'นักสาธารณสุข , ผู้เชี่ยวชาญด้านสาธารณสุข'),
(322250, 'นักสุขศึกษา'),
(322290, 'ผู้เชี่ยวชาญด้านสุขอนามัยอื่น ๆ'),
(322320, 'ที่ปรึกษาด้านการควบคุมอาหาร , ผู้เชี่ยวชาญด้านโภชนาการ ,   นักโภชนาการ'),
(322330, 'นักกำหนดอาหาร'),
(322390, 'ผู้เชี่ยวชาญด้านโภชนาการ และนักโภชนาการอื่น ๆ'),
(322410, 'ผู้เชี่ยวชาญการตรวจวัดสายตา , ผู้ตรวจวัดสายตา'),
(322420, 'ช่างตัดและประกอบแว่นหรืออุปกรณ์ช่วยสายตา , ช่างทำแว่น'),
(322490, 'ผู้วัดสายตาประกอบแว่นและช่างทำแว่นอื่น ๆ'),
(322520, 'ผู้ช่วยด้านทันตกรรม , เจ้าหน้าที่ทันตกรรม'),
(322590, 'ผู้ช่วยด้านทันตกรรมอื่น ๆ'),
(322620, 'นักกายภาพบำบัด'),
(322690, 'นักกายภาพบำบัดอื่น ๆ'),
(322720, 'ผู้ช่วยสัตวแพทย์'),
(322730, 'เจ้าหน้าที่ผสมเทียม'),
(322740, 'นักเทคนิคการสัตวแพทย์'),
(322790, 'ผู้ช่วยสัตวแพทย์อื่น ๆ'),
(322820, 'ผู้ช่วยด้านเภสัชกรกรรม'),
(322920, 'นักอาชีวบำบัด'),
(322930, 'นักกิจกรรมบำบัด'),
(322940, 'ผู้เชี่ยวชาญด้านการแก้ไขข้อบกพร่องในการพูดและออกเสียง'),
(322990, 'ผู้เชี่ยวชาญด้านอาชีวบำบัดอื่น ๆ'),
(323120, 'ผู้ช่วยพยาบาล'),
(323190, 'ผู้ช่วยพยาบาลอื่น ๆ'),
(323220, 'ผู้ช่วยผดุงครรภ์'),
(323290, 'ผู้ช่วยผดุงครรภ์อื่น ๆ'),
(324120, 'แพทย์แผนโบราณ'),
(324130, 'หมอนวดแผนโบราณ'),
(324190, 'ผู้ประกอบอาชีพแพทย์แผนโบราณอื่นๆ'),
(324220, 'ผู้รักษาโรคโดยใช้พลังจิต, ความเชื่อ , ความศรัทธา'),
(324290, 'ผู้รักษาโรคโดยอาศัยความศรัทธาอื่น ๆ'),
(331020, 'ครูประถม  (ประกาศนียบัตร)'),
(332020, 'ครูอนุบาล  (ประกาศนียบัตร) ,ครูผู้ช่วย'),
(333020, 'ครูผู้ช่วย (การศึกษาพิเศษ)'),
(333030, 'ครูสอนคนพิการทางจิต , ครูผู้ช่วย'),
...
(612215, 'คนงานประจำฟาร์มสัตว์ปีก\\024'),
...
(614220, 'ผู้เผาถ่าน'),
(615110, 'ผู้เลี้ยงสัตว์น้ำ'),
(615120, 'ผู้เพาะและอนุบาลสัตว์น้ำ'),
(615130, 'คนงานเพาะเลี้ยงสัตว์น้ำ'),
(615210, 'ชาวประมงน้ำจืด'),
(615220, 'ประมงพื้นบ้าน / ประมงขนาดเล็ก'),
(615290, 'ชาวประมงและผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(615320, 'ชาวประมงน้ำลึก (ประมงพาณิชย์ , ประมงนอกน่านน้ำ)'),
(615420, 'นักล่าสัตว์ ; พราน'),
(615430, 'ผู้วางกับดักสัตว์'),
(615440, 'ผู้เก็บรังนกนางแอ่น'),
(615490, 'พราน ,  ผู้วางกับดักสัตว์และผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(621020, 'ผู้ปฏิบัติงานฝีมือในไร่, ฟาร์มในเชิงเศรษฐกิจแบบพอเพียง'),
(711120, 'คนงานเหมืองแร่  , พนักงานเหมืองแร่ทั่วไป (บนผิวดิน , ใต้ดิน)'),
(711130, 'คนงานเหมืองหิน  , พนักงานเหมืองหินทั่วไป'),
(711190, 'พนักงาน/คนงานเหมืองแร่และเหมืองหินอื่น ๆ'),
(711220, 'พนักงานวางระเบิดในเหมืองแร่และเหมืองหิน , พนักงานจุดระเบิด  (เหมืองแร่)'),
(711315, 'ช่างจัดเกรดหิน'),
(711320, 'ช่างตัดหิน'),
(711325, 'ช่างเลื่อยหิน'),
(711330, 'ช่างขัดหิน'),
(711335, 'ช่างขัดเงาหินด้วยมือ'),
(711340, 'ช่างขัดเงาหินด้วยเครื่องจักร'),
(711350, 'ช่างสลักหินเป็นรูปตัวอักษรด้วยมือ'),
(711355, 'ช่างสลักหินอ่อนด้วยมือ (น้ำกรด)'),
(711360, 'ช่างแกะสลักหินด้วยมือ'),
(711390, 'ช่างตัดและช่างแกะสลักหินอื่น ๆ'),
(712120, 'ช่างก่อสร้างด้วยวัสดุพื้น'),
(712220, 'ช่างก่ออิฐ   (ก่อสร้าง)'),
(712225, 'ช่างก่ออิฐ (อิฐทนไฟ)'),
(712230, 'ช่างก่อหิน (ก่อสร้าง)'),
(712240, 'ช่างปูบาทวิถี'),
(712290, 'ช่างก่ออิฐ  ช่างก่อหินอื่น ๆ'),
(712320, 'ช่างทำแบบหล่อคอนกรีต'),
(712330, 'ช่างปูนคอนกรีตเสริมเหล็ก (การก่อสร้าง)'),
(712340, 'ช่างตกแต่งผิวคอนกรีต'),
(712390, 'ช่างปูนคอนกรีตและผู้ปฏิบัติงานที่เกี่ยวข้องอื่นๆ'),
(712410, 'ช่างไม้ทั่วไป'),
(712420, 'ช่างไม้ปลูกสร้าง'),
(712430, 'ช่างไม้ต่อเรือใหญ่'),
(712440, 'ช่างไม้ต่อเรือเล็ก'),
(712450, 'ช่างทำเครื่องไม้  (เรือ   อากาศยาน  รถไฟและยานพาหนะอื่นๆ)'),
(712490, 'ช่างไม้และช่างทำเครื่องไม้อื่น ๆ'),
(712920, 'ช่างยกตั้งนั่งร้าน'),
(712930, 'ช่างรื้อถอน  (สิ่งก่อสร้าง)'),
(713120, 'ช่างมุงหลังคา (กระเบื้องและวัสดุที่คล้ายคลึงกัน)'),
(713130, 'ช่างมุงหลังคาด้วยแผ่นโลหะ'),
(713140, 'ช่างมุงหลังคาด้วยวัสดุผสม หรือวัสดุพิเศษ'),
(713150, 'ช่างมุงหลังคาจากวัสดุธรรมชาติ (หญ้า  ฟาง)'),
(713190, 'ช่างมุ่งหลังคาอื่น ๆ'),
(713210, 'ช่างปูกระเบื้อง'),
(713220, 'ช่างปูพื้นหินอ่อน'),
(713230, 'ช่างปูพื้น (ไม้ปาร์เก้)'),
(713240, 'ช่างปูพื้นด้วยกระเบื้องชนิดพิเศษ'),
(713290, 'ช่างปูพื้น และ ช่างปูกระเบื้องอื่น ๆ'),
(713310, 'ช่างฉาบปูน'),
(713320, 'ช่างตบแต่งงานปูน'),
(713330, 'ช่างทำพื้นหินขัด'),
(713390, 'ช่างฉาบปูนอื่น ๆ'),
(713420, 'ช่างติดตั้งฉนวน (เสียง)'),
(713430, 'ช่างติดตั้งฉนวน (เครื่องทำความเย็น  เครื่องปรับอากาศ)'),
(713440, 'ช่างติดตั้งฉนวน  (หม้อน้ำและท่อ)'),
(713490, 'ช่างติดตั้งฉนวนอื่น ๆ'),
(713520, 'ช่างติดกระจก (อาคารสิ่งก่อสร้าง)  , ช่างติดตั้งกระจก'),
(713530, 'ช่างติดกระจก  (ยานพาหนะ)  ,  ช่างติดบานกระจก (ยานพาหนะ)'),
(713540, 'ช่างติดกระจกชนิดพิเศษ'),
(713590, 'ช่างติดกระจกอื่น ๆ'),
(713610, 'ช่างวางท่อทั่วไปสำหรับงานอาคาร (ท่อขนาดเล็ก) ; ช่างซ่อมท่อ ; ช่างประปา'),
(713620, 'ช่างประกอบท่อ , ช่างปรับท่อ'),
(713630, 'ช่างติดตั้งเครื่องสุขภัณฑ์'),
(713636, 'ช่างวางท่อภายนอกอาคาร (ท่อขนาดใหญ่ / ท่อหลัก )'),
(713690, 'ช่างวางท่อและช่างปรับท่ออื่น ๆ'),
(713710, 'ช่างไฟฟ้าทั่วไป'),
(713715, 'ช่างไฟฟ้าประจำอาคาร'),
(713720, 'ช่างไฟฟ้าประจำอากาศยาน'),
(713730, 'ช่างไฟฟ้าประจำเรือ'),
(713740, 'ช่างไฟฟ้าประจำเวทีและห้องศิลป์'),
(713750, 'ช่างไฟฟ้าฝ่ายบำรุงรักษา'),
(713790, 'ช่างไฟฟ้าและช่างต่อสายไฟอื่น ๆ'),
(714120, 'ช่างทาสีอาคาร'),
(714130, 'ช่างทาสี (เรือ)  ,  ช่างทาสี (โครงเหล็กกล้าและลำเรือ)'),
(714140, 'ช่างทาสี  (ฉากเวที)'),
(714150, 'ช่างทาสีโลหะ'),
(714160, 'ช่างปิดกระดาษปุผนัง  , ช่างวอลเปเปอร์'),
(714190, 'ช่างทาสีและผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(714210, 'ช่างทาสีด้วยแปรง  (ผลิตภัณฑ์และเครื่องใช้)'),
(714215, 'ช่างพ่นสี  (ผลิตภัณฑ์และเครื่องใช้)'),
(714220, 'ช่างทาสีเครื่องหมาย'),
(714230, 'ช่างพ่นสีรถยนต์ , ช่างสีรถยนต์'),
(714240, 'ช่างเคลือบสีโดยใช้การจุ่มด้วยมือ'),
(714290, 'ช่างเคลือบผิวและผู้ปฏิบัติงานที่เกี่ยวข้องอื่นๆ'),
(714320, 'ผู้ทำความสะอาดอาคาร  (ภายนอก)'),
(714330, 'ผู้ฉีดพ่นทราย  (อาคาร) , ทำความสะอาด'),
(714340, 'ผู้กำจัดปลวก  มด  แมลง'),
(714390, 'ผู้ทำความสะอาดโครงสร้างอาคารสิ่งปลูกสร้างอื่น ๆ'),
(721120, 'ช่างทำแบบหล่อโลหะด้วยมือ, ช่างกระสวนหล่อโลหะ'),
(721130, 'ช่างทำแกนแบบหล่อโลหะด้วยมือ'),
(721190, 'ช่างทำแบบหล่อโลหะและช่างทำแกนแบบหล่อโลหะอื่น ๆ'),
(721220, 'ช่างเชื่อมโลหะด้วยแก๊ซ'),
(721230, 'ช่างเชื่อมโลหะด้วยไฟฟ้า'),
(721240, 'ช่างเชื่อมและตัดโลหะแบบต่าง ๆ (แบบ Tig , Mig , X - ray , Flux  cored  arc  )'),
(721290, 'ช่างเชื่อมและตัดโลหะด้วยเปลวไฟอื่น ๆ'),
(721310, 'ช่างโลหะแผ่นทั่วไป'),
(721320, 'ช่างโลหะแผ่น (ยานพาหนะ)'),
(721325, 'ช่างซ่อมตัวถังรถยนต์ ; ช่างเคาะพ่นสีรถยนต์'),
(721330, 'ช่างโลหะแผ่น (เครื่องเรือน)'),
(721340, 'ช่างซ่อมผลิตภัณฑ์โลหะ (ช่างดีบุก , ช่างบัดกรี, ช่างทองแดง)'),
(721350, 'ช่างโลหะ (เครื่องประดับ)'),
(721390, 'ช่างโลหะแผ่นอื่น ๆ'),
(721410, 'ช่างทำโลหะนำ , ช่างทำเครื่องหมายบนโลหะ'),
(721420, 'ช่างติดตั้งและประกอบโครงสร้างโลหะ; ช่างก่อสร้างโครงเหล็ก'),
(721425, 'ช่างทำโครงเหล็กในโรงงาน'),
(721430, 'ช่างย้ำหมุดงานโครงสร้างโลหะด้วยค้อนลม'),
(721435, 'ช่างย้ำหมุดด้วยมือ (งานโครงส้รางโลหะ)'),
(721440, 'ช่างต่อเรือ (โลหะ)'),
(721445, 'ช่างทำแผ่นเหล็กตัวเรือ'),
(721450, 'ช่างติดตั้งหม้อน้ำ'),
(721460, 'ช่างอลูมิเนียม'),
(721465, 'ช่างดัดแผ่นเหล็กกล้า'),
(721490, 'ช่างเตรียมและตั้งโครงสร้างโลหะอื่น ๆ'),
(721510, 'ช่างติดตั้งเครื่องยกทั่วไป'),
(721520, 'ช่างติดตั้งสายเคเบิ้ล  , ช่างฟั่นต่อเชือกและสายเคเบิ้ล'),
(721530, 'ช่างติดตั้งเครื่องประกอบ (เชือก ลวด สายเคเบิ้ล) ในเรือ'),
(721540, 'ช่างติดตั้งเครื่องยก (การก่อสร้าง)'),
(721550, 'ผู้ติดตั้งเครื่องเจาะ  (การเจาะบ่อน้ำมัน)'),
(721590, 'ช่างติดตั้งเครื่องยกและผู้ฟั่นต่อสายเคเบิ้ลอื่น ๆ'),
(721620, 'นักประดาน้ำ , ผู้กู้ภัยใต้น้ำ'),
(721630, 'ผู้ปฏิบัติงานใต้น้ำ (ก่อสร้างและบำรุงรักษาท่าเรือและอู่เรือ)'),
(722120, 'ช่างเหล็ก , ช่างผูกเหล็ก'),
(722130, 'คนตีเหล็ก'),
(722140, 'ช่างตัดเหล็ก'),
(722150, 'ช่างอัดบีบโลหะ, ช่างรีดโลหะ'),
(722160, 'พนักงานเครื่องทุบอัดโลหะ'),
(722190, 'ช่างเหล็ก ช่างตีเหล็ก และพนักงานเครื่องทุบอัดโลหะอื่น ๆ'),
(722210, 'ช่างทำเครื่องมือทั่วไป (งานโลหะ)'),
(722220, 'ช่างทำกุญแจ'),
(722230, 'ช่างทำอาวุธปืน'),
(722240, 'ช่างทำกระสุน'),
(722260, 'ช่างทำแม่พิมพ์ (โลหะ)'),
(722290, 'ช่างทำเครื่องมือและผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(722310, 'ช่างปรับตั้งและใช้เครื่องมือกล (งานโลหะทั่วไป)'),
(722320, 'ช่างปรับตั้งและใช้เครื่องกลึง (งานโลหะ)'),
(722330, 'ช่างปรับตั้งและใช้เครื่องเจาะ  (งานโลหะ)'),
(722340, 'ช่างปรับตั้งและใช้เครื่องเลื่อย(งานโลหะ)'),
(722350, 'ช่างปรับตั้งและใช้เครื่องไส (งานโลหะ)'),
(722360, 'ช่างปรับตั้งและใช้เครื่องกว้าน (งานโลหะ)'),
(722370, 'ช่างตั้งและใช้เครื่องตัดเฟือง'),
(722390, 'ช่างปรับตั้งและใช้เครื่องมือกลอื่น ๆ'),
(722420, 'ช่างเจียระไนโลหะ , พนักงานเครื่องเจียระไน'),
(722430, 'พนักงานเครื่องขัดมันกระบอกสูบ'),
(722440, 'ช่างขัดผิวโลหะ , พนักงานเครื่องขัดเงา'),
(722450, 'ช่างลับเครื่องมือกล'),
(722460, 'ช่างลับเลื่อย, ช่างซ่อมเลื่อย'),
(722470, 'ช่างลับเครื่องมือตัด (ยกเว้นเครื่องกล)'),
(722490, 'ช่างเจียระไนโลหะ ช่างขัดเงาโลหะ และ ช่างลับเครื่องมืออื่นๆ'),
(723120, 'ช่างปรับแต่งเครื่องยนต์ ; ช่างฟิตเครื่องยนต์ ;ช่างซ่อมยานยนต์'),
(723130, 'ช่างซ่อมจักรยานยนต์'),
(723190, 'ช่างซ่อมเครื่องจักรกลและยานยนต์อื่น ๆ'),
(723220, 'ช่างเทคนิคอากาศยาน  (เครื่องยนต์  เครื่องวัด  และอุปกรณ์) ; ช่างซ่อมเครื่องจักรกลอากาศยาน ; ช่างซ่อมปรับแต่งเครื่องยนต์ (อากาศยาน) ; ช่างฟิตอากาศยาน'),
(723310, 'ช่างซ่อมและปรับแต่งเครื่องจักรกลทั่วไป'),
(723320, 'ช่างซ่อมและปรับแต่งเครื่องจักรกล (เหมืองแร่)');
INSERT INTO `d_position_career` (`possition_id`, `position_name`) VALUES
(723330, 'ช่างซ่อมและปรับแต่งเครื่องจักรกล  (สิ่งทอ , สิ่งถัก)'),
(723340, 'ช่างซ่อมและปรับแต่งเครื่องจักรกล (ทางเกษตรกรรม)'),
(723350, 'ช่างซ่อมและปรับแต่งเครื่องจักรกล  (ทางอุตสาหกรรมการผลิต)'),
(723360, 'ช่างซ่อมเครื่องจักรกล (ก่อสร้างถนน)'),
(723370, 'ช่างซ่อมเครื่องจักรกล  (เครื่องยนต์เรือ)'),
(723380, 'พนักงานหยอดน้ำมันและอัดจาระบี (เครื่องยนต์และเครื่องจักร)'),
(723390, 'ช่างเครื่องและช่างปรับแต่งเครื่องจักรกลทางการเกษตรหรือ     อุตสาหกรรมอื่น ๆ'),
(724110, 'ช่างปรับไฟฟ้าทั่วไป'),
(724120, 'ช่างปรับไฟฟ้า  (อุปกรณ์ไฟฟ้ากำลัง)'),
(724125, 'ช่างปรับไฟฟ้า  (กระแสไฟฟ้า)'),
(724130, 'ช่างปรับไฟฟ้า (เครื่องมือไฟฟ้า)'),
(724140, 'ช่างปรับไฟฟ้า (เครื่องจักรกลสำนักงาน)'),
(724145, 'ช่างปรับไฟฟ้า (ระบบไฟสัญญาณ)'),
(724150, 'ช่างปรับไฟฟ้า (ยานยนต์)'),
(724155, 'ช่างปรับไฟฟ้า (ลิฟท์และอุปกรณ์ที่เกี่ยวข้องกัน)'),
(724160, 'ช่างปรับไฟฟ้า (อุปกรณ์ทำความเย็นและอากาศ)'),
(724165, 'ช่างปรับไฟฟ้า (เครื่องใช้ในบ้านเรือน)'),
(724190, 'ช่างปรับไฟฟ้าอื่น ๆ'),
(724210, 'ช่างปรับอิเล็กทรอนิกส์ทั่วไป'),
(724220, 'ช่างปรับอิเล็กทรอนิกส์ (เครื่องส่งวิทยุโทรทัศน์)'),
(724230, 'ช่างปรับอิเล็กทรอนิกส์ (อุปกรณ์ทางการแพทย์)'),
(724240, 'ช่างปรับอิเล็กทรอนิกส์ (อุปกรณ์ทางอุตสาหกรรม)'),
(724250, 'ช่างปรับอิเล็กทรอนิกส์ (อุปกรณ์โทรคมนาคม)'),
(724260, 'ช่างปรับอิเล็กทรอนิกส์ (คอมพิวเตอร์)'),
(724270, 'ช่างปรับอิเล็กทรอนิกส์  (เครื่องจักรกลสำนักงาน)'),
(724290, 'ช่างปรับแต่งอุปกรณ์อิเล็กทรอนิกส์อื่น ๆ'),
(724320, 'ช่างเครื่องอิเล็กทรอนิกส์  , ช่างซ่อมเครื่องอิเล็กทรอนิกส์'),
(724325, 'ช่างซ่อมเครื่องอิเล็กทรอนิกส์  (เครื่องใช้ในสำนักงาน)'),
(724330, 'ช่างซ่อมวิทยุและโทรทัศน์'),
(724340, 'ช่างซ่อมเครื่องฉายภาพยนตร์'),
(724350, 'ช่างซ่อมติดตั้งเสาอากาศ (วิทยุ/โทรทัศน์)'),
(724420, 'ช่างติดตั้งโทรศัพท์และโทรเลข'),
(724430, 'ช่างซ่อมเครื่องโทรศัพท์และโทรเลข'),
(724520, 'ช่างวางสายไฟ  (ไฟฟ้ากำลัง )'),
(724530, 'ช่างต่อเชื่อมสายเคเบิ้ล , ช่างวางสายเคเบิ้ล  ไฟฟ้า'),
(724540, 'ช่างวางท่อ (โทรศัพท์ ,  สายโทรเลข) ; ช่างวางสาย'),
(724590, 'ช่างวางสายไฟและช่างต่อสายเคเบิ้ลไฟฟ้าอื่น ๆ'),
(731120, 'ช่างเครื่องมืออุปกรณ์ทางการแพทย์'),
(731125, 'ช่างทำฟัน (ปลอม) , ช่างทันตกรรม , ช่างด้านฟัน'),
(731130, 'ช่างทำอุปกรณ์แขน - ขาเทียม (อุปกรณ์ช่วยความพิการ)'),
(731140, 'ช่างทำนาฬิกา ; ช่างซ่อมนาฬิกา'),
(731150, 'ช่างเครื่องมือวัดที่มีความเที่ยงตรงทางอุตุนิยมวิทยา'),
(731190, 'ช่างเครื่องมือและอุปกรณ์ที่มีความเที่ยงตรงแม่นยำอื่น ๆ'),
(731220, 'ช่างทำเครื่องดนตรี (เครื่องสาย)'),
(731230, 'ช่างทำเครื่องดนตรี (เครื่องเป่าที่ทำด้วยไม้)'),
(731240, 'ช่างทำเครื่องดนตรี (เครื่องเป่าจากโลหะ)'),
(731250, 'ช่างปรับเสียงเปียโน'),
(731290, 'ช่างทำเครื่องดนตรีและช่างปรับเสียงดนตรีอื่น ๆ'),
(731310, 'ช่างเพชรพลอยทั่วไป'),
(731320, 'ช่างทำต้นแบบตัวเรือนด้วยขี้ผึ้ง (เทียน)'),
(731322, 'ช่างทำต้นแบบตัวเรือนด้วยโลหะ'),
(731325, 'ช่างหล่อตัวเรือน'),
(731326, 'ช่างทำแม่พิมพ์ยาง'),
(731328, 'ช่างฉีดขี้ผึ้ง (เทียน)  ช่างเทียน ( Wax)'),
(731330, 'ช่างฝัง'),
(731335, 'ช่างขัดตกแต่งตัวเรือน'),
(731340, 'ช่างตัดพลอย'),
(731341, 'ช่างโกลนพลอยด้วยเครื่อง (ช่างบล๊อกพลอย)'),
(731342, 'ช่างตัดเหลี่ยมพลอย'),
(731343, 'ช่างขัดเงาพลอย'),
(731345, 'ช่างเจียระไนเพชร'),
(731346, 'ช่างเลื่อยเพชร (Sawing)'),
(731347, 'ช่างโกลนเพชร (Bruting)'),
(731348, 'ช่างโกลนเพชรด้วยเครื่องอัตโนมัติ'),
(731350, 'ช่างเงิน  ช่างทอง'),
(731355, 'ช่างถักเงิน/ทอง'),
(731359, 'ช่างตีทองและเงิน (เปลว)'),
(731360, 'ช่างชุบและเคลือบโลหะทั่วไป'),
(731365, 'ผู้ชุบโลหะโดยการจุ่มด้วยมือ'),
(731370, 'ช่างแต่งตัวเรือน'),
(731375, 'ช่างแต่งประกอบตัวเรือน'),
(731376, 'ช่างซ่อมอัญมณีและเครื่องประดับ'),
(731380, 'ช่างทำเครื่องถม'),
(731385, 'ช่างทำเครื่องเขิน'),
(731390, 'ช่างอัญมณีและช่างประดิษฐ์เครื่องประดับอื่น ๆ'),
(732110, 'ช่างเครื่องดินเผา'),
(732115, 'ช่างทำแบบพิมพ์เครื่องดินเผา'),
(732120, 'ช่างปั้นด้วยแป้นหมุน (เครื่องดินเผา)'),
(732125, 'ช่างปั้นด้วยจิกเกอร์ (เครื่องดินเผา)'),
(732130, 'ช่างกลึงเครื่องดินเผาด้วยเครื่องกลึง'),
(732135, 'ช่างหล่อสลิป'),
(732140, 'ช่างทำอิฐจากแบบพิมพ์ด้วยมือ'),
(732145, 'ช่างทำอิฐทนไฟจากแบบพิมพ์ด้วยมือ'),
(732150, 'ช่างทำกระเบื้องจากแบบพิมพ์ด้วยมือ'),
(732160, 'ช่างอัดเครื่องดินเผาด้วยมือ'),
(732165, 'ช่างอัดกระเบื้องด้วยมือ'),
(732170, 'ช่างขึ้นรูปผลิตภัณฑ์โดยการรีดดิน'),
(732190, 'ช่างเครื่องดินเผาอื่น ๆ'),
(732220, 'ช่างเป่าแก้ว'),
(732230, 'ช่างตัดหลอดแก้ว  ช่างตัดหลอดนีออน'),
(732240, 'ช่างตัดกระจก'),
(732250, 'ช่างฝนหรือเจียรขอบกระจก'),
(732260, 'ช่างขัดฝ้ากระจก'),
(732270, 'ช่างอัดแก้วด้วยมือ  ช่างปั๊มแก้ว'),
(732290, 'ช่างขึ้นรูป  ช่างตัด  ช่างฝนและช่างตกแต่งแก้วอื่น ๆ'),
(732320, 'ช่างเจียระไนแก้ว'),
(732330, 'ช่างกัดลายแก้วด้วยน้ำกรด'),
(732390, 'ช่างเจียระไนแก้วและช่างกัดลายแก้วด้วยน้ำกรดอื่น ๆ'),
(732420, 'ช่างฉาบพื้นกระจกเงา'),
(732430, 'ช่างทำกระจกเงาด้วยสารเงิน'),
(732435, 'ช่างทำกระจกหรือแก้วให้เป็นลายฝ้า'),
(732440, 'ช่างพิมพ์แก้ว'),
(732450, 'ช่างเขียนลายเครื่องดินเผาด้วยมือ'),
(732460, 'ช่างพ่นสีเครื่องดินเผา'),
(732470, 'ช่างชุบเครื่องดินเผาด้วยมือ'),
(732490, 'ช่างเขียนและช่างตกแต่งเครื่องแก้ว  เครื่องดินเผา และอื่น ๆ'),
(733120, 'ช่างทำผลิตภัณฑ์จากไม้ไผ่  (มู่ลี่   เสื่อ )'),
(733130, 'ช่างหัตถกรรม (งานไม้)'),
(733140, 'ช่างหัตถกรรม (งานหิน)'),
(733150, 'ช่างหัตถกรรม (กระดาษ) , ผู้ผลิตกระดาษสาและกล่องกระดาษด้วยมือ'),
(733220, 'ช่างทอผ้าด้วยหูกมือ'),
(733225, 'ช่างทอพรมด้วยหูกมือ'),
(733230, 'ช่างถักด้วยมือ'),
(733240, 'ช่างปักผ้าด้วยมือ  (พื้นบ้าน)'),
(733250, 'ช่างย้อมเส้นด้ายด้วยมือ'),
(733255, 'ช่างย้อมผืนผ้าด้วยมือ'),
(733260, 'ช่างย้อมเครื่องแต่งกาย'),
(733270, 'ช่างหัตถกรรม (เครื่องหนัง)'),
(733290, 'ช่างฝีมือหัตถกรรมสิ่งทอ  เครื่องหนัง  และผลิตภัณฑ์ที่เกี่ยวข้องอื่น ๆ'),
(734120, 'พนักงานเครื่องหล่อแถวตัวพิมพ์แบบลัดโลว์'),
(734130, 'ช่างเรียงพิมพ์'),
(734140, 'ช่างประกอบฟิล์ม'),
(734150, 'พนักงานเครื่องถ่ายฟิล์ม  , ช่างถ่ายฟิล์ม'),
(734160, 'พนักงานจัดเรียงแผ่นฟิล์ม (เลเอาท์)  ช่างจัดวางฟิล์ม,ช่างเลย์เอาต์ (ช่างเลย์)'),
(734170, 'ช่างแยกสี'),
(734190, 'ช่างเรียงตัวพิมพ์  ช่างจัดตัวพิมพ์  และผู้ปฏิบัติงานที่เกี่ยวข้อง'),
(734220, 'ช่างตบแบบและเทแบบ'),
(734290, 'ช่างทำแบบพิมพ์ด้วยวิธีการจำลองแบบและการชุบโลหะอื่นๆ'),
(734320, 'ช่างทำแม่พิมพ์ออฟเซท'),
(734330, 'ช่างทำแม่พิมพ์เลตเตอร์เพรส์ส'),
(734340, 'ช่างทำแม่พิมพ์เฟล็กโซกราฟี'),
(734350, 'ช่างทำแม่พิมพ์ร่องลึก   ช่างทำแม่พิมพ์อินทาโย'),
(734360, 'ช่างทำแม่พิมพ์พื้นลึก  ช่างทำแม่พิมพ์กราวัวร์'),
(734370, 'ช่างทำแม่พิมพ์สกรีน'),
(734390, 'ช่างทำแม่พิมพ์อื่น ๆ'),
(734420, 'ช่างล้างฟิล์มสี'),
(734430, 'ช่างล้างฟิล์มขาว-ดำ'),
(734440, 'ช่างอัดและขยายภาพ'),
(734490, 'ช่างถ่ายภาพและผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(734520, 'ช่างตัดกระดาษ'),
(734530, 'ช่างพับ'),
(734540, 'ช่างเก็บเล่ม'),
(734550, 'ช่างเย็บ (การพิมพ์)'),
(734560, 'ช่างทำแบบปั๊ม (die-cutting)'),
(734570, 'ช่างทำปกด้วยมือ'),
(734590, 'ช่างทำเล่มหนังสือและผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(734620, 'ช่างทำซิลด์สกรีน (การพิมพ์สิ่งทอสิ่งถัก)'),
(734630, 'ช่างพิมพ์สกรีนทองแดง (สิ่งทอสิ่งถัก)  ด้วยมือ , คนงานรีดสีบนสกรีน'),
(734640, 'ช่างพิมพ์สกรีนกระดาษด้วยมือ'),
(734690, 'ช่างพิมพ์สกรีนกระดาษและสิ่งทอสิ่งถักอื่น ๆ'),
(741110, 'ผู้ฆ่าสัตว์และ/หรือชำแหละเนื้อสัตว์'),
(741120, 'ผู้ฆ่าสัตว์ในโรงฆ่าสัตว์'),
(741130, 'ผู้ตัดและชำแหละเนื้อสัตว์'),
(741135, 'ผู้แล่ปลา'),
(741140, 'ผู้ถนอมและแปรรูปเนื้อสัตว์'),
(741150, 'ผู้แปรรูปสัตว์น้ำเบื้องต้น'),
(741155, 'ผู้ถนอมและแปรรูปเนื้อสัตว์น้ำ'),
(741160, 'ผู้ทำน้ำปลา'),
(741190, 'ผู้ฆ่า  ชำแหละเนื้อสัตว์และผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(741220, 'ผู้ทำขนมปังและขนมอบประเภทต่าง ๆ (ด้วยมือ)'),
(741230, 'ผู้ทำขนมหวานจากน้ำตาล  (ช็อกโกแลต  ลูกกวาด)'),
(741240, 'ผู้ทำขนมจากธัญชาติ'),
(741250, 'ผู้ทำเส้นขนมจีน'),
(741255, 'ผู้ทำเส้นหมี่'),
(741258, 'ผู้ทำเส้นก๋วยเตี๋ยว'),
(741260, 'ผู้ทำวุ้นเส้น'),
(741265, 'ผู้ทำเส้นบะหมี่'),
(741290, 'ผู้ทำผลิตผลิตภัณฑ์จากแป้งและน้ำตาลอื่น ๆ'),
(741310, 'ผู้ผลิตนมเนยทั่วไป'),
(741320, 'ผู้ผลิตเนย'),
(741330, 'ผู้ผลิตไอศกรีมด้วยมือ'),
(741390, 'ผู้ผลิตผลิตภัณฑ์จากนมอื่น ๆ'),
(741420, 'ผู้ถนอมพืช ผัก ผลไม้ตากแห้ง'),
(741430, 'ผู้ถนอมพืช ผัก ผลไม้ ด้วยวิธีการหมัก  ดองและเชื่อม'),
(741440, 'ผู้แปรรูปผลิตภัณฑ์น้ำพืช ผัก ผลไม้'),
(741490, 'ผู้ถนอมและแปรรูปผลิตภัณฑ์พืช ผัก ผลไม้ ซึ่งมิได้จัดประเภทไว้ในที่อื่น'),
(741520, 'ผู้คัดแยกและจัดระดับชั้นคุณภาพอาหาร  ผักและผลไม้'),
(741530, 'ผู้ชิมชา, กาแฟ'),
(741540, 'ผู้ชิมสุรา, ไวน์และไวน์ผลไม้'),
(741550, 'ผู้ชิมเบียร์'),
(741590, 'ผู้ชิมรสชาดและจัดลำดับชั้นคุณภาพของอาหารและเครื่องดื่ม    อื่น ๆ'),
(741610, 'ผู้บ่มใบยาสูบ , ผู้บ่มอิสระ'),
(741620, 'ผู้คัดและจัดชั้นใบยาสูบที่บ่มแล้ว'),
(741625, 'ผู้อัดห่อใบยา  ,  พนักงานอัดห่อใบยา'),
(741630, 'ผู้ตรวจคุณภาพใบยาสูบ'),
(741640, 'ผู้รูดก้านใบยาสูบด้วยมือ'),
(741650, 'ผู้ผลิตยาเส้นด้วยมือ'),
(741660, 'ผู้มวนบุหรี่อื่นด้วยมือ'),
(741665, 'ผู้มวนบุหรี่ซิการ์ด้วยมือ'),
(741670, 'ผู้ทำยานัตถุ์'),
(741690, 'ผู้เตรียมใบยาสูบ  ผู้ผลิตยาสูบและผลิตภัณฑ์ยาสูบอื่น ๆ'),
(742120, 'ผู้อัดน้ำยาไม้ ;  พนักงานเครื่องอัดน้ำยาไม้'),
(742130, 'ผู้อบไม้ ; ผู้ควบคุมการอบไม้'),
(742190, 'ผู้อัดและอบน้ำยาไม้อื่น ๆ'),
(742210, 'ช่างทำเครื่องเรือนไม้'),
(742220, 'ช่างทำแบบไม้'),
(742225, 'ช่างออกแบบเครื่องเรือนไม้'),
(742230, 'ช่างแกะสลักไม้'),
(742235, 'ช่างประดับมุก'),
(742237, 'ช่างฝังรอยไม้'),
(742240, 'ช่างสีเครื่องเรือนไม้'),
(742250, 'ช่างไม้ในอาคาร'),
(742260, 'ช่างทำของเล่นไม้'),
(742270, 'ช่างตกแต่งภายในอาคารด้วยไม้'),
(742275, 'ช่างปูพื้นไม้'),
(742280, 'ผู้ตรวจและคัดแยกประเภทและชั้นคุณภาพไม้'),
(742290, 'ช่างทำเครื่องเรือนไม้และผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(742310, 'ช่างปรับตั้งเครื่องมือทำงานไม้ทั่วไป'),
(742320, 'ช่างปรับตั้งและใช้เครื่องเลื่อยไม้ด้วยมือ'),
(742330, 'ช่างปรับตั้งและใช้เครื่องกลึงไม้ ; ช่างกลึงไม้'),
(742340, 'ช่างปรับตั้งและใช้เครื่องทำบัวหรือร่องด้วยมือ'),
(742350, 'ช่างปรับตั้งและใช้เครื่องไสไม้ด้วยมือ'),
(742360, 'ช่างปรับตั้งและใช้เครื่องแกะสลักงานไม้ด้วยมือ'),
(742390, 'ช่างปรับตั้งและใช้เครื่องมืองานไม้อื่น ๆ'),
(742420, 'ช่างสานตะกร้า  กระจาด  ,ช่างทำผลิตภัณฑ์จักสาน'),
(742425, 'ช่างจักสานเครื่องเรือน'),
(742430, 'ช่างทำแปรง'),
(742440, 'ช่างทำไม้กวาด'),
(742490, 'ช่างจักสาน  ช่างทำแปรงและผู้ปฏิบัติงานที่เกี่ยวข้องอื่นๆ'),
(743120, 'ผู้จัดเกรดและผู้จัดประเภทเส้นใยฝ้าย'),
(743130, 'ผู้คัดเลือกปอ  พนักงานคัดเลือกปอ'),
(743140, 'ผู้ตีเส้นใย  ผู้หีบฝ้าย'),
(743150, 'ผู้สาวและบิดเกลียวไหมด้วยมือ  ผู้สาวและบิดเกลียวไหมจาก    รังไหม'),
(743160, 'ผู้ลอกกาวเส้นไหม'),
(743190, 'ผู้เตรียมเส้นใยอื่น ๆ'),
(743220, 'ผู้ปั่นด้ายด้วยมือ'),
(743225, 'พนักงานควบเส้นด้ายด้วยมือ'),
(743230, 'ช่างทำเกลียวเส้นด้ายด้วยมือ'),
(743240, 'พนักงานกรอด้ายด้วยมือ'),
(743245, 'พนักงานร้อยตะกรอเพื่อใช้ในการทอมือ ;  ผู้ร้อยตะกรอด้วยมือ'),
(743250, 'ช่างซ่อมผืนผ้า'),
(743260, 'ช่างทอผ้าด้วยหูกมือ'),
(743265, 'ช่างทอพรมด้วยหูกมือ'),
(743270, 'ช่างถัก (เครื่องจักรที่ควบคุมด้วยมือ)'),
(743275, 'ช่างถักโครเชต์ด้วยมือ'),
(743290, 'ช่างทอ  ช่างถัก  และผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(743320, 'ช่างตัดเย็บเสื้อผ้า  (เฉพาะบุคคล)'),
(743330, 'ช่างตัดเย็บเสื้อผ้า  (สำเร็จรูป)'),
(743340, 'ช่างประดิษฐ์เครื่องแต่งกาย'),
(743350, 'ช่างทำหมวก'),
(743360, 'ช่างทำหมวก (พื้นเมือง)'),
(743390, 'ช่างตัดเย็บเครื่องแต่งกาย  และช่างทำหมวกอื่น ๆ'),
(743420, 'ช่างคัดผ้าขนสัตว์'),
(743430, 'ช่างตัดผ้าขนสัตว์'),
(743440, 'ช่างตัดเย็บเสื้อผ้าขนสัตว์'),
(743490, 'ช่างตัดเย็บเสื้อผ้าที่ทำจากขนสัตว์และผู้ปฏิบัติงานที่เกี่ยวข้องอื่นๆ'),
(743520, 'ช่างสร้างแบบสำเร็จ  (ผ้าขนสัตว์)'),
(743530, 'ช่างสร้างแบบสำเร็จ  (เครื่องแต่งกาย)'),
(743535, 'ผู้เขียนแบบสำเร็จ  (เครื่องแต่งกาย)'),
(743540, 'ช่างสร้างแบบสำเร็จ  (หมวก)'),
(743550, 'ช่างตัดเครื่องแต่งกายสำเร็จรูป (ยกเว้นหนัง)'),
(743555, 'ช่างตัดเครื่องแต่งกาย (หนัง)'),
(743590, 'ช่างสร้างแบบและช่างตัดเครื่องแต่งกายอื่น ๆ'),
(743620, 'ช่างเย็บเครื่องแต่งกายด้วยมือ'),
(743625, 'ช่างเย็บด้วยมือและจักรทั่วไป'),
(743630, 'ช่างปักด้วยมือ'),
(743640, 'ช่างทำผ้าใบเรือ เต็นท์  และหลังคาผ้ากันสาด'),
(743650, 'ช่างทำร่ม (กระดาษและผ้า)'),
(743690, 'ช่างเย็บ  ช่างปัก  และผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(743720, 'ช่างทำเบาะ (เครื่องเรือน)'),
(743730, 'ช่างทำเบาะ (ยานพาหนะ)'),
(743740, 'ช่างทำที่นอน'),
(743790, 'ช่างหุ้มเบาะเครื่องเรือน  เฟอร์นิเจอร์  และผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(744120, 'ช่างคัดเลือกคุณภาพหนัง'),
(744130, 'ช่างถากหนังขูดขนด้วยมือ'),
(744140, 'ช่างย้อมสีหนัง'),
(744190, 'ช่างตกแต่งขนสัตว์  ช่างฟอกหนัง และช่างถากหนังขูดขนอื่น ๆ'),
(744210, 'ช่างทำรองเท้าทั่วไป'),
(744215, 'ช่างซ่อมรองเท้า (ด้วยมือ)'),
(744220, 'ช่างตัดแบบรองเท้า'),
(744225, 'ช่างตัดชิ้นส่วนหนังหน้ารองเท้าด้วยมือ'),
(744230, 'ช่างประกอบหนังหน้ารองเท้า'),
(744235, 'ช่างประกอบพื้นรองเท้า'),
(744240, 'ช่างตัดรองเท้าคนพิการ'),
(744250, 'ช่างขึ้นหุ่นรองเท้า'),
(744255, 'ช่างตกแต่งรองเท้า'),
(744260, 'ช่างเย็บหนังด้วยมือ (ยกเว้นรองเท้า ถุงมือ และเครื่องแต่งกาย)'),
(744265, 'ช่างเย็บหนังด้วยจักร  (ยกเว้นรองเท้า ถุงมือ และเครื่องแต่งกาย)'),
(744270, 'ช่างผลิตภัณฑ์เครื่องหนังทั่วไป'),
(744275, 'ช่างทำเครื่องเทียมสัตว์'),
(744278, 'ช่างทำอานม้า'),
(744290, 'ช่างทำรองเท้าและผู้ปฏิบัติงานที่เกี่ยวข้องอื่น ๆ'),
(811110, 'ผู้ควบคุมเครื่องขุดเจาะทำเหมืองแร่ , พนักงานเครื่องเจาะในเหมืองแร่และเหมืองหิน'),
(811120, 'ผู้ควบคุมเครื่องเจาะหิน , ช่างเจาะหิน'),
(811190, 'ผู้ควบคุมเครื่องขุดและเจาะเหมืองแบบอื่น ๆ'),
(811220, 'ผู้ควบคุมเครื่องบด โม่  , พนักงานเครื่องย่อยหิน'),
(811230, 'ผู้ควบคุมเครื่องแยกแร่, พนักงานเครื่องแยกแร่'),
(811240, 'ผู้ควบคุมเครื่องลอยแร่, พนักงานเครื่องลอยแร่'),
(811250, 'ผู้ควบคุมเครื่องบดย่อยแร่, พนักงานเครื่องตำแร่'),
(811260, 'พนักงานโต๊ะแยกแร่'),
(811290, 'ผู้ควบคุมเครื่องจักรในการแปรรูปและสกัดแร่อื่น ๆ'),
(811320, 'ผู้ควบคุมแท่นขุดเจาะบ่อน้ำมันและบ่อก๊าซ , ช่างประจำปั่นจั่นเจาะ (บ่อน้ำมันและก๊าซ)'),
(811330, 'พนักงานเครื่องโรตารี่ , ผู้ควบคุมเครื่องโรตารี่'),
(811340, 'ผู้เจาะบ่อ (ยกเว้นบ่อน้ำมันและก๊าซ)'),
(811390, 'ผู้ควบคุมอุปกรณ์และเครื่องขุดเจาะอื่น ๆ'),
(812120, 'พนักงานคุมเตาถลุงแร่ , โลหะ'),
(812130, 'พนักงานคุมเตาหลอมเหล็กกล้า'),
(812140, 'พนักงานคุมเตาหลอมไฟฟ้า (ถลุงแร่และโลหะ)'),
(812150, 'พนักงานคุมเตาหลอมแบบนอน (ถลุงแร่และโลหะ)'),
(812160, 'พนักงานเจาะเตา (เตาไฟฟ้า, เตาแบบเตานอน)'),
(812190, 'พนักงานคุมเตาถลุงโลหะอื่น ๆ'),
(812220, 'พนักงานคุมเตาหลอมโลหะ  , ผู้ควบคุมเตาหลอมโลหะ (แบบคูโปลา , แบบนอน)'),
(812230, 'ผู้ควบคุมเครื่องหล่อโลหะ'),
(812235, 'ช่างคุมเครื่องหล่อดีบุก'),
(812240, 'ช่างคุมเครื่องหล่อแม่พิมพ์'),
(812250, 'ผู้ควบคุมเครื่องรีดโลหะ, พนักงานเครื่องรีดโลหะ (รีดร้อน)'),
(812255, 'พนักงานคุมเครื่องรีดโลหะแบบรีดเย็น'),
(812260, 'พนักงานควบคุมเครื่องรีดโลหะ (ผลิตภัณฑ์สำเร็จรูป)'),
(812265, 'พนักงานควบคุมเครื่องรีดโลหะ (ผลิตภัณฑ์กึ่งสำเร็จรูป)'),
(812290, 'พนักงานคุมเครื่องรีดโลหะอื่น ๆ'),
(812310, 'พนักงานอบชุบทั่วไป'),
(812320, 'พนักงานอบชุบโลหะเพื่อลดความเครียด'),
(812330, 'พนักงานอบชุบโลหะเพื่อเพิ่มความแข็ง , พนักงานอบชุบให้โลหะแข็ง'),
(812340, 'พนักงานเปลี่ยนความแข็งเหนียวของโลหะ'),
(812390, 'พนักงานอบชุบโลหะอื่น ๆ'),
(812420, 'ผู้ควบคุมเครื่องดึงยึดเส้นลวด , ช่างรีดโลหะ'),
(812490, 'ผู้ควบคุมเครื่องดึง อัดและบีบโลหะอื่น ๆ'),
(813120, 'พนักงานเครื่องเป่าแก้ว'),
(813130, 'ช่างคุมเครื่องดึงน้ำแก้วให้เป็นกระจกแผ่นเรียบ'),
(813135, 'ช่างคุมเครื่องดึงน้ำแก้วให้เป็นกระจกแผ่นลาย'),
(813140, 'พนักงานคุมเครื่องอัดผลิตภัณฑ์แก้วด้วยเครื่องจักร'),
(813150, 'ช่างคุมเตาหลอมแก้ว'),
(813152, 'ช่างก่อหรือซ่อมเตาหลอมแก้ว'),
(813155, 'ช่างคุมเตาอบแก้วเพื่อลดความเครียด'),
(813160, 'พนักงานคุมเครื่องปั้น'),
(813162, 'ช่างคุมเตาเผาเครื่องดินเผา'),
(813165, 'พนักงานคุมเครื่องขึ้นรูป  เครื่องดินเผาแบบหล่อตัน'),
(813166, 'ช่างคุมเตาฟืน'),
(813168, 'ช่างเผาอิฐ'),
(813190, 'ช่างคุมเตาหลอมแก้วและเตาเผาเครื่องดินเผาอื่น ๆ'),
(813920, 'พนักงานเตรียมเนื้อดิน  เครื่องดินเผา'),
(813922, 'พนักงานคุมเครื่องล้างดิน'),
(813924, 'พนักงานเตรียมดินเผา (กระเบื้อง)'),
(813925, 'พนักงานเครื่องรีดดิน  (พนักงานเครื่องอัดรีดดิน , ช่างป้อนและรีดดิน)'),
(813927, 'พนักงานเครื่องอัดกระเบื้อง'),
(813930, 'ช่างอัดอิฐและกระเบื้องด้วยเครื่องจักร'),
(813935, 'ช่างอัดเครื่องดินเผา'),
(813940, 'พนักงานเตรียมเนื้อดินปั้นด้วยเครื่องจักร'),
(813945, 'พนักงานนวดดิน'),
(813946, 'พนักงานย่อยแร่และดิน'),
(813950, 'พนักงานทำน้ำเคลือบเครื่องดินเผา'),
(813960, 'ช่างผสมวัตถุดิบทำแก้ว'),
(813990, 'ผู้ควบคุมเครื่องจักรผลิตเครื่องแก้ว เครื่องดินเผาและเครื่องจักรที่เกี่ยวข้องอื่นๆ'),
(814110, 'ช่างตีหน้าไม้  ; นายม้า'),
(814120, 'ช่างเลื่อยไม้ (โรงเลื่อย)'),
(814130, 'ช่างเลื่อยซอย ; นายม้าเลื่อยซอย'),
(814140, 'ช่างตัดไม้'),
(814150, 'ช่างปอกหรือฝานไม้แผ่นบาง'),
(814160, 'ช่างทำไม้อัดสลับชั้น ; ช่างทำไม้อัดแผ่นเรียบ'),
(814190, 'พนักงานเครื่องจักรแปรรูปอื่นๆ'),
(814220, 'พนักงานเครื่องบดหรือสับไม้เพื่อทำเยื่อกระดาษ'),
(814230, 'พนักงานเครื่องต้มย่อยวัสดุเพื่อทำเยื่อกระดาษ'),
(814235, 'พนักงานเครื่องไฮดราย่อยวัสดุเพื่อทำเยื่อกระดาษ'),
(814240, 'พนักงานเครื่องฟอกเยื่อกระดาษ'),
(814250, 'พนักงานเครื่องตีเยื่อกระดาษ , พนักงานเครื่องบดเยื่อ'),
(814290, 'พนักงานเครื่องทำเยื่อกระดาษอื่น ๆ'),
(814320, 'พนักงานเครื่องผลิตกระดาษเวท - แอนด์  (WET -END)'),
(814330, 'พนักงานเครื่องผลิตกระดาษดราย - แอนด์ (DRY - END)'),
(814340, 'พนักงานเครื่องอัดรีดขัดมันกระดาษ'),
(814390, 'พนักงานเครื่องผลิตกระดาษอื่น ๆ'),
(815120, 'ผู้ควบคุมเครื่องโม่สารเคมี , พนักงานเครื่องย่อย (กรรมวิธีทางเคมีและกรรมวิธีที่เกี่ยวข้องกัน)'),
(815125, 'ผู้ควบคุมเครื่องบดสารเคมี, พนักงานเครื่องบด (กรรมวิธีทางเคมีและกรรมวิธีที่เกี่ยวข้องกัน)'),
(815130, 'ผู้ใช้เครื่องผสมยางระบบปิด , ผู้ใช้เครื่องผสมยางแบนบูรี'),
(815135, 'ผู้ใช้เครื่องบดผสมยางแบบสองลูกกลิ้ง'),
(815140, 'ผู้ควบคุมเครื่องผสมสารเคมี , พนักงานเครื่องผสม (กรรมวิธีทางเคมีและกรรมวิธีที่เกี่ยวข้องกัน)'),
(815190, 'ผู้ควบคุมเครื่องบด  โม่และผสมอื่น ๆ'),
(815220, 'ผู้ต้มเคี่ยว (กรรมวิธีทางเคมีและกรรมวิธีที่เกี่ยวข้อง)  , ผู้ควบคุมหม้อต้มเคี่ยว'),
(815225, 'ผู้อบ (กรรมวิธีทางเคมีและกรรมวิธีที่เกี่ยวข้อง)  , ผู้ควบคุมหม้ออบ'),
(815230, 'ผู้ควบคุมหม้อนึ่ง (กรรมวิธีทางเคมีและกรรมวิธีที่เกี่ยวข้อง)'),
(815240, 'ผู้ควบคุมเตาผลิตซีเมนต์'),
(815250, 'ผู้คุมเตารมควันยางแผ่น , ผู้รมควันยางแผ่น , คนเฝ้าไฟเตารมควันยางแผ่น'),
(815255, 'ผู้ทำยางแผ่นผึ่งแห้ง'),
(815257, 'พนักงานควบคุมเตาอบยางแท่ง'),
(815290, 'ผู้ต้มเคี่ยว อบและผู้ปฏิบัติงานที่เกี่ยวกับการใช้ความร้อนอื่นๆ(กรรมวิธีทางเคมีและกรรมวิธีที่เกี่ยวข้อง)'),
(815320, 'ผู้ควบคุมเครื่องอัดกรอง'),
(815340, 'ผู้ควบคุมเครื่องแยกของเหลวด้วยระบบหนีศูนย์'),
(815350, 'ผู้ควบคุมเครื่องแยกน้ำมันดิบ ; ผู้แยกน้ำมันดิบ'),
(815390, 'ผู้ควบคุมเครื่องกรองและแยกสารเคมีอื่น ๆ'),
(815420, 'ผู้ควบคุมอุปกรณ์ในกระบวนการทางเคมี ; พนักงานควบคุมถังกลั่นทางเคมีชนิดเดี่ยวและต่อเนื่อง (ยกเว้นปิโตรเลียมและก๊าซธรรมชาติ)'),
(815430, 'ผู้ควบคุมเครื่องทำระเหย'),
(815490, 'ผู้ควบคุมเครื่องกลั่นและเตาปฏิกรณ์ทางเคมีอื่น ๆ  (ยกเว้นปิโตรเลียมและก๊าซธรรมชาติ)'),
(815510, 'พนักงานเครื่องกลั่น  (น้ำมันปิโตรเลียม) ทั่วไป'),
(815520, 'ผู้ควบคุมเครื่องแยกน้ำมัน'),
(815530, 'ผู้ควบคุมหอกลั่น (น้ำมันปิโตรเลียมและก๊าซธรรมชาติ)'),
(815540, 'พนักงานเครื่องปฏิกรณ์ (น้ำมันปิโตรเลียม)'),
(815590, 'ผู้ปฏิบัติงานเกี่ยวกับการกลั่นน้ำมันอื่น ๆ'),
(815920, 'ผู้ใช้เครื่องฟอกสี (สารเคมี)'),
(815930, 'ผู้ทำยางแผ่นดิบ (ผู้ทำยางแผ่นจากน้ำยาง)'),
(815932, 'ผู้ทำยางเครป  , ผู้ทำยางเครปจากเศษยางดิบ'),
(815934, 'ผู้ทำยางแท่ง'),
(815940, 'ผู้ทำน้ำยางข้น'),
(815945, 'พนักงานประจำเครื่องผลิตเม็ดพลาสติก'),
(815950, 'ผู้ปฏิบัติงานในกระบวนการผลิตถ่านโค้ก'),
(815960, 'ผู้ปฏิบัติงานในกระบวนการผลิตปุ๋ย'),
(815970, 'ผู้ปฏิบัติงานในกระบวนการผลิตเส้นใยสังเคราะห์'),
(815990, 'ผู้ปฏิบัติงานในกรรมวิธีทางเคมีอื่น ๆ'),
(816120, 'ผู้ควบคุมเครื่องผลิตกระแสไฟฟ้า , พนักงานประจำห้องควบคุม (การผลิตกระแสไฟฟ้า)'),
(816130, 'ผู้ควบคุมสถานีผลิตไฟฟ้า  (พลังงานน้ำ) , พนักงานเครื่องกังหัน (ผลิตกระแสไฟฟ้า)'),
(816140, 'ผู้ควบคุมสถานีผลิตไฟฟ้า  (พลังงานนิวเคลียร์)'),
(816150, 'ผู้ควบคุมสถานีผลิตไฟฟ้า  (พลังงานแสงอาทิตย์)'),
(816160, 'พนักงานเครื่องอัดอากาศ'),
(816170, 'ผู้ควบคุมการจ่ายกระแสไฟฟ้า , พนักงานประจำสถานีจ่ายไฟ'),
(816190, 'ผู้ปฏิบัติงานเครื่องจักรในการผลิตพลังงานไฟฟ้าอื่น ๆ'),
(816220, 'ผู้ควบคุมหม้อน้ำ , ช่างไฟประจำหม้อน้ำ'),
(816230, 'ผู้ควบคุมเครื่องจักรไอน้ำ (เรือ)'),
(816290, 'ผู้ควบคุมเครื่องจักรไอน้ำ  และหม้อกำเนิดไอน้ำอื่น ๆ'),
(816320, 'ผู้ควบคุมเตาเผาขยะ'),
(816330, 'ผู้ควบคุมเครื่องสูบน้ำ'),
(816335, 'ผู้ควบคุมเครื่องบำบัดน้ำเสีย'),
(816340, 'พนักงานเครื่องทำน้ำให้บริสุทธิ์'),
(816350, 'ผู้ควบคุมเครื่องระบบทำความเย็น , พนักงานควบคุมระบบเครื่องทำความเย็น'),
(816390, 'ผู้ควบคุมเตาเผาขยะ  งานบำบัดน้ำเสียและงานที่เกี่ยวข้องอื่น ๆ'),
(817120, 'ผู้ควบคุมเครื่องจักรในการประกอบชิ้นส่วนแบบอัตโนมัติ'),
(817130, 'ผู้ควบคุมเครื่องจักรในการประกอบชิ้นส่วนแบบกึ่งอัตโนมัติ'),
(817220, 'ผู้ควบคุมหุ่นยนต์'),
(821110, 'ผู้ควบคุมเครื่องมือกล (งานโลหะ) ทั่วไป'),
(821120, 'ผู้ควบคุมเครื่องกลึง (งานโลหะ) , ช่างกลึง (แบบฐานหมุน , คงที่)'),
(821125, 'ผู้ควบคุมเครื่องไส (งานโลหะ) ชนิดแท่นเคลื่อนที่ , ชนิดแท่นเหล็ก'),
(821130, 'ผู้ควบคุมเครื่องตัดเฟือง (งานโลหะ) , ช่างตัดเฟือง'),
(821135, 'ผู้ควบคุมเครื่องเลื่อยโลหะ'),
(821140, 'ผู้ควบคุมเครื่องกว้าน (งานโลหะ)'),
(821145, 'ผู้ควบคุมเครื่องเจาะ (งานโลหะ)'),
(821150, 'ผู้ควบคุมเครื่องเจียระไนที่มีความเที่ยงตรงแม่นยำ  (งานโลหะ)'),
(821155, 'ผู้ควบคุมเครื่องจักรทำแกนแบบหล่อโลหะ'),
(821160, 'พนักงานคุมเครื่องทำลวดหนาม'),
(821190, 'ผู้ควบคุมเครื่องจักรและอุปกรณ์แปรรูปโลหะอื่น ๆ'),
(821220, 'ผู้หล่อซีเมนต์บล๊อค , ผู้ทำซีเมนต์บล๊อค'),
(821230, 'ผู้ควบคุมเครื่องหล่อซีเมนต์คอนกรีต'),
(821240, 'พนังงานเครื่องผสมคอนกรีต'),
(822120, 'ผู้ควบคุมเครื่องผลิตผงซักฟอก'),
(822130, 'ผู้ควบคุมเครื่องผลิตผลิตภัณฑ์รักษาโรค'),
(822140, 'ผู้ควบคุมเครื่องผลิตผลิตภัณฑ์และของใช้สำหรับห้องน้ำ'),
(822150, 'ผู้ควบคุมเครื่องผลิตผลิตภัณฑ์เครื่องสำอาง'),
(822190, 'ผู้ควบคุมเครื่องจักรผลิตผลิตภัณฑ์เคมีอื่น ๆ'),
(822210, 'ผู้ควบคลุมเครื่องผลิตกระสุนดินปืน'),
(822220, 'ผู้ควบคุมเครื่องผลิตกระสุนดินปืน'),
(822225, 'ผู้ควบคุมเครื่องผลิตวัตถุระเบิดh'),
(822230, 'ผู้ควบคุมเครื่องผลิตไม้ขีดไฟ , ผู้ทำไม้ขีดไฟ'),
(822290, 'ผู้ควบคุมเครื่องจักรในการผลิตผลิตภัณฑ์กระสุนปืนและวัตถุระเบิดอื่น ๆ'),
(822310, 'ผู้ควบคุมเครื่องชุบและเคลือบ (โลหะ) ทั่วไป'),
(822320, 'ผู้ควบคุมเครื่องตกแต่งสำเร็จงานโลหะ'),
(822330, 'ผู้ใช้เครื่องพ่นทราย (โลหะ)'),
(822390, 'ผู้ควบคุมเครื่องจักรในการตกแต่งการเคลือบและชุบผิวโลหะ   อื่น ๆ'),
(822420, 'ผู้ควบคุมเครื่องล้างฟิล์ม , ช่างล้างฟิล์ม'),
(822430, 'ผู้ควบคุมเครื่องอัดขยายภาพถ่าย'),
(822435, 'ผู้ควบคุมเครื่องพิมพ์ภาพถ่าย (สี)'),
(822440, 'ผู้ควบคุมเครื่องผลิตฟิล์ม'),
(822490, 'ผู้ควบคุมเครื่องจักรในการผลิตผลิตภัณฑ์การถ่ายภาพอื่น ๆ'),
(822920, 'ผู้ควบคุมเครื่องจักรในการผลิตเทียนไข'),
(822930, 'ผู้ควบคุมเครื่องผลิตก๊าซต่าง ๆ  (คลอรีน , ไฮโดรเจน )'),
(822940, 'ผู้ควบคุมเครื่องผลิตเสื่อน้ำมัน'),
(822950, 'ผู้ควบคุมเครื่องผลิตดินสอ'),
(822990, 'ผู้ควบคุมเครื่องจักรในการผลิตผลิตภัณฑ์เคมีอื่น ๆ ที่มิได้จัดประเภทไว้ในที่อื่น'),
(823110, 'พนักงานควบคุมเครื่องอัดขึ้นรูปผลิตภัณฑ์ยาง'),
(823115, 'พนักงานหล่อดอกยาง'),
(823120, 'พนักงานควบคุมเครื่องขึ้นรูปผลิตภัณฑ์ยางแบบอัดผ่านดายน์'),
(823125, 'พนักงานควบคุมเครื่องอัดรีดยาง'),
(823130, 'พนักงานควบคุมเครื่องฉีดยาง'),
(823140, 'พนักงานควบคุมเครื่องขึ้นรูปยางรถยนต์'),
(823150, 'พนักงานควบคุมเครื่องจักรผลิตผลิตภัณฑ์จากน้ำยางแบบจุ่ม'),
(823155, 'พนักงานควบคุมเครื่องจักรผลิตฟองน้ำจากน้ำยาง'),
(823160, 'พนักงานควบคุมเครื่องจักรผลิตเส้นด้ายยางยึดจากน้ำยาง'),
(823190, 'พนักงานควบคุมเครื่องจักรผลิตผลิตภัณฑ์ยางอื่น ๆ'),
(823220, 'พนักงานควบคุมเครื่องขึ้นรูปพลาสติกด้วยความร้อน'),
(823230, 'พนักงานควบคุมเครื่องฉีดพลาสติก'),
(823240, 'พนักงานควบคุมเครื่องเป่าฟิล์ม'),
(823245, 'พนักงานควบคุมเครื่องเป่าภาชนะกลวง'),
(823250, 'พนักงานควบคุมเครื่องอัดขึ้นรูปพลาสติก'),
(823260, 'ช่างทำแม่แบบไฟเบอร์กลาส'),
(823265, 'ช่างทำผลิตภัณฑ์ไฟเบอร์กลาส'),
(823290, 'พนักงานควบคุมเครื่องจักรในการผลิตผลิตภัณฑ์พลาสติกอื่น ๆ'),
(824010, 'พนักงานเครื่องจักรทำงานไม้ทั่วไป , ช่างตั้งและใช้เครื่องจักรทำงานไม้ทั่วไป'),
(824020, 'ช่างปรับตั้งและใช้เครื่องจักรเลื่อยไม้'),
(824030, 'ช่างปรับตั้งและใช้เครื่องกลึงอัตโนมัติ'),
(824040, 'ช่างปรับตั้งและใช้เครื่องจักรขึ้นรูปงานไม้'),
(824045, 'ช่างปรับตั้งและใช้เครื่องจักรทำบัวหรือร่อง'),
(824050, 'ช่างปรับตั้งและใช้เครื่องจักรไสไม้'),
(824055, 'ช่างปรับตั้งและใช้เครื่องจักรทำเดือย'),
(824060, 'ช่างปรับตั้งและใช้เครื่องจักรแกะสลักงานไม้'),
(824080, 'พนักงานเครื่องจักรทำแผ่นไม้วิทยาศาสตร์'),
(824085, 'พนักงานเครื่องจักรทำไม้อัดแผ่นเรียบ'),
(824087, 'พนักงานเครื่องจักรทำแผ่นไม้ปูพื้น'),
(824090, 'พนักงานเครื่องจักรผลิตผลิตภัณฑ์ไม้อื่น ๆ'),
(825120, 'ช่างแท่นพิมพ์ออฟเซท'),
(825130, 'ช่างแท่นพิมพ์เลตเตอร์เพรส์ส'),
(825140, 'ช่างแท่นพิมพ์เฟล็กโซกราฟี'),
(825150, 'ช่างแท่นพิมพ์ร่องลึก  , อินทาโย'),
(825160, 'ช่างแท่นพิมพ์พื้นลึก , กราวัวร์'),
(825170, 'ช่างแท่นพิมพ์สกรีน'),
(825190, 'ช่างแท่นพิมพ์อื่น ๆ'),
(825210, 'ช่างเข้าเล่มหนังสือ (ผู้คุมเครื่องเข้าเล่มหนังสือ)'),
(825220, 'ช่างแท่นปั๊ม (ปั้มภาพและอักษรนูนบนหนังสือ)  , พนักงานคุมเครื่องดุนหนังสือ'),
(825230, 'ช่างเคลือบด้วยพลาสติก'),
(825235, 'ช่างเคลือบเงาระบบยูวี (สิ่งพิมพ์)'),
(825240, 'ช่างขัดมัน'),
(825250, 'ช่างทำปกด้วยเครื่อง'),
(825290, 'พนักงานคุมเครื่องเข้าเล่มหนังสืออื่น ๆ'),
(825320, 'พนักงานคุมเครื่องทำแผ่นกระดาษแข็งหรือทำแผ่นกระดาษกล่องลูกฟูก'),
(825330, 'พนักงานคุมเครื่องตัดและรีดพับ (ทำกล่องกระดาษ)  , พนักงานเครื่องตัดและพับกล่องกระดาษ'),
(825335, 'พนักงานคุมเครื่องทำซองและถุงกระดาษ'),
(825340, 'พนักงานคุมเครื่องทำถุงบางใส'),
(825345, 'พนักงานคุมเครื่องทำถุงกระดาษ'),
(825350, 'พนักงานคุมเครื่องเย็บถุงกระดาษ'),
(825390, 'พนักงานคุมเครื่องผลิตผลิตภัณฑ์กระดาษอื่น ๆ'),
(826120, 'พนักงานผสมและทำความสะอาดเส้นใย'),
(826130, 'พนักงานสางเส้นใย'),
(826135, 'พนักงานรีดปุยเส้นใย'),
(826140, 'พนักงานเครื่องซิมเพลกซ์หรือเครื่องโรฟวิ่ง'),
(826150, 'พนักงานปั่นด้ายด้วยเครื่องจักร'),
(826155, 'พนักงานปั่นเกลียวเส้นด้าย'),
(826160, 'พนักงานควบเส้นด้ายด้วยเครื่องจักร'),
(826170, 'พนักงานกรอด้าย'),
(826175, 'พนักงานกรอด้ายให้เป็นไจ'),
(826180, 'ผู้ทำเส้นใยกาบมะพร้าว'),
(826190, 'พนักงานเตรียมเส้นใยด้วยเครื่องจักรอื่น ๆ'),
(826220, 'ช่างทำบัตรทอผ้ายกดอกแบบแจกการ์ดh'),
(826225, 'ช่างเจาะบัตรทอผ้ายกดอก'),
(826230, 'พนักงานเตรียมม้วนด้ายยืน'),
(826235, 'พนักงานร้อยตะกรอเพื่อใช้ในการทอผ้าด้วยเครื่องจักร'),
(826238, 'พนักงานลงแป้งเส้นด้ายยืน'),
(826240, 'ช่างปรับตั้งเครื่องจักรทอผ้า (ยกเว้นเครื่องทอผ้ายกดอกแบบแจกการ์ด)'),
(826245, 'ช่างทอผ้าด้วยเครื่องจักร  (ยกเว้นเครื่องทอผ้ายกดอก)'),
(826250, 'ช่างปรับตั้งเครื่องจักรทอผ้ายกดอกแบบแจกการ์ด'),
(826255, 'ช่างทอผ้าด้วยเครื่องทอผ้ายกดอก , ผู้ควบคุมเครื่องจักรทอผ้า (แบบแจกการ์ด)'),
(826260, 'พนักงานเครื่องทอผ้าแบบดอบบี้'),
(826270, 'ช่างปรับตั้งเครื่องถัก'),
(826275, 'ผู้ควบคุมเครื่องถักผ้า'),
(826278, 'ช่างทำเกลียวเส้นด้ายด้วยเครื่องจักร'),
(826280, 'ช่างทอแห อวน ด้วยเครื่องจักร   ,  ผู้ควบคุมเครื่องผลิตตาข่าย'),
(826285, 'ช่างทอพรมด้วยเครื่องจักร'),
(826290, 'ช่างทอ  ช่างถักผ้าด้วยเครื่องจักรอื่น ๆ'),
(826320, 'ช่างเย็บผลิตภัณฑ์สิ่งทอสิ่งถักและเครื่องแต่งกาย   ,  ช่างเย็บจักรอุตสาหกรรม'),
(826330, 'ช่างปักจักร , ช่างปักผ้า'),
(826340, 'ช่างปักผ้าลูกไม้ด้วยเครื่องจักร'),
(826390, 'ช่างเย็บ   ช่างปักด้วยเครื่องจักรอื่น ๆ'),
(826420, 'พนักงานคุมเครื่องฟอกขาวเส้นด้ายและผืนผ้า'),
(826430, 'พนักงานคุมเครื่องย้อมเส้นด้าย , ช่างย้อมเส้นด้ายด้วยเครื่องจักร'),
(826440, 'พนักงานคุมเครื่องย้อมผืนผ้า , ช่างย้อมผืนผ้าด้วยเครื่องจักร'),
(826450, 'พนักงานคุมเครื่องซักล้างสิ่งทอสิ่งถัก'),
(826460, 'พนักงานคุมเครื่องตกแต่งผืนผ้าสิ่งทอสิ่งถัก'),
(826490, 'พนักงานคุมเครื่องฟอก ย้อมและทำความสะอาดสิ่งทอสิ่งถักอื่นๆ'),
(826520, 'พนักงานถากหนังขูดขน'),
(826530, 'พนักงานเครื่องผ่าหนัง'),
(826540, 'พนักงานคุมเครื่องฟอกหนัง'),
(826550, 'พนักงานเครื่องแต่งสีหนัง  ,ช่างคุมเครื่องตกแต่งสีหนัง'),
(826560, 'พนักงานคุมเครื่องผสมขนสัตว์'),
(826570, 'พนักงานคุมเครื่องดึง  ยืด  เส้นใยขนสัตว์'),
(826620, 'พนักงานเครื่องตัดชิ้นส่วนหนังหน้ารองเท้า'),
(826625, 'พนักงานเครื่องตัดพื้นรองเท้า'),
(826630, 'พนักงานเครื่องเย็บรองเท้า'),
(826920, 'พนักงานควบคุมเครื่องจักรผลิตหมวก , ช่างทำหมวกด้วยเครื่องจักร'),
(826930, 'พนักงานคุมเครื่องถักด้ายให้เป็นเกลียว'),
(826990, 'พนักงานคุมเครื่องผลิตผลิตภัณฑ์สิ่งทอสิ่งถัก  ขนสัตว์  และเครื่องหนัง  ซึ่งมิได้จัดประเภทไว้ในในที่อื่น'),
(827120, 'ผู้ควบคุมเครื่องผลิตผลิตภัณฑ์อาหารจากเนื้อสัตว์และสัตว์น้ำในภาชนะบรรจุปิดสนิท  (กระป๋อง  ขวดแก้ว  ฯลฯ )'),
(827125, 'ผู้ควบคุมเครื่องทำไส้กรอก'),
(827130, 'ผู้ควบคุมเครื่องผลิตผลิตภัณฑ์อาหารจากเนื้อสัตว์และสัตว์น้ำ   แช่เย็นและแช่เยือกแข็ง'),
(827190, 'ผู้ควบคุมเครื่องจักรผลิตผลิตภัณฑ์อาหารจากเนื้อสัตว์และสัตว์น้ำอื่นๆ'),
(827220, 'ผู้ควบคุมเครื่องจักรในกระบวนการผลิตนมพร้อมดื่ม'),
(827230, 'ผู้ควบคุมเครื่องผลิตผลิตภัณฑ์นมอื่นๆ  (นมผง  นมข้น  เนยแข็งฯลฯ  )'),
(827240, 'ผู้ควบคุมเครื่องผลิตไอศกรีม'),
(827290, 'ผู้ควบคุมเครื่องผลิตผลิตภัณฑ์นมอื่น ๆ'),
(827320, 'ผู้คุมเครื่องผลิตแป้งมันสำปะหลัง'),
(827330, 'ผู้ควบคุมเครื่องสีข้าว'),
(827340, 'ผู้ควบคุมเครื่องป่นเครื่องเทศ  ,  ผู้ควบคุมเครื่องโม่ บด สี เมล็ดธัญพืช'),
(827350, 'ผู้ควบคุมเครื่องผสมอาหารสัตว์'),
(827355, 'ผู้ควบคุมเครื่องอัดเม็ดอาหารสัตว์'),
(827390, 'ผู้ควบคุมเครื่องโม่เมล็ดธัญพืชและเครื่องเทศอื่น ๆ'),
(827410, 'ผู้ควบคุมเครื่องผลิตขนมอบทั่วไป'),
(827420, 'ผู้ควบคุมเครื่องผลิตขนมหวานจากน้ำตาล  (ช็อกโกแลต  ลูกอม  ลูกกวาด )'),
(827430, 'ผู้ควบคุมเครื่องผลิตบะหมี่สำเร็จรูป'),
(827490, 'ผู้ควบคุมเครื่องผลิตผลิตภัณฑ์จากแป้งและน้ำตาลอื่นๆ'),
(827510, 'ผู้ควบคุมเครื่องแปรรูปอาหารและเครื่องดื่มจากพืช  ผัก  ผลไม้ในภาชนะบรรจุปิดสนิท  (กระป๋อง  ขวดแก้ว  ฯลฯ )'),
(827520, 'ผู้ควบคุมเครื่องแปรรูปพืช  ผัก  ผลไม้ แช่เยือกแข็ง'),
(827530, 'ผู้ควบคุมเครื่องผลิตผลิตภัณฑ์จากพืช  ผัก  ผลไม้อบแห้ง'),
(827540, 'ผู้ควบคุมเครื่องผลิตซอสและเครื่องปรุงรสจากพืช'),
(827550, 'ผู้ควบคุมเครื่องสกัดน้ำมันสำหรับบริโภคจากพืช'),
(827560, 'ผู้ควบคุมเครื่องผลิตเนยเทียม'),
(827590, 'ผู้ควบคุมเครื่องแปรรูปพืช  ผักและผลไม้อื่น ๆ'),
(827620, 'ผู้ควบคุมเครื่องหีบอ้อย'),
(827630, 'ผู้ควบคุมเครื่องทำน้ำตาลให้บริสุทธิ์'),
(827640, 'ผู้ควบคุมเครื่องทำผลึกน้ำตาล'),
(827690, 'ผู้ปฏิบัติงานในกรรมวิธีการทำน้ำตาลและผู้ทำน้ำตาลให้บริสุทธิ์อื่น ๆ'),
(827720, 'ผู้ควบคุมเครื่องผสมใบชา'),
(827730, 'ผู้ควบคุมเครื่องแปรรูปเมล็ดกาแฟ  , ผู้ควบคุมเครื่องคั่วเมล็ดกาแฟ'),
(827790, 'ผู้ควบคุมเครื่องแปรรูปใบชา  กาแฟและโกโก้  อื่นๆ'),
(827810, 'ผู้ควบคุมการผลิตเบียร์ , บริวมาสเตอร์ , ผู้ปรุงเบียร์'),
(827820, 'ผู้ควบคุมเครื่องผลิตเบียร์'),
(827830, 'ผู้ควบคุมการหมักส่า  , ผู้หมักส่า'),
(827840, 'ผู้ควบคุมการปรุงแต่งสุรา'),
(827850, 'ผู้ควบคุมเครื่องผลิตน้ำอัดลม'),
(827860, 'ผู้ควบคุมการผลิตไวน์และไวน์ผลไม้'),
(827870, 'ผู้ควบคุมเครื่องผลิตน้ำดื่มและน้ำแข็งบริโภค'),
(827890, 'ผู้ควบคุมเครื่องจักรในการผลิตเบียร์  เหล้า ไวน์และเครื่องดื่มอื่นๆ'),
(827910, 'ผู้ชำนาญการปรุง'),
(827920, 'พนักงานควบคุมเครื่องแยกใบยาและก้าน'),
(827930, 'พนักงานควบคุมเครื่องผลิตยาเส้น'),
(827940, 'พนักงานควบคุมเครื่องผสมน้ำหอมและน้ำปรุงใบยา'),
(827950, 'พนักงานควบคุมเครื่องมวนบุหรี่'),
(827990, 'พนักงานควบคุมเครื่องผลิตผลิตภัณฑ์ยาสูบอื่น ๆ'),
(828110, 'ช่างประกอบเครื่องจักรกล , ช่างติดตั้งเครื่องจักร'),
(828120, 'ช่างประกอบอากาศยาน  (เครื่องบิน)'),
(828130, 'ช่างประกอบยานยนต์'),
(828140, 'ช่างประกอบรถจักรยาน'),
(828150, 'ช่างประกอบรถจักรยานยนต์'),
(828220, 'ช่างประกอบอุปกรณ์ชิ้นส่วนทางไฟฟ้า (มอเตอร์, ไดนาโม , หม้อแปลงไฟฟ้า, เครื่องใช้สำนักงาน , เครื่องใช้ในบ้านเรือน ,ลิฟท์, แยกควบคุมไฟฟ้า)'),
(828230, 'ช่างประกอบเครื่องมือที่มีความเที่ยงตรงแม่นยำ'),
(828290, 'ผู้ประกอบอุปกรณ์ไฟฟ้าอื่น ๆ'),
(828320, 'ช่างประกอบอุปกรณ์อิเล็กทรอนิกส์ (เครื่องส่งวิทยุโทรทัศน์)'),
(828330, 'ช่างประกอบอุปกรณ์อิเล็กทรอนิกส์ (การแพทย์)'),
(828340, 'ช่างประกอบอุปกรณ์อิเล็กทรอนิกส์ (อุตสาหกรรม)'),
(828350, 'ช่างประกอบอุปกรณ์อิเล็กทรอนิกส์ (คอมพิวเตอร์)'),
(828390, 'ผู้ประกอบอุปกรณ์อิเล็กทรอนิกส์อื่นๆ'),
(828420, 'ช่างประกอบผลิตภัณฑ์โลหะ'),
(828430, 'ช่างประกอบผลิตภัณฑ์ยาง'),
(828440, 'ช่างประกอบผลิตภัณฑ์พลาสติก'),
(828490, 'ผู้ประกอบผลิตภัณฑ์โลหะ   ยางและพลาสติก  อื่นๆ'),
(828520, 'ช่างต่อตัวถังยานพาหนะด้วยไม้'),
(828590, 'ช่างประกอบผลิตภัณฑ์ไม้อื่น ๆ'),
(828620, 'ช่างประกอบชิ้นส่วนผลิตภัณฑ์เครื่องหนัง'),
(828630, 'ช่างประกอบชิ้นส่วนผลิตภัณฑ์กระดาษอัด'),
(828640, 'ช่างประกอบชิ้นส่วนผลิตภัณฑ์สิ่งทอ'),
(828690, 'ผู้ประกอบผลิตภัณฑ์กระดาษอัด สิ่งทอ เครื่องหนังและผลิตภัณฑ์ต่าง ๆ ที่เกี่ยวข้องอื่น ๆ'),
(829020, 'ผู้ควบคุมเครื่องปิดฉลากผลิตภัณฑ์'),
(829030, 'ผู้ควบคุมเครื่องปิดและผนึกฝา'),
(829040, 'ผู้ควบคุมเครื่องบรรจุของ'),
(829050, 'ผู้ควบคุมเครื่องบรรจุขวด'),
(829060, 'พนักงานเครื่องห่อของ'),
(829090, 'ผู้บรรจุหีบห่อและปิดฉลากอื่น ๆ'),
(831120, 'พนักงานขับรถไฟ , พนักงานขับรถจักร'),
(831130, 'พนักงาน , ผู้ช่วยขับรถจักร  , ช่างเครื่องรถจักร (รถไฟ)'),
(831190, 'พนักงานขับรถจักรอื่น ๆ'),
(831220, 'พนักงานห้ามล้อรถไฟ'),
(831230, 'พนักงานให้สัญญาณรถไฟ'),
(831240, 'พนักงานสับเปลี่ยนรางรถไฟ'),
(832120, 'ผู้ขับรถจักรยานยนต์'),
(832130, 'ผู้ขับรถสามล้อ'),
(832210, 'พนักงานขับรถยนต์'),
(832220, 'พนักงานขับรถยนต์โดยสารขนาดเล็ก ,  พนักงานขับรถยนต์รับจ้าง'),
(832230, 'พนักงานขับรถบรรทุกขนาดเล็ก  , พนักงานขับรถตู้'),
(832290, 'ผู้ขับรถยนต์ รถรับจ้าง และรถตู้ อื่น ๆ'),
(832320, 'พนักงานขับรถยนต์โดยสารประจำทาง'),
(832330, 'พนักงานขับรถราง'),
(832420, 'พนักงานขับรถบรรทุกและรถตู้ขนาดใหญ่'),
(832430, 'พนักงานขับรถดัมพ์  ,  พนักงานขับรถกระบะเทหลัง'),
(833120, 'พนักงานขับรถแทรกเตอร์'),
(833130, 'พนักงานขับรถบรรทุกไม้ซุง'),
(833140, 'ผู้ควบคุมเครื่องเก็บเกี่ยว  ,  พนักงานเครื่องจักรการเกษตร'),
(833190, 'ผู้ควบคุมอุปกรณ์ในไร่นา  , ฟาร์ม , งานเกษตรอื่น ๆ'),
(833210, 'พนักงานเครื่องขนย้ายดินทั่วไป'),
(833220, 'พนักงานรถขุดดิน , พนักงานรถตัก'),
(833225, 'พนักงานเครื่องขุดคู'),
(833230, 'พนักงานไถ/ปราบดิน'),
(833240, 'พนักงานเครื่องครูดและปรับระดับถนน'),
(833245, 'พนักงานขับรถบดอัดถนน'),
(833250, 'พนักงานเครื่องลากขนย้าย'),
(833260, 'พนักงานรถเครื่องตอกเสาเข็ม'),
(833270, 'พนักงานเครื่องเทคอนกรีต'),
(833275, 'พนักงานเครื่องลำเลียงคอนกรีต'),
(833280, 'พนักงานเรือขุด'),
(833290, 'ผู้ควบคุมเครื่องจักร เครื่องยนต์ที่ใช้ในการขนย้ายวัสดุอื่น ๆ'),
(833320, 'พนักงานปั้นจั่นแบบสะพาน'),
(833330, 'พนักงานปั้นจั่นแบบแขน  ยกเว้นปั้นจั่นเคลื่อนที่'),
(833340, 'พนักงานปั้นจั่นแบบเคลื่อนที่'),
(833350, 'พนักงานเครื่องกว้าน'),
(833360, 'พนักงานปั้นจั่นงานก่อสร้าง  , พนักงานเครื่องยก (การก่อสร้าง)'),
(833370, 'พนักงานประจำประตูน้ำ'),
(833390, 'ผู้ควบคุมปั้นจั่น  รอก ยก และเครื่องจักรต่าง ๆ ที่เกี่ยวข้องอื่น ๆ'),
(833420, 'พนักงานขับรถยก  (fork  lift)'),
(833430, 'พนักงานควบคุมอุปกรณ์ยกขน'),
(834020, 'กลาสี'),
(834030, 'สรั่งเรือ'),
(834035, 'สรั่งช่างกลเรือ'),
(834040, 'ช่างเครื่องเรือยนต์'),
(834050, 'พนักงานถือท้ายเรือ'),
(834055, 'นายท้ายเรือยนต์'),
(834057, 'พนักงานคุมแพขนานยนต์'),
(834060, 'ช่างอัดจาระบีประจำเครื่อง'),
(834065, 'ช่างเครื่องและช่างน้ำมันประจำเรือ'),
(834070, 'ลูกเรือชำนาญงาน'),
(834090, 'ลูกเรือและผู้ปฏิบัติงานที่เกี่ยวข้องอื่นๆ'),
(911120, 'ผู้จำหน่ายอาหารในสถานที่สาธารณะ'),
(911130, 'ผู้จำหน่ายอาหารตามถนน'),
(911140, 'ผู้จำหน่ายอาหารตามทางน้ำ'),
(911220, 'ผู้จำหน่ายหนังสือพิมพ์'),
(911230, 'ผู้จำหน่ายสินค้าต่าง ๆ ตามถนน (ยกเว้นอาหาร)'),
(911240, 'ผู้จำหน่ายสินค้าตามงานแสดงต่างๆ'),
(911320, 'ผู้จำหน่ายสินค้าแบบขายตรง'),
(911330, 'ผู้จำหน่ายสินค้าทางโทรศัพท์'),
(912010, 'ผู้รับจ้างทั่วไป  (ปิดโปสเตอร์)'),
(912020, 'พนักงานขัดรองเท้า'),
(912030, 'พนักงานเช็ดกระจกหน้าต่างรถยนต์'),
(912090, 'ทำงานให้บริการตามข้างถนนอื่น ๆ'),
(913120, 'ผู้ช่วยแม่บ้าน'),
(913130, 'คนงานทำความสะอาด'),
(913220, 'พนักงานทำความสะอาดในที่สาธารณะ'),
(913230, 'พนักงานล้างจานด้วยมือ'),
(913320, 'ผู้ซักล้างเสื้อผ้าด้วยมือ/ พนักงานซักรีด'),
(914120, 'ผู้ทำความสะอาดอาคาร , พนักงานทำความสะอาดอาคาร'),
(914130, 'ผู้ดูแลบ้านเช่า / อาพาร์ทเม้นต์'),
(914140, 'ผู้ดูแลวัดหรือโบสถ์'),
(914220, 'พนักงานทำความสะอาดหน้าต่าง'),
(914230, 'ผู้ทำความสะอาดยานพาหนะด้วยมือ'),
(915120, 'พนักงานส่งหนังสือ'),
(915130, 'คนส่งหนังสือพิมพ์'),
(915140, 'พนักงานยกกระเป๋า  , พนักงานขนสัมภาระ'),
(915150, 'พนักงานแบกถุงกอล์ฟ'),
(915190, 'พนักงานจัดส่งสินค้าอื่น ๆ'),
(915220, 'พนักงานเปิด - ปิดประตู'),
(915230, 'ยามรักษาการณ์'),
(915240, 'พนักงานเก็บตั๋ว/บัตรอนุญาติ'),
(915320, 'พนักงานเก็บเงินเครื่องอัตโนมัติ'),
(915330, 'พนักงานเก็บค่าบริการจอดรถ'),
(915340, 'พนักงานจดมาตรวัดน้ำ/ไฟฟ้า'),
(916120, 'ผู้เก็บขยะ'),
(916220, 'พนักงานเก็บกวาดสวนสาธารณะ'),
(916230, 'พนักงานกวาดถนน'),
(916240, 'คนงานเฝ้าประตูระบายน้ำ ; ยามเฝ้าประตูระบายน้ำ'),
(916245, 'คนงานท่อระบายน้ำ'),
(921120, 'คนงานในฟาร์มทั่วไป'),
(921130, 'ผู้เก็บเกี่ยวผลไม้/พืชไร่'),
(921220, 'แรงงานปลูกป่า'),
(921310, 'แรงงานประมง'),
(921320, 'แรงงานจับสัตว์ล่า'),
(921330, 'คนงานในฟาร์มเพาะเลี้ยงสัตว์น้ำ'),
(931120, 'แรงงานเหมืองแร่  เหมืองหิน'),
(931220, 'แรงงานก่อสร้างถนน  เขื่อน และอื่น ๆ ที่เกี่ยวข้อง'),
(931320, 'แรงงานรื้อถอน อาคาร  สิ่งปลูกสร้าง'),
(931330, 'แรงงานก่อสร้างอาคาร  สิ่งปลูกสร้างต่าง ๆ'),
(932120, 'พนักงานคัดแยกขวด'),
(932130, 'แรงงานด้านการผลิต'),
(932132, 'ผู้ทำกระเบื้องซีเมนต์ด้วยมือ'),
(932134, 'ผู้หล่อซีเมนต์คอนกรีตด้วยมือ'),
(932140, 'ผู้คัดชั้นยางแผ่นรมควัน'),
(932190, 'แรงงานด้านการประกอบอื่น ๆ'),
(932220, 'แรงงานบรรจุ'),
(932225, 'พนักงานบรรจุอาหารลงถาด'),
(932230, 'ผู้ล้างและผึ่งยางแผ่นดิบ'),
(932235, 'ผู้อัดและหีบห่อก้อนยางแผ่นรมควัน'),
(932290, 'แรงงานในด้านการผลิตต่าง ๆ , แรงงานทั่วไป'),
(933120, 'คนถีบสามล้อ'),
(933130, 'คนเข็นของ'),
(933220, 'ผู้ขับยานพาหนะที่ใช้สัตว์ลากเทียม(สินค้า)'),
(933225, 'ผู้ขับยานพหนะที่ใช้สัตว์ลากเทียม(ผู้โดยสาร)'),
(933230, 'ควาญช้าง'),
(933290, 'ผู้ขับเคลื่อนพาหนะและเครื่องจักรโดยใช้สัตว์ลากจูงอื่น ๆ'),
(933310, 'พนักงานขนถ่ายสินค้า'),
(933320, 'ผู้ขนถ่ายสินค้า  (รถ, รถไฟ)'),
(933330, 'ผู้ขนถ่ายสินค้า  (ทางเรือ)'),
(933340, 'ผู้ขนถ่ายสินค้า  (ทางอากาศ)'),
(933345, 'พนักงานลำเลียงอาหารขึ้นเครื่องบิน'),
(933390, 'ผู้ขนส่งสินค้าอื่นๆ'),
(0, 'ผู้ฝึกงาน'),
(0, 'ผู้เข้าสู่แรงงานใหม่'),
(0, 'ผู้แจ้งชื่ออาชีพไม่ชัดเจน'),
(0, 'ผู้ไม่แจ้งชื่ออาชีพ');

-- --------------------------------------------------------

--
-- Table structure for table `d_prob_edu`
--

CREATE TABLE `d_prob_edu` (
  `prob_edu_id` int(11) DEFAULT NULL,
  `prob_edu_desc` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_prob_edu`
--

INSERT INTO `d_prob_edu` (`prob_edu_id`, `prob_edu_desc`) VALUES
(1, 'ไม่มีปัญหา'),
(2, 'ข้อมูลสถานที่ศึกษาต่อไม่เพียงพอ'),
(3, 'คุณสมบัติในการสมัครเรียน'),
(4, 'ขาดความรู้พื้นฐานในการศึกษาต่อ'),
(5, 'ขาดแคลนเงินทุน'),
(6, 'อื่นๆให้ระบุ');
...
--
-- Table structure for table `d_prob_findwork`
--

CREATE TABLE `d_prob_findwork` (
  `prob_findwork_id` int(11) DEFAULT NULL,
  `prob_findwork_name` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_prob_findwork`
--

INSERT INTO `d_prob_findwork` (`prob_findwork_id`, `prob_findwork_name`) VALUES
(1, 'ไม่มีปัญหา'),
(2, 'ไม่ทราบแหล่งงาน'),
(3, 'หางานที่ถูกใจไม่ได้'),
(4, 'ต้องสอบจึงไม่อยากสมัคร'),
(5, 'ขาดคนสนับสนุน'),
(6, 'ขาดคนหรือเงินค้ำประกัน'),
(7, 'หน่วยงานไม่ต้องการ'),
(8, 'เงินเดือนน้อย'),
(9, 'สอบเข้าทำงานไม่ได้'),
(10, 'ปัญหาด้านสุขภาพ'),
(11, 'ขาดทักษะภาษาต่างประเทศ'),
(12, 'ขาดทักษะด้านคอมพิวเตอร์'),
(13, 'ขาดประสบการณ์ในการทำงาน'),
(14, 'เกรดเฉลี่ยไม่ถึงเกณฑ์ที่กำหนด'),
(15, 'อื่นๆให้ระบุ');

-- --------------------------------------------------------

--
-- Table structure for table `d_salary`
--
...
--
-- Dumping data for table `d_salary`
--

INSERT INTO `d_salary` (`salary_id`, `salary_amount`) VALUES
(1, '12,000'),
(2, '20,000');
...
--
-- Table structure for table `d_source_jobs`
--

CREATE TABLE `d_source_jobs` (
  `src_job_id` int(11) NOT NULL,
  `src_job_name` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_source_jobs`
--

INSERT INTO `d_source_jobs` (`src_job_id`, `src_job_name`) VALUES
(1, 'สมัครด้วยตนเอง By yourself'),
(2, 'บอร์ดรับสมัครงานภายในสถาบัน Bulletin board in the institute'),
(3, 'หนังสือพิมพ์ Newspaper'),
(4, 'การจัดตลาดนัดพบแรงงาน Job Fair'),
(5, 'มีผู้แนะนำ Other people'),
(6, 'สื่อโทรทัศน์และวิทยุ TV/Radio'),
(7, 'อินเตอร์เน์ต Internet/website'),
(8, 'เป็นกิจการตนเองหรือครอบครัว Own/Family Business');

-- --------------------------------------------------------

--
-- Table structure for table `d_students`
--
...
CREATE TABLE `d_students` (
  ...
  `add_Distinct_Name` varchar(255) DEFAULT NULL,
  `add_Province` varchar(255) DEFAULT NULL,
  `Phone` varchar(255) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL,
  `workstatus_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `d_students`
--
...
--
-- Table structure for table `d_sub_district`
--

CREATE TABLE `d_sub_district` (
  `SUB_DISTRICT_ID` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `d_sub_district`
--

INSERT INTO `d_sub_district` (`SUB_DISTRICT_ID`, `SUB_DISTRICT_NAME_TH`, `DISTRICT_ID`, `DISTRICT_NAME_TH`, `PROVINCE_ID`, `PROVINCE_NAME_TH`, `STATUS`) VALUES
('090000', 'ต่างประเทศ', '0900', 'ต่างประเทศ', '09', 'ต่างประเทศ', 'Y'),
('100101', 'พระบรมมหาราชวัง', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100102', 'วังบูรพาภิรมย์', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100103', 'วัดราชบพิธ', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100104', 'สำราญราษฎร์', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100105', 'ศาลเจ้าพ่อเสือ', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100106', 'เสาชิงช้า', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100107', 'บวรนิเวศ', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100108', 'ตลาดยอด', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100109', 'ชนะสงคราม', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100110', 'บ้านพานถม', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100111', 'บางขุนพรหม', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100112', 'วัดสามพระยา', '1001', 'เขตพระนคร', '10', 'กรุงเทพมหานคร', 'Y'),
('100201', 'ดุสิต', '1002', 'เขตดุสิต', '10', 'กรุงเทพมหานคร', 'Y'),
('100202', 'วชิรพยาบาล', '1002', 'เขตดุสิต', '10', 'กรุงเทพมหานคร', 'Y'),
('100203', 'สวนจิตรลดา', '1002', 'เขตดุสิต', '10', 'กรุงเทพมหานคร', 'Y'),
('100204', 'สี่แยกมหานาค', '1002', 'เขตดุสิต', '10', 'กรุงเทพมหานคร', 'Y'),
('100206', 'ถนนนครไชยศรี', '1002', 'เขตดุสิต', '10', 'กรุงเทพมหานคร', 'Y'),
('100301', 'กระทุ่มราย', '1003', 'เขตหนองจอก', '10', 'กรุงเทพมหานคร', 'Y'),
('100302', 'หนองจอก', '1003', 'เขตหนองจอก', '10', 'กรุงเทพมหานคร', 'Y'),
('100303', 'คลองสิบ', '1003', 'เขตหนองจอก', '10', 'กรุงเทพมหานคร', 'Y'),
('100304', 'คลองสิบสอง', '1003', 'เขตหนองจอก', '10', 'กรุงเทพมหานคร', 'Y'),
('100305', 'โคกแฝด', '1003', 'เขตหนองจอก', '10', 'กรุงเทพมหานคร', 'Y'),
('100306', 'คู้ฝั่งเหนือ', '1003', 'เขตหนองจอก', '10', 'กรุงเทพมหานคร', 'Y'),
('100307', 'ลำผักชี', '1003', 'เขตหนองจอก', '10', 'กรุงเทพมหานคร', 'Y'),
('100308', 'ลำต้อยติ่ง', '1003', 'เขตหนองจอก', '10', 'กรุงเทพมหานคร', 'Y'),
('100401', 'มหาพฤฒาราม', '1004', 'เขตบางรัก', '10', 'กรุงเทพมหานคร', 'Y'),
('100402', 'สีลม', '1004', 'เขตบางรัก', '10', 'กรุงเทพมหานคร', 'Y'),
('100403', 'สุริยวงศ์', '1004', 'เขตบางรัก', '10', 'กรุงเทพมหานคร', 'Y'),
('100404', 'บางรัก', '1004', 'เขตบางรัก', '10', 'กรุงเทพมหานคร', 'Y'),
('100405', 'สี่พระยา', '1004', 'เขตบางรัก', '10', 'กรุงเทพมหานคร', 'Y'),
('100502', 'อนุสาวรีย์', '1005', 'เขตบางเขน', '10', 'กรุงเทพมหานคร', 'Y'),
('100508', 'ท่าแร้ง', '1005', 'เขตบางเขน', '10', 'กรุงเทพมหานคร', 'Y'),
('100601', 'คลองจั่น', '1006', 'เขตบางกะปิ', '10', 'กรุงเทพมหานคร', 'Y'),
('100608', 'หัวหมาก', '1006', 'เขตบางกะปิ', '10', 'กรุงเทพมหานคร', 'Y'),
('100701', 'รองเมือง', '1007', 'เขตปทุมวัน', '10', 'กรุงเทพมหานคร', 'Y'),
('100702', 'วังใหม่', '1007', 'เขตปทุมวัน', '10', 'กรุงเทพมหานคร', 'Y'),
('100703', 'ปทุมวัน', '1007', 'เขตปทุมวัน', '10', 'กรุงเทพมหานคร', 'Y'),
('100704', 'ลุมพินี', '1007', 'เขตปทุมวัน', '10', 'กรุงเทพมหานคร', 'Y'),
('100801', 'ป้อมปราบ', '1008', 'เขตป้อมปราบศัตรูพ่าย', '10', 'กรุงเทพมหานคร', 'Y'),
('100802', 'วัดเทพศิรินทร์', '1008', 'เขตป้อมปราบศัตรูพ่าย', '10', 'กรุงเทพมหานคร', 'Y'),
('100803', 'คลองมหานาค', '1008', 'เขตป้อมปราบศัตรูพ่าย', '10', 'กรุงเทพมหานคร', 'Y'),
('100804', 'บ้านบาตร', '1008', 'เขตป้อมปราบศัตรูพ่าย', '10', 'กรุงเทพมหานคร', 'Y'),
('100805', 'วัดโสมนัส', '1008', 'เขตป้อมปราบศัตรูพ่าย', '10', 'กรุงเทพมหานคร', 'Y'),
('100905', 'บางจาก', '1009', 'เขตพระโขนง', '10', 'กรุงเทพมหานคร', 'Y'),
('100910', 'พระโขนงใต้', '1009', 'เขตพระโขนง', '10', 'กรุงเทพมหานคร', 'Y'),
('101001', 'มีนบุรี', '1010', 'เขตมีนบุรี', '10', 'กรุงเทพมหานคร', 'Y'),
('101002', 'แสนแสบ', '1010', 'เขตมีนบุรี', '10', 'กรุงเทพมหานคร', 'Y'),
('101101', 'ลาดกระบัง', '1011', 'เขตลาดกระบัง', '10', 'กรุงเทพมหานคร', 'Y'),
('101102', 'คลองสองต้นนุ่น', '1011', 'เขตลาดกระบัง', '10', 'กรุงเทพมหานคร', 'Y'),
('101103', 'คลองสามประเวศ', '1011', 'เขตลาดกระบัง', '10', 'กรุงเทพมหานคร', 'Y'),
('101104', 'ลำปลาทิว', '1011', 'เขตลาดกระบัง', '10', 'กรุงเทพมหานคร', 'Y'),
('101105', 'ทับยาว', '1011', 'เขตลาดกระบัง', '10', 'กรุงเทพมหานคร', 'Y'),
('101106', 'ขุมทอง', '1011', 'เขตลาดกระบัง', '10', 'กรุงเทพมหานคร', 'Y'),
('101203', 'ช่องนนทรี', '1012', 'เขตยานนาวา', '10', 'กรุงเทพมหานคร', 'Y'),
('101204', 'บางโพงพาง', '1012', 'เขตยานนาวา', '10', 'กรุงเทพมหานคร', 'Y'),
('101301', 'จักรวรรดิ', '1013', 'เขตสัมพันธวงศ์', '10', 'กรุงเทพมหานคร', 'Y'),
('101302', 'สัมพันธวงศ์', '1013', 'เขตสัมพันธวงศ์', '10', 'กรุงเทพมหานคร', 'Y'),
('101303', 'ตลาดน้อย', '1013', 'เขตสัมพันธวงศ์', '10', 'กรุงเทพมหานคร', 'Y'),
('101401', 'สามเสนใน', '1014', 'เขตพญาไท', '10', 'กรุงเทพมหานคร', 'Y'),
('101406', 'พญาไท', '1014', 'เขตพญาไท', '10', 'กรุงเทพมหานคร', 'Y'),
('101501', 'วัดกัลยาณ์', '1015', 'เขตธนบุรี', '10', 'กรุงเทพมหานคร', 'Y'),
('101502', 'หิรัญรูจี', '1015', 'เขตธนบุรี', '10', 'กรุงเทพมหานคร', 'Y'),
('101503', 'บางยี่เรือ', '1015', 'เขตธนบุรี', '10', 'กรุงเทพมหานคร', 'Y'),
('101504', 'บุคคโล', '1015', 'เขตธนบุรี', '10', 'กรุงเทพมหานคร', 'Y'),
('101505', 'ตลาดพลู', '1015', 'เขตธนบุรี', '10', 'กรุงเทพมหานคร', 'Y'),
('101506', 'ดาวคะนอง', '1015', 'เขตธนบุรี', '10', 'กรุงเทพมหานคร', 'Y'),
('101507', 'สำเหร่', '1015', 'เขตธนบุรี', '10', 'กรุงเทพมหานคร', 'Y'),
('101601', 'วัดอรุณ', '1016', 'เขตบางกอกใหญ่', '10', 'กรุงเทพมหานคร', 'Y'),
('101602', 'วัดท่าพระ', '1016', 'เขตบางกอกใหญ่', '10', 'กรุงเทพมหานคร', 'Y'),
('101701', 'ห้วยขวาง', '1017', 'เขตห้วยขวาง', '10', 'กรุงเทพมหานคร', 'Y'),
('101702', 'บางกะปิ', '1017', 'เขตห้วยขวาง', '10', 'กรุงเทพมหานคร', 'Y'),
('101704', 'สามเสนนอก', '1017', 'เขตห้วยขวาง', '10', 'กรุงเทพมหานคร', 'Y'),
('101801', 'สมเด็จเจ้าพระยา', '1018', 'เขตคลองสาน', '10', 'กรุงเทพมหานคร', 'Y'),
('101802', 'คลองสาน', '1018', 'เขตคลองสาน', '10', 'กรุงเทพมหานคร', 'Y'),
('101803', 'บางลำภูล่าง', '1018', 'เขตคลองสาน', '10', 'กรุงเทพมหานคร', 'Y'),
('101804', 'คลองต้นไทร', '1018', 'เขตคลองสาน', '10', 'กรุงเทพมหานคร', 'Y'),
('101901', 'คลองชักพระ', '1019', 'เขตตลิ่งชัน', '10', 'กรุงเทพมหานคร', 'Y'),
('101902', 'ตลิ่งชัน', '1019', 'เขตตลิ่งชัน', '10', 'กรุงเทพมหานคร', 'Y'),
('101903', 'ฉิมพลี', '1019', 'เขตตลิ่งชัน', '10', 'กรุงเทพมหานคร', 'Y'),
('101904', 'บางพรม', '1019', 'เขตตลิ่งชัน', '10', 'กรุงเทพมหานคร', 'Y'),
('101905', 'บางระมาด', '1019', 'เขตตลิ่งชัน', '10', 'กรุงเทพมหานคร', 'Y'),
('101907', 'บางเชือกหนัง', '1019', 'เขตตลิ่งชัน', '10', 'กรุงเทพมหานคร', 'Y'),
('102004', 'ศิริราช', '1020', 'เขตบางกอกน้อย', '10', 'กรุงเทพมหานคร', 'Y'),
('102005', 'บ้านช่างหล่อ', '1020', 'เขตบางกอกน้อย', '10', 'กรุงเทพมหานคร', 'Y'),
('102006', 'บางขุนนนท์', '1020', 'เขตบางกอกน้อย', '10', 'กรุงเทพมหานคร', 'Y'),
('102007', 'บางขุนศรี', '1020', 'เขตบางกอกน้อย', '10', 'กรุงเทพมหานคร', 'Y'),
('102009', 'อรุณอมรินทร์', '1020', 'เขตบางกอกน้อย', '10', 'กรุงเทพมหานคร', 'Y'),
('102105', 'ท่าข้าม', '1021', 'เขตบางขุนเทียน', '10', 'กรุงเทพมหานคร', 'Y'),
('102107', 'แสมดำ', '1021', 'เขตบางขุนเทียน', '10', 'กรุงเทพมหานคร', 'Y'),
('102201', 'บางหว้า', '1022', 'เขตภาษีเจริญ', '10', 'กรุงเทพมหานคร', 'Y'),
('102202', 'บางด้วน', '1022', 'เขตภาษีเจริญ', '10', 'กรุงเทพมหานคร', 'Y'),
('102204', 'บางแคเหนือ', '1022', 'เขตภาษีเจริญ', '10', 'กรุงเทพมหานคร', 'Y'),
('102206', 'บางจาก', '1022', 'เขตภาษีเจริญ', '10', 'กรุงเทพมหานคร', 'Y'),
('102207', 'บางแวก', '1022', 'เขตภาษีเจริญ', '10', 'กรุงเทพมหานคร', 'Y'),
('102208', 'คลองขวาง', '1022', 'เขตภาษีเจริญ', '10', 'กรุงเทพมหานคร', 'Y'),
('102209', 'ปากคลองภาษีเจริญ', '1022', 'เขตภาษีเจริญ', '10', 'กรุงเทพมหานคร', 'Y'),
('102210', 'คูหาสวรรค์', '1022', 'เขตภาษีเจริญ', '10', 'กรุงเทพมหานคร', 'Y'),
('102302', 'หนองแขม', '1023', 'เขตหนองแขม', '10', 'กรุงเทพมหานคร', 'Y'),
('102303', 'หนองค้างพลู', '1023', 'เขตหนองแขม', '10', 'กรุงเทพมหานคร', 'Y'),
('102401', 'ราษฎร์บูรณะ', '1024', 'เขตราษฎร์บูรณะ', '10', 'กรุงเทพมหานคร', 'Y'),
('102402', 'บางปะกอก', '1024', 'เขตราษฎร์บูรณะ', '10', 'กรุงเทพมหานคร', 'Y'),
('102501', 'บางพลัด', '1025', 'เขตบางพลัด', '10', 'กรุงเทพมหานคร', 'Y'),
('102502', 'บางอ้อ', '1025', 'เขตบางพลัด', '10', 'กรุงเทพมหานคร', 'Y'),
('102503', 'บางบำหรุ', '1025', 'เขตบางพลัด', '10', 'กรุงเทพมหานคร', 'Y'),
('102504', 'บางยี่ขัน', '1025', 'เขตบางพลัด', '10', 'กรุงเทพมหานคร', 'Y'),
('102601', 'ดินแดง', '1026', 'เขตดินแดง', '10', 'กรุงเทพมหานคร', 'Y'),
('102602', 'รัชดาภิเษก', '1026', 'เขตดินแดง', '10', 'กรุงเทพมหานคร', 'Y'),
('102701', 'คลองกุ่ม', '1027', 'เขตบึงกุ่ม', '10', 'กรุงเทพมหานคร', 'Y'),
('102704', 'นวมินทร์', '1027', 'เขตบึงกุ่ม', '10', 'กรุงเทพมหานคร', 'Y'),
('102705', 'นวลจันทร์', '1027', 'เขตบึงกุ่ม', '10', 'กรุงเทพมหานคร', 'Y'),
('102801', 'ทุ่งวัดดอน', '1028', 'เขตสาทร', '10', 'กรุงเทพมหานคร', 'Y'),
('102802', 'ยานนาวา', '1028', 'เขตสาทร', '10', 'กรุงเทพมหานคร', 'Y'),
('102803', 'ทุ่งมหาเมฆ', '1028', 'เขตสาทร', '10', 'กรุงเทพมหานคร', 'Y'),
('102901', 'บางซื่อ', '1029', 'เขตบางซื่อ', '10', 'กรุงเทพมหานคร', 'Y'),
('102902', 'วงศ์สว่าง', '1029', 'เขตบางซื่อ', '10', 'กรุงเทพมหานคร', 'Y'),
('103001', 'ลาดยาว', '1030', 'เขตจตุจักร', '10', 'กรุงเทพมหานคร', 'Y'),
('103002', 'เสนานิคม', '1030', 'เขตจตุจักร', '10', 'กรุงเทพมหานคร', 'Y'),
('103003', 'จันทรเกษม', '1030', 'เขตจตุจักร', '10', 'กรุงเทพมหานคร', 'Y'),
('103004', 'จอมพล', '1030', 'เขตจตุจักร', '10', 'กรุงเทพมหานคร', 'Y'),
('103005', 'จตุจักร', '1030', 'เขตจตุจักร', '10', 'กรุงเทพมหานคร', 'Y'),
('103101', 'บางคอแหลม', '1031', 'เขตบางคอแหลม', '10', 'กรุงเทพมหานคร', 'Y'),
('103102', 'วัดพระยาไกร', '1031', 'เขตบางคอแหลม', '10', 'กรุงเทพมหานคร', 'Y'),
('103103', 'บางโคล่', '1031', 'เขตบางคอแหลม', '10', 'กรุงเทพมหานคร', 'Y'),
('103201', 'ประเวศ', '1032', 'เขตประเวศ', '10', 'กรุงเทพมหานคร', 'Y'),
('103202', 'หนองบอน', '1032', 'เขตประเวศ', '10', 'กรุงเทพมหานคร', 'Y'),
('103203', 'ดอกไม้', '1032', 'เขตประเวศ', '10', 'กรุงเทพมหานคร', 'Y'),
('103301', 'คลองเตย', '1033', 'เขตคลองเตย', '10', 'กรุงเทพมหานคร', 'Y'),
('103302', 'คลองตัน', '1033', 'เขตคลองเตย', '10', 'กรุงเทพมหานคร', 'Y'),
('103303', 'พระโขนง', '1033', 'เขตคลองเตย', '10', 'กรุงเทพมหานคร', 'Y'),
('103401', 'สวนหลวง', '1034', 'เขตสวนหลวง', '10', 'กรุงเทพมหานคร', 'Y'),
('103402', 'อ่อนนุช', '1034', 'เขตสวนหลวง', '10', 'กรุงเทพมหานคร', 'Y'),
('103403', 'พัฒนาการ', '1034', 'เขตสวนหลวง', '10', 'กรุงเทพมหานคร', 'Y'),
('103501', 'บางขุนเทียน', '1035', 'เขตจอมทอง', '10', 'กรุงเทพมหานคร', 'Y'),
('103502', 'บางค้อ', '1035', 'เขตจอมทอง', '10', 'กรุงเทพมหานคร', 'Y'),
('103503', 'บางมด', '1035', 'เขตจอมทอง', '10', 'กรุงเทพมหานคร', 'Y'),
('103504', 'จอมทอง', '1035', 'เขตจอมทอง', '10', 'กรุงเทพมหานคร', 'Y'),
('103602', 'สีกัน', '1036', 'เขตดอนเมือง', '10', 'กรุงเทพมหานคร', 'Y'),
('103604', 'ดอนเมือง', '1036', 'เขตดอนเมือง', '10', 'กรุงเทพมหานคร', 'Y'),
('103605', 'สนามบิน', '1036', 'เขตดอนเมือง', '10', 'กรุงเทพมหานคร', 'Y'),
('103701', 'ทุ่งพญาไท', '1037', 'เขตราชเทวี', '10', 'กรุงเทพมหานคร', 'Y'),
('103702', 'ถนนพญาไท', '1037', 'เขตราชเทวี', '10', 'กรุงเทพมหานคร', 'Y'),
('103703', 'ถนนเพชรบุรี', '1037', 'เขตราชเทวี', '10', 'กรุงเทพมหานคร', 'Y'),
('103704', 'มักกะสัน', '1037', 'เขตราชเทวี', '10', 'กรุงเทพมหานคร', 'Y'),
('103801', 'ลาดพร้าว', '1038', 'เขตลาดพร้าว', '10', 'กรุงเทพมหานคร', 'Y'),
('103802', 'จรเข้บัว', '1038', 'เขตลาดพร้าว', '10', 'กรุงเทพมหานคร', 'Y'),
('103901', 'คลองเตยเหนือ', '1039', 'เขตวัฒนา', '10', 'กรุงเทพมหานคร', 'Y'),
('103902', 'คลองตันเหนือ', '1039', 'เขตวัฒนา', '10', 'กรุงเทพมหานคร', 'Y'),
('103903', 'พระโขนงเหนือ', '1039', 'เขตวัฒนา', '10', 'กรุงเทพมหานคร', 'Y'),
('104001', 'บางแค', '1040', 'เขตบางแค', '10', 'กรุงเทพมหานคร', 'Y'),
('104002', 'บางแคเหนือ', '1040', 'เขตบางแค', '10', 'กรุงเทพมหานคร', 'Y'),
('104003', 'บางไผ่', '1040', 'เขตบางแค', '10', 'กรุงเทพมหานคร', 'Y'),
('104004', 'หลักสอง', '1040', 'เขตบางแค', '10', 'กรุงเทพมหานคร', 'Y'),
('104101', 'ทุ่งสองห้อง', '1041', 'เขตหลักสี่', '10', 'กรุงเทพมหานคร', 'Y'),
('104102', 'ตลาดบางเขน', '1041', 'เขตหลักสี่', '10', 'กรุงเทพมหานคร', 'Y'),
('104201', 'สายไหม', '1042', 'เขตสายไหม', '10', 'กรุงเทพมหานคร', 'Y'),
('104202', 'ออเงิน', '1042', 'เขตสายไหม', '10', 'กรุงเทพมหานคร', 'Y'),
('104203', 'คลองถนน', '1042', 'เขตสายไหม', '10', 'กรุงเทพมหานคร', 'Y'),
('104301', 'คันนายาว', '1043', 'เขตคันนายาว', '10', 'กรุงเทพมหานคร', 'Y'),
('104302', 'รามอินทรา', '1043', 'เขตคันนายาว', '10', 'กรุงเทพมหานคร', 'Y'),
('104401', 'สะพานสูง', '1044', 'เขตสะพานสูง', '10', 'กรุงเทพมหานคร', 'Y'),
('104402', 'ราษฎร์พัฒนา', '1044', 'เขตสะพานสูง', '10', 'กรุงเทพมหานคร', 'Y'),
('104403', 'ทับช้าง', '1044', 'เขตสะพานสูง', '10', 'กรุงเทพมหานคร', 'Y'),
('104501', 'วังทองหลาง', '1045', 'เขตวังทองหลาง', '10', 'กรุงเทพมหานคร', 'Y'),
('104502', 'สะพานสอง', '1045', 'เขตวังทองหลาง', '10', 'กรุงเทพมหานคร', 'Y'),
('104503', 'คลองเจ้าคุณสิงห์', '1045', 'เขตวังทองหลาง', '10', 'กรุงเทพมหานคร', 'Y'),
('104504', 'พลับพลา', '1045', 'เขตวังทองหลาง', '10', 'กรุงเทพมหานคร', 'Y'),
('104601', 'สามวาตะวันตก', '1046', 'เขตคลองสามวา', '10', 'กรุงเทพมหานคร', 'Y'),
('104602', 'สามวาตะวันออก', '1046', 'เขตคลองสามวา', '10', 'กรุงเทพมหานคร', 'Y'),
('104603', 'บางชัน', '1046', 'เขตคลองสามวา', '10', 'กรุงเทพมหานคร', 'Y'),
('104604', 'ทรายกองดิน', '1046', 'เขตคลองสามวา', '10', 'กรุงเทพมหานคร', 'Y'),
('104605', 'ทรายกองดินใต้', '1046', 'เขตคลองสามวา', '10', 'กรุงเทพมหานคร', 'Y'),
('104701', 'บางนา', '1047', 'เขตบางนา', '10', 'กรุงเทพมหานคร', 'Y'),
('104702', 'บางนาเหนือ', '1047', 'เขตบางนา', '10', 'กรุงเทพมหานคร', 'Y'),
('104703', 'บางนาใต้', '1047', 'เขตบางนา', '10', 'กรุงเทพมหานคร', 'Y'),
('104801', 'ทวีวัฒนา', '1048', 'เขตทวีวัฒนา', '10', 'กรุงเทพมหานคร', 'Y'),
('104802', 'ศาลาธรรมสพน์', '1048', 'เขตทวีวัฒนา', '10', 'กรุงเทพมหานคร', 'Y'),
('104901', 'บางมด', '1049', 'เขตทุ่งครุ', '10', 'กรุงเทพมหานคร', 'Y'),
('104902', 'ทุ่งครุ', '1049', 'เขตทุ่งครุ', '10', 'กรุงเทพมหานคร', 'Y'),
('105001', 'บางบอน', '1050', 'เขตบางบอน', '10', 'กรุงเทพมหานคร', 'Y'),
('105002', 'บางบอนเหนือ', '1050', 'เขตบางบอน', '10', 'กรุงเทพมหานคร', 'Y'),
('105003', 'บางบอนใต้', '1050', 'เขตบางบอน', '10', 'กรุงเทพมหานคร', 'Y'),
('105004', 'คลองบางพราน', '1050', 'เขตบางบอน', '10', 'กรุงเทพมหานคร', 'Y'),
('105005', 'คลองบางบอน', '1050', 'เขตบางบอน', '10', 'กรุงเทพมหานคร', 'Y'),
('110101', 'ปากน้ำ', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110102', 'สำโรงเหนือ', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110103', 'บางเมือง', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110104', 'ท้ายบ้าน', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110108', 'บางปูใหม่', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110110', 'แพรกษา', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110111', 'บางโปรง', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110112', 'บางปู', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110113', 'บางด้วน', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110114', 'บางเมืองใหม่', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110115', 'เทพารักษ์', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110116', 'ท้ายบ้านใหม่', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110117', 'แพรกษาใหม่', '1101', 'เมืองสมุทรปราการ', '11', 'สมุทรปราการ', 'Y'),
('110201', 'บางบ่อ', '1102', 'บางบ่อ', '11', 'สมุทรปราการ', 'Y'),
('110202', 'บ้านระกาศ', '1102', 'บางบ่อ', '11', 'สมุทรปราการ', 'Y'),
('110203', 'บางพลีน้อย', '1102', 'บางบ่อ', '11', 'สมุทรปราการ', 'Y'),
('110204', 'บางเพรียง', '1102', 'บางบ่อ', '11', 'สมุทรปราการ', 'Y'),
('110205', 'คลองด่าน', '1102', 'บางบ่อ', '11', 'สมุทรปราการ', 'Y'),
('110206', 'คลองสวน', '1102', 'บางบ่อ', '11', 'สมุทรปราการ', 'Y'),
('110207', 'เปร็ง', '1102', 'บางบ่อ', '11', 'สมุทรปราการ', 'Y'),
('110208', 'คลองนิยมยาตรา', '1102', 'บางบ่อ', '11', 'สมุทรปราการ', 'Y'),
('110301', 'บางพลีใหญ่', '1103', 'บางพลี', '11', 'สมุทรปราการ', 'Y'),
('110302', 'บางแก้ว', '1103', 'บางพลี', '11', 'สมุทรปราการ', 'Y'),
('110303', 'บางปลา', '1103', 'บางพลี', '11', 'สมุทรปราการ', 'Y'),
('110304', 'บางโฉลง', '1103', 'บางพลี', '11', 'สมุทรปราการ', 'Y'),
('110308', 'ราชาเทวะ', '1103', 'บางพลี', '11', 'สมุทรปราการ', 'Y'),
('110309', 'หนองปรือ', '1103', 'บางพลี', '11', 'สมุทรปราการ', 'Y'),
('110401', 'ตลาด', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110402', 'บางพึ่ง', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110403', 'บางจาก', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110404', 'บางครุ', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110405', 'บางหญ้าแพรก', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110406', 'บางหัวเสือ', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110407', 'สำโรงใต้', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110408', 'บางยอ', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110409', 'บางกะเจ้า', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110410', 'บางน้ำผึ้ง', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110411', 'บางกระสอบ', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110412', 'บางกอบัว', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110413', 'ทรงคนอง', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110414', 'สำโรง', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110415', 'สำโรงกลาง', '1104', 'พระประแดง', '11', 'สมุทรปราการ', 'Y'),
('110501', 'นาเกลือ', '1105', 'พระสมุทรเจดีย์', '11', 'สมุทรปราการ', 'Y'),
('110502', 'บ้านคลองสวน', '1105', 'พระสมุทรเจดีย์', '11', 'สมุทรปราการ', 'Y'),
('110503', 'แหลมฟ้าผ่า', '1105', 'พระสมุทรเจดีย์', '11', 'สมุทรปราการ', 'Y'),
('110504', 'ปากคลองบางปลากด', '1105', 'พระสมุทรเจดีย์', '11', 'สมุทรปราการ', 'Y'),
('110505', 'ในคลองบางปลากด', '1105', 'พระสมุทรเจดีย์', '11', 'สมุทรปราการ', 'Y'),
('110601', 'บางเสาธง', '1106', 'บางเสาธง', '11', 'สมุทรปราการ', 'Y'),
('110602', 'ศีรษะจรเข้น้อย', '1106', 'บางเสาธง', '11', 'สมุทรปราการ', 'Y'),
('110603', 'ศีรษะจรเข้ใหญ่', '1106', 'บางเสาธง', '11', 'สมุทรปราการ', 'Y'),
('120101', 'สวนใหญ่', '1201', 'เมืองนนทบุรี', '12', 'นนทบุรี', 'Y'),
('120102', 'ตลาดขวัญ', '1201', 'เมืองนนทบุรี', '12', 'นนทบุรี', 'Y'),
('120103', 'บางเขน', '1201', 'เมืองนนทบุรี', '12', 'นนทบุรี', 'Y'),
('120104', 'บางกระสอ', '1201', 'เมืองนนทบุรี', '12', 'นนทบุรี', 'Y'),
('120105', 'ท่าทราย', '1201', 'เมืองนนทบุรี', '12', 'นนทบุรี', 'Y'),
('120106', 'บางไผ่', '1201', 'เมืองนนทบุรี', '12', 'นนทบุรี', 'Y'),
('120107', 'บางศรีเมือง', '1201', 'เมืองนนทบุรี', '12', 'นนทบุรี', 'Y'),
('120108', 'บางกร่าง', '1201', 'เมืองนนทบุรี', '12', 'นนทบุรี', 'Y'),
('120109', 'ไทรม้า', '1201', 'เมืองนนทบุรี', '12', 'นนทบุรี', 'Y'),
('120110', 'บางรักน้อย', '1201', 'เมืองนนทบุรี', '12', 'นนทบุรี', 'Y'),
('120201', 'วัดชลอ', '1202', 'บางกรวย', '12', 'นนทบุรี', 'Y'),
('120202', 'บางกรวย', '1202', 'บางกรวย', '12', 'นนทบุรี', 'Y'),
('120203', 'บางสีทอง', '1202', 'บางกรวย', '12', 'นนทบุรี', 'Y'),
('120204', 'บางขนุน', '1202', 'บางกรวย', '12', 'นนทบุรี', 'Y'),
('120205', 'บางขุนกอง', '1202', 'บางกรวย', '12', 'นนทบุรี', 'Y'),
('120206', 'บางคูเวียง', '1202', 'บางกรวย', '12', 'นนทบุรี', 'Y'),
('120207', 'มหาสวัสดิ์', '1202', 'บางกรวย', '12', 'นนทบุรี', 'Y'),
('120208', 'ปลายบาง', '1202', 'บางกรวย', '12', 'นนทบุรี', 'Y'),
('120209', 'ศาลากลาง', '1202', 'บางกรวย', '12', 'นนทบุรี', 'Y'),
('120301', 'บางม่วง', '1203', 'บางใหญ่', '12', 'นนทบุรี', 'Y'),
('120302', 'บางแม่นาง', '1203', 'บางใหญ่', '12', 'นนทบุรี', 'Y'),
('120303', 'บางเลน', '1203', 'บางใหญ่', '12', 'นนทบุรี', 'Y'),
('120304', 'เสาธงหิน', '1203', 'บางใหญ่', '12', 'นนทบุรี', 'Y'),
('120305', 'บางใหญ่', '1203', 'บางใหญ่', '12', 'นนทบุรี', 'Y'),
('120306', 'บ้านใหม่', '1203', 'บางใหญ่', '12', 'นนทบุรี', 'Y'),
('120401', 'โสนลอย', '1204', 'บางบัวทอง', '12', 'นนทบุรี', 'Y'),
('120402', 'บางบัวทอง', '1204', 'บางบัวทอง', '12', 'นนทบุรี', 'Y'),
('120403', 'บางรักใหญ่', '1204', 'บางบัวทอง', '12', 'นนทบุรี', 'Y'),
('120404', 'บางคูรัด', '1204', 'บางบัวทอง', '12', 'นนทบุรี', 'Y'),
('120405', 'ละหาร', '1204', 'บางบัวทอง', '12', 'นนทบุรี', 'Y'),
('120406', 'ลำโพ', '1204', 'บางบัวทอง', '12', 'นนทบุรี', 'Y'),
('120407', 'พิมลราช', '1204', 'บางบัวทอง', '12', 'นนทบุรี', 'Y'),
('120408', 'บางรักพัฒนา', '1204', 'บางบัวทอง', '12', 'นนทบุรี', 'Y'),
('120501', 'ไทรน้อย', '1205', 'ไทรน้อย', '12', 'นนทบุรี', 'Y'),
('120502', 'ราษฎร์นิยม', '1205', 'ไทรน้อย', '12', 'นนทบุรี', 'Y'),
('120503', 'หนองเพรางาย', '1205', 'ไทรน้อย', '12', 'นนทบุรี', 'Y'),
('120504', 'ไทรใหญ่', '1205', 'ไทรน้อย', '12', 'นนทบุรี', 'Y'),
('120505', 'ขุนศรี', '1205', 'ไทรน้อย', '12', 'นนทบุรี', 'Y'),
('120506', 'คลองขวาง', '1205', 'ไทรน้อย', '12', 'นนทบุรี', 'Y'),
('120507', 'ทวีวัฒนา', '1205', 'ไทรน้อย', '12', 'นนทบุรี', 'Y'),
('120601', 'ปากเกร็ด', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120602', 'บางตลาด', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120603', 'บ้านใหม่', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120604', 'บางพูด', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120605', 'บางตะไนย์', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120606', 'คลองพระอุดม', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120607', 'ท่าอิฐ', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120608', 'เกาะเกร็ด', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120609', 'อ้อมเกร็ด', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120610', 'คลองข่อย', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120611', 'บางพลับ', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('120612', 'คลองเกลือ', '1206', 'ปากเกร็ด', '12', 'นนทบุรี', 'Y'),
('130101', 'บางปรอก', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130102', 'บ้านใหม่', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130103', 'บ้านกลาง', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130104', 'บ้านฉาง', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130105', 'บ้านกระแชง', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130106', 'บางขะแยง', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130107', 'บางคูวัด', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130108', 'บางหลวง', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130109', 'บางเดื่อ', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130110', 'บางพูด', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130111', 'บางพูน', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130112', 'บางกะดี', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130113', 'สวนพริกไทย', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130114', 'หลักหก', '1301', 'เมืองปทุมธานี', '13', 'ปทุมธานี', 'Y'),
('130201', 'คลองหนึ่ง', '1302', 'คลองหลวง', '13', 'ปทุมธานี', 'Y'),
('130202', 'คลองสอง', '1302', 'คลองหลวง', '13', 'ปทุมธานี', 'Y'),
('130203', 'คลองสาม', '1302', 'คลองหลวง', '13', 'ปทุมธานี', 'Y'),
('130204', 'คลองสี่', '1302', 'คลองหลวง', '13', 'ปทุมธานี', 'Y'),
('130205', 'คลองห้า', '1302', 'คลองหลวง', '13', 'ปทุมธานี', 'Y'),
('130206', 'คลองหก', '1302', 'คลองหลวง', '13', 'ปทุมธานี', 'Y'),
('130207', 'คลองเจ็ด', '1302', 'คลองหลวง', '13', 'ปทุมธานี', 'Y'),
('130301', 'ประชาธิปัตย์', '1303', 'ธัญบุรี', '13', 'ปทุมธานี', 'Y'),
('130302', 'บึงยี่โถ', '1303', 'ธัญบุรี', '13', 'ปทุมธานี', 'Y'),
('130303', 'รังสิต', '1303', 'ธัญบุรี', '13', 'ปทุมธานี', 'Y'),
('130304', 'ลำผักกูด', '1303', 'ธัญบุรี', '13', 'ปทุมธานี', 'Y'),
('130305', 'บึงสนั่น', '1303', 'ธัญบุรี', '13', 'ปทุมธานี', 'Y'),
('130306', 'บึงน้ำรักษ์', '1303', 'ธัญบุรี', '13', 'ปทุมธานี', 'Y'),
('130401', 'บึงบา', '1304', 'หนองเสือ', '13', 'ปทุมธานี', 'Y'),
('130402', 'บึงบอน', '1304', 'หนองเสือ', '13', 'ปทุมธานี', 'Y'),
('130403', 'บึงกาสาม', '1304', 'หนองเสือ', '13', 'ปทุมธานี', 'Y'),
('130404', 'บึงชำอ้อ', '1304', 'หนองเสือ', '13', 'ปทุมธานี', 'Y'),
('130405', 'หนองสามวัง', '1304', 'หนองเสือ', '13', 'ปทุมธานี', 'Y'),
('130406', 'ศาลาครุ', '1304', 'หนองเสือ', '13', 'ปทุมธานี', 'Y'),
('130407', 'นพรัตน์', '1304', 'หนองเสือ', '13', 'ปทุมธานี', 'Y'),
('130501', 'ระแหง', '1305', 'ลาดหลุมแก้ว', '13', 'ปทุมธานี', 'Y'),
('130502', 'ลาดหลุมแก้ว', '1305', 'ลาดหลุมแก้ว', '13', 'ปทุมธานี', 'Y'),
('130503', 'คูบางหลวง', '1305', 'ลาดหลุมแก้ว', '13', 'ปทุมธานี', 'Y'),
('130504', 'คูขวาง', '1305', 'ลาดหลุมแก้ว', '13', 'ปทุมธานี', 'Y'),
('130505', 'คลองพระอุดม', '1305', 'ลาดหลุมแก้ว', '13', 'ปทุมธานี', 'Y'),
('130506', 'บ่อเงิน', '1305', 'ลาดหลุมแก้ว', '13', 'ปทุมธานี', 'Y'),
('130507', 'หน้าไม้', '1305', 'ลาดหลุมแก้ว', '13', 'ปทุมธานี', 'Y'),
('130601', 'คูคต', '1306', 'ลำลูกกา', '13', 'ปทุมธานี', 'Y'),
('130602', 'ลาดสวาย', '1306', 'ลำลูกกา', '13', 'ปทุมธานี', 'Y'),
('130603', 'บึงคำพร้อย', '1306', 'ลำลูกกา', '13', 'ปทุมธานี', 'Y'),
('130604', 'ลำลูกกา', '1306', 'ลำลูกกา', '13', 'ปทุมธานี', 'Y'),
('130605', 'บึงทองหลาง', '1306', 'ลำลูกกา', '13', 'ปทุมธานี', 'Y'),
('130606', 'ลำไทร', '1306', 'ลำลูกกา', '13', 'ปทุมธานี', 'Y'),
('130607', 'บึงคอไห', '1306', 'ลำลูกกา', '13', 'ปทุมธานี', 'Y'),
('130608', 'พืชอุดม', '1306', 'ลำลูกกา', '13', 'ปทุมธานี', 'Y'),
('130701', 'บางเตย', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('130702', 'คลองควาย', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('130703', 'สามโคก', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('130704', 'กระแชง', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('130705', 'บางโพธิ์เหนือ', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('130706', 'เชียงรากใหญ่', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('130707', 'บ้านปทุม', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('130708', 'บ้านงิ้ว', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('130709', 'เชียงรากน้อย', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('130710', 'บางกระบือ', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('130711', 'ท้ายเกาะ', '1307', 'สามโคก', '13', 'ปทุมธานี', 'Y'),
('140101', 'ประตูชัย', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140102', 'กะมัง', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140103', 'หอรัตนไชย', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140104', 'หัวรอ', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140105', 'ท่าวาสุกรี', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140106', 'ไผ่ลิง', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140107', 'ปากกราน', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140108', 'ภูเขาทอง', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140109', 'สำเภาล่ม', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140110', 'สวนพริก', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140111', 'คลองตะเคียน', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140112', 'วัดตูม', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140113', 'หันตรา', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140114', 'ลุมพลี', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140115', 'บ้านใหม่', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140116', 'บ้านเกาะ', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140117', 'คลองสวนพลู', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140118', 'คลองสระบัว', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140119', 'เกาะเรียน', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140120', 'บ้านป้อม', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140121', 'บ้านรุน', '1401', 'เมืองพระนครศรีอยุธยา', '14', 'พระนครศรีอยุธยา', 'Y'),
('140201', 'ท่าเรือ', '1402', 'ท่าเรือ', '14', 'พระนครศรีอยุธยา', 'Y'),
('140202', 'จำปา', '1402', 'ท่าเรือ', '14', 'พระนครศรีอยุธยา', 'Y'),
('140203', 'ท่าหลวง', '1402', 'ท่าเรือ', '14', 'พระนครศรีอยุธยา', 'Y'),
('140204', 'บ้านร่อม', '1402', 'ท่าเรือ', '14', 'พระนครศรีอยุธยา', 'Y'),
('140205', 'ศาลาลอย', '1402', 'ท่าเรือ', '14', 'พระนครศรีอยุธยา', 'Y'),
('140206', 'วังแดง', '1402', 'ท่าเรือ', '14', 'พระนครศรีอยุธยา', 'Y'),
('140207', 'โพธิ์เอน', '1402', 'ท่าเรือ', '14', 'พระนครศรีอยุธยา', 'Y'),
('140208', 'ปากท่า', '1402', 'ท่าเรือ', '14', 'พระนครศรีอยุธยา', 'Y'),
('140209', 'หนองขนาก', '1402', 'ท่าเรือ', '14', 'พระนครศรีอยุธยา', 'Y'),
('140210', 'ท่าเจ้าสนุก', '1402', 'ท่าเรือ', '14', 'พระนครศรีอยุธยา', 'Y'),
('140301', 'นครหลวง', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140302', 'ท่าช้าง', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140303', 'บ่อโพง', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140304', 'บ้านชุ้ง', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140305', 'ปากจั่น', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140306', 'บางระกำ', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140307', 'บางพระครู', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140308', 'แม่ลา', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140309', 'หนองปลิง', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140310', 'คลองสะแก', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140311', 'สามไถ', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140312', 'พระนอน', '1403', 'นครหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('140401', 'บางไทร', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140402', 'บางพลี', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140403', 'สนามชัย', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140404', 'บ้านแป้ง', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140405', 'หน้าไม้', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140406', 'บางยี่โท', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140407', 'แคออก', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140408', 'แคตก', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140409', 'ช่างเหล็ก', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140410', 'กระแชง', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140411', 'บ้านกลึง', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140412', 'ช้างน้อย', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140413', 'ห่อหมก', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140414', 'ไผ่พระ', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140415', 'กกแก้วบูรพา', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140416', 'ไม้ตรา', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140417', 'บ้านม้า', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140418', 'บ้านเกาะ', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140419', 'ราชคราม', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140420', 'ช้างใหญ่', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140421', 'โพแตง', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140422', 'เชียงรากน้อย', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140423', 'โคกช้าง', '1404', 'บางไทร', '14', 'พระนครศรีอยุธยา', 'Y'),
('140501', 'บางบาล', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140502', 'วัดยม', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140503', 'ไทรน้อย', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140504', 'สะพานไทย', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140505', 'มหาพราหมณ์', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140506', 'กบเจา', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140507', 'บ้านคลัง', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140508', 'พระขาว', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140509', 'น้ำเต้า', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140510', 'ทางช้าง', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140511', 'วัดตะกู', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140512', 'บางหลวง', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140513', 'บางหลวงโดด', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140514', 'บางหัก', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140515', 'บางชะนี', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140516', 'บ้านกุ่ม', '1405', 'บางบาล', '14', 'พระนครศรีอยุธยา', 'Y'),
('140601', 'บ้านเลน', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140602', 'เชียงรากน้อย', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140603', 'บ้านโพ', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140604', 'บ้านกรด', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140605', 'บางกระสั้น', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140606', 'คลองจิก', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140607', 'บ้านหว้า', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140608', 'วัดยม', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140609', 'บางประแดง', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140610', 'สามเรือน', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140611', 'เกาะเกิด', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140612', 'บ้านพลับ', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140613', 'บ้านแป้ง', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140614', 'คุ้งลาน', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140615', 'ตลิ่งชัน', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140616', 'บ้านสร้าง', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140617', 'ตลาดเกรียบ', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140618', 'ขนอนหลวง', '1406', 'บางปะอิน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140701', 'บางปะหัน', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140702', 'ขยาย', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140703', 'บางเดื่อ', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140704', 'เสาธง', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140705', 'ทางกลาง', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140706', 'บางเพลิง', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140707', 'หันสัง', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140708', 'บางนางร้า', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140709', 'ตานิม', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140710', 'ทับน้ำ', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140711', 'บ้านม้า', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140712', 'ขวัญเมือง', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140713', 'บ้านลี่', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140714', 'โพธิ์สามต้น', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140715', 'พุทเลา', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140716', 'ตาลเอน', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140717', 'บ้านขล้อ', '1407', 'บางปะหัน', '14', 'พระนครศรีอยุธยา', 'Y'),
('140801', 'ผักไห่', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140802', 'อมฤต', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140803', 'บ้านแค', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140804', 'ลาดน้ำเค็ม', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140805', 'ตาลาน', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140806', 'ท่าดินแดง', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140807', 'ดอนลาน', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140808', 'นาคู', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140809', 'กุฎี', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140810', 'ลำตะเคียน', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140811', 'โคกช้าง', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140812', 'จักราช', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140813', 'หนองน้ำใหญ่', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140814', 'ลาดชิด', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140815', 'หน้าโคก', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140816', 'บ้านใหญ่', '1408', 'ผักไห่', '14', 'พระนครศรีอยุธยา', 'Y'),
('140901', 'ภาชี', '1409', 'ภาชี', '14', 'พระนครศรีอยุธยา', 'Y'),
('140902', 'โคกม่วง', '1409', 'ภาชี', '14', 'พระนครศรีอยุธยา', 'Y'),
('140903', 'ระโสม', '1409', 'ภาชี', '14', 'พระนครศรีอยุธยา', 'Y'),
('140904', 'หนองน้ำใส', '1409', 'ภาชี', '14', 'พระนครศรีอยุธยา', 'Y'),
('140905', 'ดอนหญ้านาง', '1409', 'ภาชี', '14', 'พระนครศรีอยุธยา', 'Y'),
('140906', 'ไผ่ล้อม', '1409', 'ภาชี', '14', 'พระนครศรีอยุธยา', 'Y'),
('140907', 'กระจิว', '1409', 'ภาชี', '14', 'พระนครศรีอยุธยา', 'Y'),
('140908', 'พระแก้ว', '1409', 'ภาชี', '14', 'พระนครศรีอยุธยา', 'Y'),
('141001', 'ลาดบัวหลวง', '1410', 'ลาดบัวหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('141002', 'หลักชัย', '1410', 'ลาดบัวหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('141003', 'สามเมือง', '1410', 'ลาดบัวหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('141004', 'พระยาบันลือ', '1410', 'ลาดบัวหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('141005', 'สิงหนาท', '1410', 'ลาดบัวหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('141006', 'คู้สลอด', '1410', 'ลาดบัวหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('141007', 'คลองพระยาบันลือ', '1410', 'ลาดบัวหลวง', '14', 'พระนครศรีอยุธยา', 'Y'),
('141101', 'ลำตาเสา', '1411', 'วังน้อย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141102', 'บ่อตาโล่', '1411', 'วังน้อย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141103', 'วังน้อย', '1411', 'วังน้อย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141104', 'ลำไทร', '1411', 'วังน้อย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141105', 'สนับทึบ', '1411', 'วังน้อย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141106', 'พยอม', '1411', 'วังน้อย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141107', 'หันตะเภา', '1411', 'วังน้อย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141108', 'วังจุฬา', '1411', 'วังน้อย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141109', 'ข้าวงาม', '1411', 'วังน้อย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141110', 'ชะแมบ', '1411', 'วังน้อย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141201', 'เสนา', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141202', 'บ้านแพน', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141203', 'เจ้าเจ็ด', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141204', 'สามกอ', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141205', 'บางนมโค', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141206', 'หัวเวียง', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141207', 'มารวิชัย', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141208', 'บ้านโพธิ์', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141209', 'รางจรเข้', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141210', 'บ้านกระทุ่ม', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141211', 'บ้านแถว', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141212', 'ชายนา', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141213', 'สามตุ่ม', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141214', 'ลาดงา', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141215', 'ดอนทอง', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141216', 'บ้านหลวง', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141217', 'เจ้าเสด็จ', '1412', 'เสนา', '14', 'พระนครศรีอยุธยา', 'Y'),
('141301', 'บางซ้าย', '1413', 'บางซ้าย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141302', 'แก้วฟ้า', '1413', 'บางซ้าย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141303', 'เต่าเล่า', '1413', 'บางซ้าย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141304', 'ปลายกลัด', '1413', 'บางซ้าย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141305', 'เทพมงคล', '1413', 'บางซ้าย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141306', 'วังพัฒนา', '1413', 'บางซ้าย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141401', 'คานหาม', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141402', 'บ้านช้าง', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141403', 'สามบัณฑิต', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141404', 'บ้านหีบ', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141405', 'หนองไม้ซุง', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141406', 'อุทัย', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141407', 'เสนา', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141408', 'หนองน้ำส้ม', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141409', 'โพสาวหาญ', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141410', 'ธนู', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141411', 'ข้าวเม่า', '1414', 'อุทัย', '14', 'พระนครศรีอยุธยา', 'Y'),
('141501', 'หัวไผ่', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141502', 'กะทุ่ม', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141503', 'มหาราช', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141504', 'น้ำเต้า', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141505', 'บางนา', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141506', 'โรงช้าง', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141507', 'เจ้าปลุก', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141508', 'พิตเพียน', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141509', 'บ้านนา', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141510', 'บ้านขวาง', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141511', 'ท่าตอ', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141512', 'บ้านใหม่', '1415', 'มหาราช', '14', 'พระนครศรีอยุธยา', 'Y'),
('141601', 'บ้านแพรก', '1416', 'บ้านแพรก', '14', 'พระนครศรีอยุธยา', 'Y'),
('141602', 'บ้านใหม่', '1416', 'บ้านแพรก', '14', 'พระนครศรีอยุธยา', 'Y'),
('141603', 'สำพะเนียง', '1416', 'บ้านแพรก', '14', 'พระนครศรีอยุธยา', 'Y'),
('141604', 'คลองน้อย', '1416', 'บ้านแพรก', '14', 'พระนครศรีอยุธยา', 'Y'),
('141605', 'สองห้อง', '1416', 'บ้านแพรก', '14', 'พระนครศรีอยุธยา', 'Y'),
('150101', 'ตลาดหลวง', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150102', 'บางแก้ว', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150103', 'ศาลาแดง', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150104', 'ป่างิ้ว', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150105', 'บ้านแห', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150106', 'ตลาดกรวด', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150107', 'มหาดไทย', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150108', 'บ้านอิฐ', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150109', 'หัวไผ่', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150110', 'จำปาหล่อ', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150111', 'โพสะ', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150112', 'บ้านรี', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150113', 'คลองวัว', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150114', 'ย่านซื่อ', '1501', 'เมืองอ่างทอง', '15', 'อ่างทอง', 'Y'),
('150201', 'จรเข้ร้อง', '1502', 'ไชโย', '15', 'อ่างทอง', 'Y'),
('150202', 'ไชยภูมิ', '1502', 'ไชโย', '15', 'อ่างทอง', 'Y'),
('150203', 'ชัยฤทธิ์', '1502', 'ไชโย', '15', 'อ่างทอง', 'Y'),
('150204', 'เทวราช', '1502', 'ไชโย', '15', 'อ่างทอง', 'Y'),
('150205', 'ราชสถิตย์', '1502', 'ไชโย', '15', 'อ่างทอง', 'Y'),
('150206', 'ไชโย', '1502', 'ไชโย', '15', 'อ่างทอง', 'Y'),
('150207', 'หลักฟ้า', '1502', 'ไชโย', '15', 'อ่างทอง', 'Y'),
('150208', 'ชะไว', '1502', 'ไชโย', '15', 'อ่างทอง', 'Y'),
('150209', 'ตรีณรงค์', '1502', 'ไชโย', '15', 'อ่างทอง', 'Y'),
('150301', 'บางปลากด', '1503', 'ป่าโมก', '15', 'อ่างทอง', 'Y'),
('150302', 'ป่าโมก', '1503', 'ป่าโมก', '15', 'อ่างทอง', 'Y'),
('150303', 'สายทอง', '1503', 'ป่าโมก', '15', 'อ่างทอง', 'Y'),
('150304', 'โรงช้าง', '1503', 'ป่าโมก', '15', 'อ่างทอง', 'Y'),
('150305', 'บางเสด็จ', '1503', 'ป่าโมก', '15', 'อ่างทอง', 'Y'),
('150306', 'นรสิงห์', '1503', 'ป่าโมก', '15', 'อ่างทอง', 'Y'),
('150307', 'เอกราช', '1503', 'ป่าโมก', '15', 'อ่างทอง', 'Y'),
('150308', 'โผงเผง', '1503', 'ป่าโมก', '15', 'อ่างทอง', 'Y'),
('150401', 'อ่างแก้ว', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150402', 'อินทประมูล', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150403', 'บางพลับ', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150404', 'หนองแม่ไก่', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150405', 'รำมะสัก', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150406', 'บางระกำ', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150407', 'โพธิ์รังนก', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150408', 'องครักษ์', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150409', 'โคกพุทรา', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150410', 'ยางช้าย', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150411', 'บ่อแร่', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150412', 'ทางพระ', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150413', 'สามง่าม', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150414', 'บางเจ้าฉ่า', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150415', 'คำหยาด', '1504', 'โพธิ์ทอง', '15', 'อ่างทอง', 'Y'),
('150501', 'แสวงหา', '1505', 'แสวงหา', '15', 'อ่างทอง', 'Y'),
('150502', 'ศรีพราน', '1505', 'แสวงหา', '15', 'อ่างทอง', 'Y'),
('150503', 'บ้านพราน', '1505', 'แสวงหา', '15', 'อ่างทอง', 'Y'),
('150504', 'วังน้ำเย็น', '1505', 'แสวงหา', '15', 'อ่างทอง', 'Y'),
('150505', 'สีบัวทอง', '1505', 'แสวงหา', '15', 'อ่างทอง', 'Y'),
('150506', 'ห้วยไผ่', '1505', 'แสวงหา', '15', 'อ่างทอง', 'Y'),
('150507', 'จำลอง', '1505', 'แสวงหา', '15', 'อ่างทอง', 'Y'),
('150601', 'ไผ่จำศิล', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150602', 'ศาลเจ้าโรงทอง', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150603', 'ไผ่ดำพัฒนา', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150604', 'สาวร้องไห้', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150605', 'ท่าช้าง', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150606', 'ยี่ล้น', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150607', 'บางจัก', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150608', 'ห้วยคันแหลน', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150609', 'คลองขนาก', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150610', 'ไผ่วง', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150611', 'สี่ร้อย', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150612', 'ม่วงเตี้ย', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150613', 'หัวตะพาน', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150614', 'หลักแก้ว', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150615', 'ตลาดใหม่', '1506', 'วิเศษชัยชาญ', '15', 'อ่างทอง', 'Y'),
('150701', 'สามโก้', '1507', 'สามโก้', '15', 'อ่างทอง', 'Y'),
('150702', 'ราษฎรพัฒนา', '1507', 'สามโก้', '15', 'อ่างทอง', 'Y'),
('150703', 'อบทม', '1507', 'สามโก้', '15', 'อ่างทอง', 'Y'),
('150704', 'โพธิ์ม่วงพันธ์', '1507', 'สามโก้', '15', 'อ่างทอง', 'Y'),
('150705', 'มงคลธรรมนิมิต', '1507', 'สามโก้', '15', 'อ่างทอง', 'Y'),
('160101', 'ทะเลชุบศร', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160102', 'ท่าหิน', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160103', 'กกโก', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160104', 'โก่งธนู', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160105', 'เขาพระงาม', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160106', 'เขาสามยอด', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160107', 'โคกกะเทียม', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160108', 'โคกลำพาน', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160109', 'โคกตูม', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160110', 'งิ้วราย', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160111', 'ดอนโพธิ์', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160112', 'ตะลุง', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160114', 'ท่าแค', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160115', 'ท่าศาลา', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160116', 'นิคมสร้างตนเอง', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160117', 'บางขันหมาก', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160118', 'บ้านข่อย', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160119', 'ท้ายตลาด', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160120', 'ป่าตาล', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160121', 'พรหมมาสตร์', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160122', 'โพธิ์เก้าต้น', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160123', 'โพธิ์ตรุ', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160124', 'สี่คลอง', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160125', 'ถนนใหญ่', '1601', 'เมืองลพบุรี', '16', 'ลพบุรี', 'Y'),
('160201', 'พัฒนานิคม', '1602', 'พัฒนานิคม', '16', 'ลพบุรี', 'Y'),
('160202', 'ช่องสาริกา', '1602', 'พัฒนานิคม', '16', 'ลพบุรี', 'Y'),
('160203', 'มะนาวหวาน', '1602', 'พัฒนานิคม', '16', 'ลพบุรี', 'Y'),
('160204', 'ดีลัง', '1602', 'พัฒนานิคม', '16', 'ลพบุรี', 'Y'),
('160205', 'โคกสลุง', '1602', 'พัฒนานิคม', '16', 'ลพบุรี', 'Y'),
('160206', 'ชอนน้อย', '1602', 'พัฒนานิคม', '16', 'ลพบุรี', 'Y'),
('160207', 'หนองบัว', '1602', 'พัฒนานิคม', '16', 'ลพบุรี', 'Y'),
('160208', 'ห้วยขุนราม', '1602', 'พัฒนานิคม', '16', 'ลพบุรี', 'Y'),
('160209', 'น้ำสุด', '1602', 'พัฒนานิคม', '16', 'ลพบุรี', 'Y'),
('160301', 'โคกสำโรง', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160302', 'เกาะแก้ว', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160303', 'ถลุงเหล็ก', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160304', 'หลุมข้าว', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160305', 'ห้วยโป่ง', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160306', 'คลองเกตุ', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160307', 'สะแกราบ', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160308', 'เพนียด', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160309', 'วังเพลิง', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160310', 'ดงมะรุม', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160318', 'วังขอนขว้าง', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160320', 'วังจั่น', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160322', 'หนองแขม', '1603', 'โคกสำโรง', '16', 'ลพบุรี', 'Y'),
('160401', 'ลำนารายณ์', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160402', 'ชัยนารายณ์', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160403', 'ศิลาทิพย์', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160404', 'ห้วยหิน', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160405', 'ม่วงค่อม', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160406', 'บัวชุม', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160407', 'ท่าดินดำ', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160408', 'มะกอกหวาน', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160409', 'ซับตะเคียน', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160410', 'นาโสม', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160411', 'หนองยายโต๊ะ', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160412', 'เกาะรัง', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160414', 'ท่ามะนาว', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160417', 'นิคมลำนารายณ์', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160418', 'ชัยบาดาล', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160419', 'บ้านใหม่สามัคคี', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160422', 'เขาแหลม', '1604', 'ชัยบาดาล', '16', 'ลพบุรี', 'Y'),
('160501', 'ท่าวุ้ง', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160502', 'บางคู้', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160503', 'โพตลาดแก้ว', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160504', 'บางลี่', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160505', 'บางงา', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160506', 'โคกสลุด', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160507', 'เขาสมอคอน', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160508', 'หัวสำโรง', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160509', 'ลาดสาลี่', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160510', 'บ้านเบิก', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160511', 'มุจลินท์', '1605', 'ท่าวุ้ง', '16', 'ลพบุรี', 'Y'),
('160601', 'ไผ่ใหญ่', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160602', 'บ้านทราย', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160603', 'บ้านกล้วย', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160604', 'ดงพลับ', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160605', 'บ้านชี', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160606', 'พุคา', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160607', 'หินปัก', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160608', 'บางพึ่ง', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160609', 'หนองทรายขาว', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160610', 'บางกะพี้', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160611', 'หนองเต่า', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160612', 'โพนทอง', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160613', 'บางขาม', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160614', 'ดอนดึง', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160615', 'ชอนม่วง', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160616', 'หนองกระเบียน', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160617', 'สายห้วยแก้ว', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160618', 'มหาสอน', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160619', 'บ้านหมี่', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160620', 'เชียงงา', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y');
INSERT INTO `d_sub_district` (`SUB_DISTRICT_ID`, `SUB_DISTRICT_NAME_TH`, `DISTRICT_ID`, `DISTRICT_NAME_TH`, `PROVINCE_ID`, `PROVINCE_NAME_TH`, `STATUS`) VALUES
('160621', 'หนองเมือง', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160622', 'สนามแจง', '1606', 'บ้านหมี่', '16', 'ลพบุรี', 'Y'),
('160701', 'ท่าหลวง', '1607', 'ท่าหลวง', '16', 'ลพบุรี', 'Y'),
('160702', 'แก่งผักกูด', '1607', 'ท่าหลวง', '16', 'ลพบุรี', 'Y'),
('160703', 'ซับจำปา', '1607', 'ท่าหลวง', '16', 'ลพบุรี', 'Y'),
('160704', 'หนองผักแว่น', '1607', 'ท่าหลวง', '16', 'ลพบุรี', 'Y'),
('160705', 'ทะเลวังวัด', '1607', 'ท่าหลวง', '16', 'ลพบุรี', 'Y'),
('160706', 'หัวลำ', '1607', 'ท่าหลวง', '16', 'ลพบุรี', 'Y'),
('160801', 'สระโบสถ์', '1608', 'สระโบสถ์', '16', 'ลพบุรี', 'Y'),
('160802', 'มหาโพธิ', '1608', 'สระโบสถ์', '16', 'ลพบุรี', 'Y'),
('160803', 'ทุ่งท่าช้าง', '1608', 'สระโบสถ์', '16', 'ลพบุรี', 'Y'),
('160804', 'ห้วยใหญ่', '1608', 'สระโบสถ์', '16', 'ลพบุรี', 'Y'),
('160805', 'นิยมชัย', '1608', 'สระโบสถ์', '16', 'ลพบุรี', 'Y'),
('160901', 'โคกเจริญ', '1609', 'โคกเจริญ', '16', 'ลพบุรี', 'Y'),
('160902', 'ยางราก', '1609', 'โคกเจริญ', '16', 'ลพบุรี', 'Y'),
('160903', 'หนองมะค่า', '1609', 'โคกเจริญ', '16', 'ลพบุรี', 'Y'),
('160904', 'วังทอง', '1609', 'โคกเจริญ', '16', 'ลพบุรี', 'Y'),
('160905', 'โคกแสมสาร', '1609', 'โคกเจริญ', '16', 'ลพบุรี', 'Y'),
('161001', 'ลำสนธิ', '1610', 'ลำสนธิ', '16', 'ลพบุรี', 'Y'),
('161002', 'ซับสมบูรณ์', '1610', 'ลำสนธิ', '16', 'ลพบุรี', 'Y'),
('161003', 'หนองรี', '1610', 'ลำสนธิ', '16', 'ลพบุรี', 'Y'),
('161004', 'กุดตาเพชร', '1610', 'ลำสนธิ', '16', 'ลพบุรี', 'Y'),
('161005', 'เขารวก', '1610', 'ลำสนธิ', '16', 'ลพบุรี', 'Y'),
('161006', 'เขาน้อย', '1610', 'ลำสนธิ', '16', 'ลพบุรี', 'Y'),
('161101', 'หนองม่วง', '1611', 'หนองม่วง', '16', 'ลพบุรี', 'Y'),
('161102', 'บ่อทอง', '1611', 'หนองม่วง', '16', 'ลพบุรี', 'Y'),
('161103', 'ดงดินแดง', '1611', 'หนองม่วง', '16', 'ลพบุรี', 'Y'),
('161104', 'ชอนสมบูรณ์', '1611', 'หนองม่วง', '16', 'ลพบุรี', 'Y'),
('161105', 'ยางโทน', '1611', 'หนองม่วง', '16', 'ลพบุรี', 'Y'),
('161106', 'ชอนสารเดช', '1611', 'หนองม่วง', '16', 'ลพบุรี', 'Y'),
('170101', 'บางพุทรา', '1701', 'เมืองสิงห์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170102', 'บางมัญ', '1701', 'เมืองสิงห์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170103', 'โพกรวม', '1701', 'เมืองสิงห์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170104', 'ม่วงหมู่', '1701', 'เมืองสิงห์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170105', 'หัวไผ่', '1701', 'เมืองสิงห์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170106', 'ต้นโพธิ์', '1701', 'เมืองสิงห์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170107', 'จักรสีห์', '1701', 'เมืองสิงห์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170108', 'บางกระบือ', '1701', 'เมืองสิงห์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170201', 'สิงห์', '1702', 'บางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170202', 'ไม้ดัด', '1702', 'บางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170203', 'เชิงกลัด', '1702', 'บางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170204', 'โพชนไก่', '1702', 'บางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170205', 'แม่ลา', '1702', 'บางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170206', 'บ้านจ่า', '1702', 'บางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170207', 'พักทัน', '1702', 'บางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170208', 'สระแจง', '1702', 'บางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170301', 'โพทะเล', '1703', 'ค่ายบางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170302', 'บางระจัน', '1703', 'ค่ายบางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170303', 'โพสังโฆ', '1703', 'ค่ายบางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170304', 'ท่าข้าม', '1703', 'ค่ายบางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170305', 'คอทราย', '1703', 'ค่ายบางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170306', 'หนองกระทุ่ม', '1703', 'ค่ายบางระจัน', '17', 'สิงห์บุรี', 'Y'),
('170401', 'พระงาม', '1704', 'พรหมบุรี', '17', 'สิงห์บุรี', 'Y'),
('170402', 'พรหมบุรี', '1704', 'พรหมบุรี', '17', 'สิงห์บุรี', 'Y'),
('170403', 'บางน้ำเชี่ยว', '1704', 'พรหมบุรี', '17', 'สิงห์บุรี', 'Y'),
('170404', 'บ้านหม้อ', '1704', 'พรหมบุรี', '17', 'สิงห์บุรี', 'Y'),
('170405', 'บ้านแป้ง', '1704', 'พรหมบุรี', '17', 'สิงห์บุรี', 'Y'),
('170406', 'หัวป่า', '1704', 'พรหมบุรี', '17', 'สิงห์บุรี', 'Y'),
('170407', 'โรงช้าง', '1704', 'พรหมบุรี', '17', 'สิงห์บุรี', 'Y'),
('170501', 'ถอนสมอ', '1705', 'ท่าช้าง', '17', 'สิงห์บุรี', 'Y'),
('170502', 'โพประจักษ์', '1705', 'ท่าช้าง', '17', 'สิงห์บุรี', 'Y'),
('170503', 'วิหารขาว', '1705', 'ท่าช้าง', '17', 'สิงห์บุรี', 'Y'),
('170504', 'พิกุลทอง', '1705', 'ท่าช้าง', '17', 'สิงห์บุรี', 'Y'),
('170601', 'อินทร์บุรี', '1706', 'อินทร์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170602', 'ประศุก', '1706', 'อินทร์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170603', 'ทับยา', '1706', 'อินทร์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170604', 'งิ้วราย', '1706', 'อินทร์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170605', 'ชีน้ำร้าย', '1706', 'อินทร์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170606', 'ท่างาม', '1706', 'อินทร์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170607', 'น้ำตาล', '1706', 'อินทร์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170608', 'ทองเอน', '1706', 'อินทร์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170609', 'ห้วยชัน', '1706', 'อินทร์บุรี', '17', 'สิงห์บุรี', 'Y'),
('170610', 'โพธิ์ชัย', '1706', 'อินทร์บุรี', '17', 'สิงห์บุรี', 'Y'),
('180101', 'ในเมือง', '1801', 'เมืองชัยนาท', '18', 'ชัยนาท', 'Y'),
('180102', 'บ้านกล้วย', '1801', 'เมืองชัยนาท', '18', 'ชัยนาท', 'Y'),
('180103', 'ท่าชัย', '1801', 'เมืองชัยนาท', '18', 'ชัยนาท', 'Y'),
('180104', 'ชัยนาท', '1801', 'เมืองชัยนาท', '18', 'ชัยนาท', 'Y'),
('180105', 'เขาท่าพระ', '1801', 'เมืองชัยนาท', '18', 'ชัยนาท', 'Y'),
('180106', 'หาดท่าเสา', '1801', 'เมืองชัยนาท', '18', 'ชัยนาท', 'Y'),
('180107', 'ธรรมามูล', '1801', 'เมืองชัยนาท', '18', 'ชัยนาท', 'Y'),
('180108', 'เสือโฮก', '1801', 'เมืองชัยนาท', '18', 'ชัยนาท', 'Y'),
('180109', 'นางลือ', '1801', 'เมืองชัยนาท', '18', 'ชัยนาท', 'Y'),
('180201', 'คุ้งสำเภา', '1802', 'มโนรมย์', '18', 'ชัยนาท', 'Y'),
('180202', 'วัดโคก', '1802', 'มโนรมย์', '18', 'ชัยนาท', 'Y'),
('180203', 'ศิลาดาน', '1802', 'มโนรมย์', '18', 'ชัยนาท', 'Y'),
('180204', 'ท่าฉนวน', '1802', 'มโนรมย์', '18', 'ชัยนาท', 'Y'),
('180205', 'หางน้ำสาคร', '1802', 'มโนรมย์', '18', 'ชัยนาท', 'Y'),
('180206', 'ไร่พัฒนา', '1802', 'มโนรมย์', '18', 'ชัยนาท', 'Y'),
('180207', 'อู่ตะเภา', '1802', 'มโนรมย์', '18', 'ชัยนาท', 'Y'),
('180301', 'วัดสิงห์', '1803', 'วัดสิงห์', '18', 'ชัยนาท', 'Y'),
('180302', 'มะขามเฒ่า', '1803', 'วัดสิงห์', '18', 'ชัยนาท', 'Y'),
('180303', 'หนองน้อย', '1803', 'วัดสิงห์', '18', 'ชัยนาท', 'Y'),
('180304', 'หนองบัว', '1803', 'วัดสิงห์', '18', 'ชัยนาท', 'Y'),
('180306', 'หนองขุ่น', '1803', 'วัดสิงห์', '18', 'ชัยนาท', 'Y'),
('180307', 'บ่อแร่', '1803', 'วัดสิงห์', '18', 'ชัยนาท', 'Y'),
('180311', 'วังหมัน', '1803', 'วัดสิงห์', '18', 'ชัยนาท', 'Y'),
('180401', 'สรรพยา', '1804', 'สรรพยา', '18', 'ชัยนาท', 'Y'),
('180402', 'ตลุก', '1804', 'สรรพยา', '18', 'ชัยนาท', 'Y'),
('180403', 'เขาแก้ว', '1804', 'สรรพยา', '18', 'ชัยนาท', 'Y'),
('180404', 'โพนางดำตก', '1804', 'สรรพยา', '18', 'ชัยนาท', 'Y'),
('180405', 'โพนางดำออก', '1804', 'สรรพยา', '18', 'ชัยนาท', 'Y'),
('180406', 'บางหลวง', '1804', 'สรรพยา', '18', 'ชัยนาท', 'Y'),
('180407', 'หาดอาษา', '1804', 'สรรพยา', '18', 'ชัยนาท', 'Y'),
('180501', 'แพรกศรีราชา', '1805', 'สรรคบุรี', '18', 'ชัยนาท', 'Y'),
('180502', 'เที่ยงแท้', '1805', 'สรรคบุรี', '18', 'ชัยนาท', 'Y'),
('180503', 'ห้วยกรด', '1805', 'สรรคบุรี', '18', 'ชัยนาท', 'Y'),
('180504', 'โพงาม', '1805', 'สรรคบุรี', '18', 'ชัยนาท', 'Y'),
('180505', 'บางขุด', '1805', 'สรรคบุรี', '18', 'ชัยนาท', 'Y'),
('180506', 'ดงคอน', '1805', 'สรรคบุรี', '18', 'ชัยนาท', 'Y'),
('180507', 'ดอนกำ', '1805', 'สรรคบุรี', '18', 'ชัยนาท', 'Y'),
('180508', 'ห้วยกรดพัฒนา', '1805', 'สรรคบุรี', '18', 'ชัยนาท', 'Y'),
('180601', 'หันคา', '1806', 'หันคา', '18', 'ชัยนาท', 'Y'),
('180602', 'บ้านเชี่ยน', '1806', 'หันคา', '18', 'ชัยนาท', 'Y'),
('180605', 'ไพรนกยูง', '1806', 'หันคา', '18', 'ชัยนาท', 'Y'),
('180606', 'หนองแซง', '1806', 'หันคา', '18', 'ชัยนาท', 'Y'),
('180607', 'ห้วยงู', '1806', 'หันคา', '18', 'ชัยนาท', 'Y'),
('180608', 'วังไก่เถื่อน', '1806', 'หันคา', '18', 'ชัยนาท', 'Y'),
('180609', 'เด่นใหญ่', '1806', 'หันคา', '18', 'ชัยนาท', 'Y'),
('180611', 'สามง่ามท่าโบสถ์', '1806', 'หันคา', '18', 'ชัยนาท', 'Y'),
('180701', 'หนองมะโมง', '1807', 'หนองมะโมง', '18', 'ชัยนาท', 'Y'),
('180702', 'วังตะเคียน', '1807', 'หนองมะโมง', '18', 'ชัยนาท', 'Y'),
('180703', 'สะพานหิน', '1807', 'หนองมะโมง', '18', 'ชัยนาท', 'Y'),
('180704', 'กุดจอก', '1807', 'หนองมะโมง', '18', 'ชัยนาท', 'Y'),
('180801', 'เนินขาม', '1808', 'เนินขาม', '18', 'ชัยนาท', 'Y'),
('180802', 'กะบกเตี้ย', '1808', 'เนินขาม', '18', 'ชัยนาท', 'Y'),
('180803', 'สุขเดือนห้า', '1808', 'เนินขาม', '18', 'ชัยนาท', 'Y'),
('190101', 'ปากเพรียว', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190105', 'ดาวเรือง', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190106', 'นาโฉง', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190107', 'โคกสว่าง', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190108', 'หนองโน', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190109', 'หนองยาว', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190110', 'ปากข้าวสาร', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190111', 'หนองปลาไหล', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190112', 'กุดนกเปล้า', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190113', 'ตลิ่งชัน', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190114', 'ตะกุด', '1901', 'เมืองสระบุรี', '19', 'สระบุรี', 'Y'),
('190201', 'แก่งคอย', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190202', 'ทับกวาง', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190203', 'ตาลเดี่ยว', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190204', 'ห้วยแห้ง', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190205', 'ท่าคล้อ', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190206', 'หินซ้อน', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190207', 'บ้านธาตุ', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190208', 'บ้านป่า', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190209', 'ท่าตูม', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190210', 'ชะอม', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190211', 'สองคอน', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190212', 'เตาปูน', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190213', 'ชำผักแพว', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190215', 'ท่ามะปราง', '1902', 'แก่งคอย', '19', 'สระบุรี', 'Y'),
('190301', 'หนองแค', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190302', 'กุ่มหัก', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190303', 'คชสิทธิ์', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190304', 'โคกตูม', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190305', 'โคกแย้', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190306', 'บัวลอย', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190307', 'ไผ่ต่ำ', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190308', 'โพนทอง', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190309', 'ห้วยขมิ้น', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190310', 'ห้วยทราย', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190311', 'หนองไข่น้ำ', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190312', 'หนองแขม', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190313', 'หนองจิก', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190314', 'หนองจรเข้', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190315', 'หนองนาก', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190316', 'หนองปลาหมอ', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190317', 'หนองปลิง', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190318', 'หนองโรง', '1903', 'หนองแค', '19', 'สระบุรี', 'Y'),
('190401', 'หนองหมู', '1904', 'วิหารแดง', '19', 'สระบุรี', 'Y'),
('190402', 'บ้านลำ', '1904', 'วิหารแดง', '19', 'สระบุรี', 'Y'),
('190403', 'คลองเรือ', '1904', 'วิหารแดง', '19', 'สระบุรี', 'Y'),
('190404', 'วิหารแดง', '1904', 'วิหารแดง', '19', 'สระบุรี', 'Y'),
('190405', 'หนองสรวง', '1904', 'วิหารแดง', '19', 'สระบุรี', 'Y'),
('190406', 'เจริญธรรม', '1904', 'วิหารแดง', '19', 'สระบุรี', 'Y'),
('190501', 'หนองแซง', '1905', 'หนองแซง', '19', 'สระบุรี', 'Y'),
('190502', 'หนองควายโซ', '1905', 'หนองแซง', '19', 'สระบุรี', 'Y'),
('190503', 'หนองหัวโพ', '1905', 'หนองแซง', '19', 'สระบุรี', 'Y'),
('190504', 'หนองสีดา', '1905', 'หนองแซง', '19', 'สระบุรี', 'Y'),
('190505', 'หนองกบ', '1905', 'หนองแซง', '19', 'สระบุรี', 'Y'),
('190506', 'ไก่เส่า', '1905', 'หนองแซง', '19', 'สระบุรี', 'Y'),
('190507', 'โคกสะอาด', '1905', 'หนองแซง', '19', 'สระบุรี', 'Y'),
('190508', 'ม่วงหวาน', '1905', 'หนองแซง', '19', 'สระบุรี', 'Y'),
('190509', 'เขาดิน', '1905', 'หนองแซง', '19', 'สระบุรี', 'Y'),
('190601', 'บ้านหมอ', '1906', 'บ้านหมอ', '19', 'สระบุรี', 'Y'),
('190602', 'บางโขมด', '1906', 'บ้านหมอ', '19', 'สระบุรี', 'Y'),
('190603', 'สร่างโศก', '1906', 'บ้านหมอ', '19', 'สระบุรี', 'Y'),
('190604', 'ตลาดน้อย', '1906', 'บ้านหมอ', '19', 'สระบุรี', 'Y'),
('190605', 'หรเทพ', '1906', 'บ้านหมอ', '19', 'สระบุรี', 'Y'),
('190606', 'โคกใหญ่', '1906', 'บ้านหมอ', '19', 'สระบุรี', 'Y'),
('190607', 'ไผ่ขวาง', '1906', 'บ้านหมอ', '19', 'สระบุรี', 'Y'),
('190608', 'บ้านครัว', '1906', 'บ้านหมอ', '19', 'สระบุรี', 'Y'),
('190609', 'หนองบัว', '1906', 'บ้านหมอ', '19', 'สระบุรี', 'Y'),
('190701', 'ดอนพุด', '1907', 'ดอนพุด', '19', 'สระบุรี', 'Y'),
('190702', 'ไผ่หลิ่ว', '1907', 'ดอนพุด', '19', 'สระบุรี', 'Y'),
('190703', 'บ้านหลวง', '1907', 'ดอนพุด', '19', 'สระบุรี', 'Y'),
('190704', 'ดงตะงาว', '1907', 'ดอนพุด', '19', 'สระบุรี', 'Y'),
('190801', 'หนองโดน', '1908', 'หนองโดน', '19', 'สระบุรี', 'Y'),
('190802', 'บ้านกลับ', '1908', 'หนองโดน', '19', 'สระบุรี', 'Y'),
('190803', 'ดอนทอง', '1908', 'หนองโดน', '19', 'สระบุรี', 'Y'),
('190804', 'บ้านโปร่ง', '1908', 'หนองโดน', '19', 'สระบุรี', 'Y'),
('190901', 'พระพุทธบาท', '1909', 'พระพุทธบาท', '19', 'สระบุรี', 'Y'),
('190902', 'ขุนโขลน', '1909', 'พระพุทธบาท', '19', 'สระบุรี', 'Y'),
('190903', 'ธารเกษม', '1909', 'พระพุทธบาท', '19', 'สระบุรี', 'Y'),
('190904', 'นายาว', '1909', 'พระพุทธบาท', '19', 'สระบุรี', 'Y'),
('190905', 'พุคำจาน', '1909', 'พระพุทธบาท', '19', 'สระบุรี', 'Y'),
('190906', 'เขาวง', '1909', 'พระพุทธบาท', '19', 'สระบุรี', 'Y'),
('190907', 'ห้วยป่าหวาย', '1909', 'พระพุทธบาท', '19', 'สระบุรี', 'Y'),
('190908', 'พุกร่าง', '1909', 'พระพุทธบาท', '19', 'สระบุรี', 'Y'),
('190909', 'หนองแก', '1909', 'พระพุทธบาท', '19', 'สระบุรี', 'Y'),
('191001', 'เสาไห้', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191002', 'บ้านยาง', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191003', 'หัวปลวก', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191004', 'งิ้วงาม', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191005', 'ศาลารีไทย', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191006', 'ต้นตาล', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191007', 'ท่าช้าง', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191008', 'พระยาทด', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191009', 'ม่วงงาม', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191010', 'เริงราง', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191011', 'เมืองเก่า', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191012', 'สวนดอกไม้', '1910', 'เสาไห้', '19', 'สระบุรี', 'Y'),
('191101', 'มวกเหล็ก', '1911', 'มวกเหล็ก', '19', 'สระบุรี', 'Y'),
('191102', 'มิตรภาพ', '1911', 'มวกเหล็ก', '19', 'สระบุรี', 'Y'),
('191104', 'หนองย่างเสือ', '1911', 'มวกเหล็ก', '19', 'สระบุรี', 'Y'),
('191105', 'ลำสมพุง', '1911', 'มวกเหล็ก', '19', 'สระบุรี', 'Y'),
('191107', 'ลำพญากลาง', '1911', 'มวกเหล็ก', '19', 'สระบุรี', 'Y'),
('191109', 'ซับสนุ่น', '1911', 'มวกเหล็ก', '19', 'สระบุรี', 'Y'),
('191201', 'แสลงพัน', '1912', 'วังม่วง', '19', 'สระบุรี', 'Y'),
('191202', 'คำพราน', '1912', 'วังม่วง', '19', 'สระบุรี', 'Y'),
('191203', 'วังม่วง', '1912', 'วังม่วง', '19', 'สระบุรี', 'Y'),
('191301', 'เขาดินพัฒนา', '1913', 'เฉลิมพระเกียรติ', '19', 'สระบุรี', 'Y'),
('191302', 'บ้านแก้ง', '1913', 'เฉลิมพระเกียรติ', '19', 'สระบุรี', 'Y'),
('191303', 'ผึ้งรวง', '1913', 'เฉลิมพระเกียรติ', '19', 'สระบุรี', 'Y'),
('191304', 'พุแค', '1913', 'เฉลิมพระเกียรติ', '19', 'สระบุรี', 'Y'),
('191305', 'ห้วยบง', '1913', 'เฉลิมพระเกียรติ', '19', 'สระบุรี', 'Y'),
('191306', 'หน้าพระลาน', '1913', 'เฉลิมพระเกียรติ', '19', 'สระบุรี', 'Y'),
('200101', 'บางปลาสร้อย', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200102', 'มะขามหย่ง', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200103', 'บ้านโขด', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200104', 'แสนสุข', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200105', 'บ้านสวน', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200106', 'หนองรี', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200107', 'นาป่า', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200108', 'หนองข้างคอก', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200109', 'ดอนหัวฬ่อ', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200110', 'หนองไม้แดง', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200111', 'บางทราย', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200112', 'คลองตำหรุ', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200113', 'เหมือง', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200114', 'บ้านปึก', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200115', 'ห้วยกะปิ', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200116', 'เสม็ด', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200117', 'อ่างศิลา', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200118', 'สำนักบก', '2001', 'เมืองชลบุรี', '20', 'ชลบุรี', 'Y'),
('200201', 'บ้านบึง', '2002', 'บ้านบึง', '20', 'ชลบุรี', 'Y'),
('200202', 'คลองกิ่ว', '2002', 'บ้านบึง', '20', 'ชลบุรี', 'Y'),
('200203', 'มาบไผ่', '2002', 'บ้านบึง', '20', 'ชลบุรี', 'Y'),
('200204', 'หนองซ้ำซาก', '2002', 'บ้านบึง', '20', 'ชลบุรี', 'Y'),
('200205', 'หนองบอนแดง', '2002', 'บ้านบึง', '20', 'ชลบุรี', 'Y'),
('200206', 'หนองชาก', '2002', 'บ้านบึง', '20', 'ชลบุรี', 'Y'),
('200207', 'หนองอิรุณ', '2002', 'บ้านบึง', '20', 'ชลบุรี', 'Y'),
('200208', 'หนองไผ่แก้ว', '2002', 'บ้านบึง', '20', 'ชลบุรี', 'Y'),
('200301', 'หนองใหญ่', '2003', 'หนองใหญ่', '20', 'ชลบุรี', 'Y'),
('200302', 'คลองพลู', '2003', 'หนองใหญ่', '20', 'ชลบุรี', 'Y'),
('200303', 'หนองเสือช้าง', '2003', 'หนองใหญ่', '20', 'ชลบุรี', 'Y'),
('200304', 'ห้างสูง', '2003', 'หนองใหญ่', '20', 'ชลบุรี', 'Y'),
('200305', 'เขาซก', '2003', 'หนองใหญ่', '20', 'ชลบุรี', 'Y'),
('200401', 'บางละมุง', '2004', 'บางละมุง', '20', 'ชลบุรี', 'Y'),
('200402', 'หนองปรือ', '2004', 'บางละมุง', '20', 'ชลบุรี', 'Y'),
('200403', 'หนองปลาไหล', '2004', 'บางละมุง', '20', 'ชลบุรี', 'Y'),
('200404', 'โป่ง', '2004', 'บางละมุง', '20', 'ชลบุรี', 'Y'),
('200405', 'เขาไม้แก้ว', '2004', 'บางละมุง', '20', 'ชลบุรี', 'Y'),
('200406', 'ห้วยใหญ่', '2004', 'บางละมุง', '20', 'ชลบุรี', 'Y'),
('200407', 'ตะเคียนเตี้ย', '2004', 'บางละมุง', '20', 'ชลบุรี', 'Y'),
('200408', 'นาเกลือ', '2004', 'บางละมุง', '20', 'ชลบุรี', 'Y'),
('200501', 'พานทอง', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200502', 'หนองตำลึง', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200503', 'มาบโป่ง', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200504', 'หนองกะขะ', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200505', 'หนองหงษ์', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200506', 'โคกขี้หนอน', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200507', 'บ้านเก่า', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200508', 'หน้าประดู่', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200509', 'บางนาง', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200510', 'เกาะลอย', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200511', 'บางหัก', '2005', 'พานทอง', '20', 'ชลบุรี', 'Y'),
('200601', 'พนัสนิคม', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200602', 'หน้าพระธาตุ', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200603', 'วัดหลวง', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200604', 'บ้านเซิด', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200605', 'นาเริก', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200606', 'หมอนนาง', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200607', 'สระสี่เหลี่ยม', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200608', 'วัดโบสถ์', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200609', 'กุฎโง้ง', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200610', 'หัวถนน', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200611', 'ท่าข้าม', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200613', 'หนองปรือ', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200614', 'หนองขยาด', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200615', 'ทุ่งขวาง', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200616', 'หนองเหียง', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200617', 'นาวังหิน', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200618', 'บ้านช้าง', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200620', 'โคกเพลาะ', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200621', 'ไร่หลักทอง', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200622', 'นามะตูม', '2006', 'พนัสนิคม', '20', 'ชลบุรี', 'Y'),
('200701', 'ศรีราชา', '2007', 'ศรีราชา', '20', 'ชลบุรี', 'Y'),
('200702', 'สุรศักดิ์', '2007', 'ศรีราชา', '20', 'ชลบุรี', 'Y'),
('200703', 'ทุ่งสุขลา', '2007', 'ศรีราชา', '20', 'ชลบุรี', 'Y'),
('200704', 'บึง', '2007', 'ศรีราชา', '20', 'ชลบุรี', 'Y'),
('200705', 'หนองขาม', '2007', 'ศรีราชา', '20', 'ชลบุรี', 'Y'),
('200706', 'เขาคันทรง', '2007', 'ศรีราชา', '20', 'ชลบุรี', 'Y'),
('200707', 'บางพระ', '2007', 'ศรีราชา', '20', 'ชลบุรี', 'Y'),
('200708', 'บ่อวิน', '2007', 'ศรีราชา', '20', 'ชลบุรี', 'Y'),
('200801', 'ท่าเทววงษ์', '2008', 'เกาะสีชัง', '20', 'ชลบุรี', 'Y'),
('200901', 'สัตหีบ', '2009', 'สัตหีบ', '20', 'ชลบุรี', 'Y'),
('200902', 'นาจอมเทียน', '2009', 'สัตหีบ', '20', 'ชลบุรี', 'Y'),
('200903', 'พลูตาหลวง', '2009', 'สัตหีบ', '20', 'ชลบุรี', 'Y'),
('200904', 'บางเสร่', '2009', 'สัตหีบ', '20', 'ชลบุรี', 'Y'),
('200905', 'แสมสาร', '2009', 'สัตหีบ', '20', 'ชลบุรี', 'Y'),
('201001', 'บ่อทอง', '2010', 'บ่อทอง', '20', 'ชลบุรี', 'Y'),
('201002', 'วัดสุวรรณ', '2010', 'บ่อทอง', '20', 'ชลบุรี', 'Y'),
('201003', 'บ่อกวางทอง', '2010', 'บ่อทอง', '20', 'ชลบุรี', 'Y'),
('201004', 'ธาตุทอง', '2010', 'บ่อทอง', '20', 'ชลบุรี', 'Y'),
('201005', 'เกษตรสุวรรณ', '2010', 'บ่อทอง', '20', 'ชลบุรี', 'Y'),
('201006', 'พลวงทอง', '2010', 'บ่อทอง', '20', 'ชลบุรี', 'Y'),
('201101', 'เกาะจันทร์', '2011', 'เกาะจันทร์', '20', 'ชลบุรี', 'Y'),
('201102', 'ท่าบุญมี', '2011', 'เกาะจันทร์', '20', 'ชลบุรี', 'Y'),
('210101', 'ท่าประดู่', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210102', 'เชิงเนิน', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210103', 'ตะพง', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210104', 'ปากน้ำ', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210105', 'เพ', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210106', 'แกลง', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210107', 'บ้านแลง', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210108', 'นาตาขวัญ', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210109', 'เนินพระ', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210110', 'กะเฉด', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210111', 'ทับมา', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210112', 'น้ำคอก', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210113', 'ห้วยโป่ง', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210114', 'มาบตาพุด', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210115', 'สำนักทอง', '2101', 'เมืองระยอง', '21', 'ระยอง', 'Y'),
('210201', 'สำนักท้อน', '2102', 'บ้านฉาง', '21', 'ระยอง', 'Y'),
('210202', 'พลา', '2102', 'บ้านฉาง', '21', 'ระยอง', 'Y'),
('210203', 'บ้านฉาง', '2102', 'บ้านฉาง', '21', 'ระยอง', 'Y'),
('210301', 'ทางเกวียน', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210302', 'วังหว้า', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210303', 'ชากโดน', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210304', 'เนินฆ้อ', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210305', 'กร่ำ', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210306', 'ชากพง', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210307', 'กระแสบน', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210308', 'บ้านนา', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210309', 'ทุ่งควายกิน', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210310', 'กองดิน', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210311', 'คลองปูน', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210312', 'พังราด', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210313', 'ปากน้ำกระแส', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210317', 'ห้วยยาง', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210318', 'สองสลึง', '2103', 'แกลง', '21', 'ระยอง', 'Y'),
('210401', 'วังจันทร์', '2104', 'วังจันทร์', '21', 'ระยอง', 'Y'),
('210402', 'ชุมแสง', '2104', 'วังจันทร์', '21', 'ระยอง', 'Y'),
('210403', 'ป่ายุบใน', '2104', 'วังจันทร์', '21', 'ระยอง', 'Y'),
('210404', 'พลงตาเอี่ยม', '2104', 'วังจันทร์', '21', 'ระยอง', 'Y'),
('210501', 'บ้านค่าย', '2105', 'บ้านค่าย', '21', 'ระยอง', 'Y'),
('210502', 'หนองละลอก', '2105', 'บ้านค่าย', '21', 'ระยอง', 'Y'),
('210503', 'หนองตะพาน', '2105', 'บ้านค่าย', '21', 'ระยอง', 'Y'),
('210504', 'ตาขัน', '2105', 'บ้านค่าย', '21', 'ระยอง', 'Y'),
('210505', 'บางบุตร', '2105', 'บ้านค่าย', '21', 'ระยอง', 'Y'),
('210506', 'หนองบัว', '2105', 'บ้านค่าย', '21', 'ระยอง', 'Y'),
('210507', 'ชากบก', '2105', 'บ้านค่าย', '21', 'ระยอง', 'Y'),
('210601', 'ปลวกแดง', '2106', 'ปลวกแดง', '21', 'ระยอง', 'Y'),
('210602', 'ตาสิทธิ์', '2106', 'ปลวกแดง', '21', 'ระยอง', 'Y'),
('210603', 'ละหาร', '2106', 'ปลวกแดง', '21', 'ระยอง', 'Y'),
('210604', 'แม่น้ำคู้', '2106', 'ปลวกแดง', '21', 'ระยอง', 'Y'),
('210605', 'มาบยางพร', '2106', 'ปลวกแดง', '21', 'ระยอง', 'Y'),
('210606', 'หนองไร่', '2106', 'ปลวกแดง', '21', 'ระยอง', 'Y'),
('210701', 'น้ำเป็น', '2107', 'เขาชะเมา', '21', 'ระยอง', 'Y'),
('210702', 'ห้วยทับมอญ', '2107', 'เขาชะเมา', '21', 'ระยอง', 'Y'),
('210703', 'ชำฆ้อ', '2107', 'เขาชะเมา', '21', 'ระยอง', 'Y'),
('210704', 'เขาน้อย', '2107', 'เขาชะเมา', '21', 'ระยอง', 'Y'),
('210801', 'นิคมพัฒนา', '2108', 'นิคมพัฒนา', '21', 'ระยอง', 'Y'),
('210802', 'มาบข่า', '2108', 'นิคมพัฒนา', '21', 'ระยอง', 'Y'),
('210803', 'พนานิคม', '2108', 'นิคมพัฒนา', '21', 'ระยอง', 'Y'),
('210804', 'มะขามคู่', '2108', 'นิคมพัฒนา', '21', 'ระยอง', 'Y'),
('220101', 'ตลาด', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220102', 'วัดใหม่', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220103', 'คลองนารายณ์', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220104', 'เกาะขวาง', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220105', 'คมบาง', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220106', 'ท่าช้าง', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220107', 'จันทนิมิต', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220108', 'บางกะจะ', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220109', 'แสลง', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220110', 'หนองบัว', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220111', 'พลับพลา', '2201', 'เมืองจันทบุรี', '22', 'จันทบุรี', 'Y'),
('220201', 'ขลุง', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220202', 'บ่อ', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220203', 'เกวียนหัก', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220204', 'ตะปอน', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220205', 'บางชัน', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220206', 'วันยาว', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220207', 'ซึ้ง', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220208', 'มาบไพ', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220209', 'วังสรรพรส', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220210', 'ตรอกนอง', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220211', 'ตกพรม', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220212', 'บ่อเวฬุ', '2202', 'ขลุง', '22', 'จันทบุรี', 'Y'),
('220301', 'ท่าใหม่', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220302', 'ยายร้า', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220303', 'สีพยา', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220304', 'บ่อพุ', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220305', 'พลอยแหวน', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220306', 'เขาวัว', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220307', 'เขาบายศรี', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220308', 'สองพี่น้อง', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220309', 'ทุ่งเบญจา', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220311', 'รำพัน', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220312', 'โขมง', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220313', 'ตะกาดเง้า', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220314', 'คลองขุด', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220324', 'เขาแก้ว', '2203', 'ท่าใหม่', '22', 'จันทบุรี', 'Y'),
('220401', 'ทับไทร', '2204', 'โป่งน้ำร้อน', '22', 'จันทบุรี', 'Y'),
('220402', 'โป่งน้ำร้อน', '2204', 'โป่งน้ำร้อน', '22', 'จันทบุรี', 'Y'),
('220404', 'หนองตาคง', '2204', 'โป่งน้ำร้อน', '22', 'จันทบุรี', 'Y'),
('220409', 'เทพนิมิต', '2204', 'โป่งน้ำร้อน', '22', 'จันทบุรี', 'Y'),
('220410', 'คลองใหญ่', '2204', 'โป่งน้ำร้อน', '22', 'จันทบุรี', 'Y'),
('220501', 'มะขาม', '2205', 'มะขาม', '22', 'จันทบุรี', 'Y'),
('220502', 'ท่าหลวง', '2205', 'มะขาม', '22', 'จันทบุรี', 'Y'),
('220503', 'ปัถวี', '2205', 'มะขาม', '22', 'จันทบุรี', 'Y'),
('220504', 'วังแซ้ม', '2205', 'มะขาม', '22', 'จันทบุรี', 'Y'),
('220506', 'ฉมัน', '2205', 'มะขาม', '22', 'จันทบุรี', 'Y'),
('220508', 'อ่างคีรี', '2205', 'มะขาม', '22', 'จันทบุรี', 'Y'),
('220601', 'ปากน้ำแหลมสิงห์', '2206', 'แหลมสิงห์', '22', 'จันทบุรี', 'Y'),
('220602', 'เกาะเปริด', '2206', 'แหลมสิงห์', '22', 'จันทบุรี', 'Y'),
('220603', 'หนองชิ่ม', '2206', 'แหลมสิงห์', '22', 'จันทบุรี', 'Y'),
('220604', 'พลิ้ว', '2206', 'แหลมสิงห์', '22', 'จันทบุรี', 'Y'),
('220605', 'คลองน้ำเค็ม', '2206', 'แหลมสิงห์', '22', 'จันทบุรี', 'Y'),
('220606', 'บางสระเก้า', '2206', 'แหลมสิงห์', '22', 'จันทบุรี', 'Y'),
('220607', 'บางกะไชย', '2206', 'แหลมสิงห์', '22', 'จันทบุรี', 'Y'),
('220701', 'ปะตง', '2207', 'สอยดาว', '22', 'จันทบุรี', 'Y'),
('220702', 'ทุ่งขนาน', '2207', 'สอยดาว', '22', 'จันทบุรี', 'Y'),
('220703', 'ทับช้าง', '2207', 'สอยดาว', '22', 'จันทบุรี', 'Y'),
('220704', 'ทรายขาว', '2207', 'สอยดาว', '22', 'จันทบุรี', 'Y'),
('220705', 'สะตอน', '2207', 'สอยดาว', '22', 'จันทบุรี', 'Y'),
('220801', 'แก่งหางแมว', '2208', 'แก่งหางแมว', '22', 'จันทบุรี', 'Y'),
('220802', 'ขุนซ่อง', '2208', 'แก่งหางแมว', '22', 'จันทบุรี', 'Y'),
('220803', 'สามพี่น้อง', '2208', 'แก่งหางแมว', '22', 'จันทบุรี', 'Y'),
('220804', 'พวา', '2208', 'แก่งหางแมว', '22', 'จันทบุรี', 'Y'),
('220805', 'เขาวงกต', '2208', 'แก่งหางแมว', '22', 'จันทบุรี', 'Y'),
('220901', 'นายายอาม', '2209', 'นายายอาม', '22', 'จันทบุรี', 'Y'),
('220902', 'วังโตนด', '2209', 'นายายอาม', '22', 'จันทบุรี', 'Y'),
('220903', 'กระแจะ', '2209', 'นายายอาม', '22', 'จันทบุรี', 'Y'),
('220904', 'สนามไชย', '2209', 'นายายอาม', '22', 'จันทบุรี', 'Y'),
('220905', 'ช้างข้าม', '2209', 'นายายอาม', '22', 'จันทบุรี', 'Y'),
('220906', 'วังใหม่', '2209', 'นายายอาม', '22', 'จันทบุรี', 'Y'),
('221001', 'ชากไทย', '2210', 'เขาคิชฌกูฏ', '22', 'จันทบุรี', 'Y'),
('221002', 'พลวง', '2210', 'เขาคิชฌกูฏ', '22', 'จันทบุรี', 'Y'),
('221003', 'ตะเคียนทอง', '2210', 'เขาคิชฌกูฏ', '22', 'จันทบุรี', 'Y'),
('221004', 'คลองพลู', '2210', 'เขาคิชฌกูฏ', '22', 'จันทบุรี', 'Y'),
('221005', 'จันทเขลม', '2210', 'เขาคิชฌกูฏ', '22', 'จันทบุรี', 'Y'),
('230101', 'บางพระ', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230102', 'หนองเสม็ด', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230103', 'หนองโสน', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230104', 'หนองคันทรง', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230105', 'ห้วงน้ำขาว', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230106', 'อ่าวใหญ่', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230107', 'วังกระแจะ', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230108', 'ห้วยแร้ง', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230109', 'เนินทราย', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230110', 'ท่าพริก', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230111', 'ท่ากุ่ม', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230112', 'ตะกาง', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230113', 'ชำราก', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230114', 'แหลมกลัด', '2301', 'เมืองตราด', '23', 'ตราด', 'Y'),
('230201', 'คลองใหญ่', '2302', 'คลองใหญ่', '23', 'ตราด', 'Y'),
('230202', 'ไม้รูด', '2302', 'คลองใหญ่', '23', 'ตราด', 'Y'),
('230203', 'หาดเล็ก', '2302', 'คลองใหญ่', '23', 'ตราด', 'Y'),
('230301', 'เขาสมิง', '2303', 'เขาสมิง', '23', 'ตราด', 'Y'),
('230302', 'แสนตุ้ง', '2303', 'เขาสมิง', '23', 'ตราด', 'Y'),
('230303', 'วังตะเคียน', '2303', 'เขาสมิง', '23', 'ตราด', 'Y'),
('230304', 'ท่าโสม', '2303', 'เขาสมิง', '23', 'ตราด', 'Y'),
('230305', 'สะตอ', '2303', 'เขาสมิง', '23', 'ตราด', 'Y'),
('230306', 'ประณีต', '2303', 'เขาสมิง', '23', 'ตราด', 'Y'),
('230307', 'เทพนิมิต', '2303', 'เขาสมิง', '23', 'ตราด', 'Y'),
('230308', 'ทุ่งนนทรี', '2303', 'เขาสมิง', '23', 'ตราด', 'Y'),
('230401', 'บ่อพลอย', '2304', 'บ่อไร่', '23', 'ตราด', 'Y'),
('230402', 'ช้างทูน', '2304', 'บ่อไร่', '23', 'ตราด', 'Y'),
('230403', 'ด่านชุมพล', '2304', 'บ่อไร่', '23', 'ตราด', 'Y'),
('230404', 'หนองบอน', '2304', 'บ่อไร่', '23', 'ตราด', 'Y'),
('230405', 'นนทรีย์', '2304', 'บ่อไร่', '23', 'ตราด', 'Y'),
('230501', 'แหลมงอบ', '2305', 'แหลมงอบ', '23', 'ตราด', 'Y'),
('230502', 'น้ำเชี่ยว', '2305', 'แหลมงอบ', '23', 'ตราด', 'Y'),
('230503', 'บางปิด', '2305', 'แหลมงอบ', '23', 'ตราด', 'Y'),
('230507', 'คลองใหญ่', '2305', 'แหลมงอบ', '23', 'ตราด', 'Y'),
('230601', 'เกาะหมาก', '2306', 'เกาะกูด', '23', 'ตราด', 'Y'),
('230602', 'เกาะกูด', '2306', 'เกาะกูด', '23', 'ตราด', 'Y'),
('230701', 'เกาะช้าง', '2307', 'เกาะช้าง', '23', 'ตราด', 'Y'),
('230702', 'เกาะช้างใต้', '2307', 'เกาะช้าง', '23', 'ตราด', 'Y'),
('240101', 'หน้าเมือง', '2401', 'เมืองฉะเชิงเทรา', '24', 'ฉะเชิงเทรา', 'Y'),
('240102', 'ท่าไข่', '2401', 'เมืองฉะเชิงเทรา', '24', 'ฉะเชิงเทรา', 'Y'),
('240103', 'บ้านใหม่', '2401', 'เมืองฉะเชิงเทรา', '24', 'ฉะเชิงเทรา', 'Y'),
('240104', 'คลองนา', '2401', 'เมืองฉะเชิงเทรา', '24', 'ฉะเชิงเทรา', 'Y'),
('240105', 'บางตีนเป็ด', '2401', 'เมืองฉะเชิงเทรา', '24', 'ฉะเชิงเทรา', 'Y'),
('240106', 'บางไผ่', '2401', 'เมืองฉะเชิงเทรา', '24', 'ฉะเชิงเทรา', 'Y');

-- --------------------------------------------------------

--
-- Table structure for table `d_talent`
--

CREATE TABLE `d_talent` (
  `talent_id` int(11) NOT NULL,
  `talent_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `d_talent`
--

INSERT INTO `d_talent` (`talent_id`, `talent_name`) VALUES
(1, 'test1'),
(2, 'test2');
...
--
-- Table structure for table `d_time_findwork`
--

CREATE TABLE `d_time_findwork` (
  `time_findwork_id` int(11) NOT NULL,
  `time_findwork_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `d_time_findwork`
--

INSERT INTO `d_time_findwork` (`time_findwork_id`, `time_findwork_name`) VALUES
(1, '1-3'),
(2, '3-6');
...
CREATE TABLE `d_worktype` (
  `worktype_id` int(11) NOT NULL,
  `worktype_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `d_worktype`
--

INSERT INTO `d_worktype` (`worktype_id`, `worktype_name`) VALUES
(1, 'test'),
(2, 'test'),
(3, 'test'),
(4, 'test');
...
--
-- Table structure for table `d_work_satisfy`
--

CREATE TABLE `d_work_satisfy` (
  `work_satisfy_id` int(11) NOT NULL,
  `work_satisfy_name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `d_work_satisfy`
--

INSERT INTO `d_work_satisfy` (`work_satisfy_id`, `work_satisfy_name`) VALUES
(1, 'Yes'),
(2, 'No');
...
CREATE TABLE `work_status` (
  ...
  `workstatus_name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `work_status` (`workstatus_id`, `workstatus_name`) VALUES
(1, 'มีงานทำหลังจบการศึกษา'),
(2, 'มีงานทำหลังจบการศึกษา และกำลังศึกษาต่อ'),
(3, 'ยังไม่มีงานทำ และ ยังไม่ได้ศึกษาต่อ'),
(4, 'มีงานทำก่อนจบการศึกษา เป็นสายงานเดิมหลังจบการศึกษา'),
(5, 'มีงานทำก่อนจบการศึกษา เป็นสายงานเดิมหลังจบการศึกษา');
...
--
-- Indexes for table `d_addr_workplace`
--
ALTER TABLE `d_addr_workplace`
  ADD PRIMARY KEY (`add_wp_ID`) USING BTREE;

--
-- Indexes for table `d_apply_edu`
--
ALTER TABLE `d_apply_edu`
  ADD PRIMARY KEY (`apply_edu_id`) USING BTREE;

--
-- Indexes for table `d_department`
--
ALTER TABLE `d_department`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `d_desire_study_further`
--
...
--
-- Indexes for table `d_salary`
--
ALTER TABLE `d_salary`
  ADD PRIMARY KEY (`salary_id`) USING BTREE;

--
-- Indexes for table `d_source_jobs`
--
ALTER TABLE `d_source_jobs`
  ADD PRIMARY KEY (`src_job_id`) USING BTREE;

--
-- Indexes for table `d_students`
--
ALTER TABLE `d_students`
  ADD PRIMARY KEY (`std_id`) USING BTREE;

--
-- Indexes for table `d_talent`
--
ALTER TABLE `d_talent`
  ADD PRIMARY KEY (`talent_id`);

--
-- Indexes for table `d_time_findwork`
--
...
--
-- Indexes for table `d_work_satisfy`
--
ALTER TABLE `d_work_satisfy`
  ADD PRIMARY KEY (`work_satisfy_id`);
...
--
ALTER TABLE `amphures`
  MODIFY `amphure_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1007;
...
--
-- AUTO_INCREMENT for table `d_desire_study_further`
--
ALTER TABLE `d_desire_study_further`
...
--
-- AUTO_INCREMENT for table `d_talent`
--
ALTER TABLE `d_talent`
  MODIFY `talent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `d_time_findwork`
--
ALTER TABLE `d_time_findwork`
...
--
ALTER TABLE `d_worktype`
  MODIFY `worktype_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `d_work_satisfy`
--
ALTER TABLE `d_work_satisfy`
  MODIFY `work_satisfy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `work_status`
  MODIFY `workstatus_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
